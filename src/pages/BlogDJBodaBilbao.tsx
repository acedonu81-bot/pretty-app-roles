...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', name: 'DJs para bodas en Bilbao', description: 'Encuentra y contrata DJs verificados para bodas y eventos en Bilbao. Contratos digitales.', serviceType: 'DJ para bodas y eventos', areaServed: { '@type': 'City', name: 'Bilbao' }, provider: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es' }, url: 'https://xpeak.es/blog/dj-bodas-bilbao', offers: { '@type': 'Offer', price: '0', priceCurrency: 'EUR' } };
