...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Cómo trabajar de RRPP en discoteca en España: guía 2026', description: 'Guía completa para trabajar de relaciones públicas en discotecas y clubs. Qué hace un RRPP, cuánto cobra, cómo conseguir los primeros contratos y cómo crecer.', datePublished: '2026-06-02', dateModified: '2026-06-02', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/como-trabajar-de-rrpp-discoteca' };
