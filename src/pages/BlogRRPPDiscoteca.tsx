...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Cómo trabajar de RRPP en discoteca en España: guía 2026', description: 'Guía completa para trabajar de relaciones públicas en discotecas y clubs. Qué hace un RRPP, cuánto cobra, cómo conseguir los primeros contratos y cómo crecer.', datePublished: '2026-06-02', dateModified: '2026-06-02', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/como-trabajar-de-rrpp-discoteca' };
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(5,150,105,0.04)', border: '1px solid rgba(5,150,105,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#3d3d4e' }}>Crea tu perfil en XPEAK. Salas, clubs y promotoras en tu ciudad ven tu red de contactos y te contratan directamente para sus eventos.</p>
              <a href="/auth?role=staff&mode=register" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#059669,#B8941E)', color: '#000' }}>Crear mi perfil de RRPP →</a>
            </div>
          </div>
