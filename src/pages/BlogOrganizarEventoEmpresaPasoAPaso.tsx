          ...
          <div className="space-y-10">
            <section>
              ...
              <div className="space-y-3">
                {FASES.map((f, i) => (
                  <div key={f.fase} className="p-4 rounded-xl" style={{ background: i % 2 === 0 ? 'rgba(255,255,255,0.025)' : 'rgba(255,255,255,0.015)', border: '1px solid rgba(255,255,255,0.04)' }}>
                    <p className="text-xs font-black mb-2" style={{ color: '#D4AF37' }}>{f.fase}</p>
                    <ul className="space-y-1">
                      {f.tareas.map(t => (
                        <li key={t} className="text-xs leading-relaxed" style={{ color: 'rgba(255,255,255,0.65)' }}>• {t}</li>
                      ))}
                    </ul>
                  </div>
                ))}
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={row.partida} className="flex items-center justify-between p-4 rounded-xl" style={{ background: i % 2 === 0 ? 'rgba(255,255,255,0.025)' : 'rgba(255,255,255,0.015)', border: '1px solid rgba(255,255,255,0.04)' }}>
                    ...
                    <span className="text-xs font-black ml-4 shrink-0" style={{ color: '#D4AF37' }}>{row.pct}</span>
                  </div>
                ))}
              </div>
            </section>
