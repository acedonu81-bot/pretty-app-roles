...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Manresa: guía 2026', description: 'Cuánto cobran las azafatas para eventos corporativos y bodas en Manresa, capital de la Catalunya Central. Tarifas 2026.', datePublished: '2026-05-31', dateModified: '2026-07-02', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-manresa' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Manresa?', acceptedAnswer: { '@type': 'Answer', text: 'En Manresa, una azafata de eventos cobra entre 12€ y 17€/hora bruto, algo por debajo de la media del área metropolitana de Barcelona por ser un mercado más interior y de menor volumen. Las agencias facturan al cliente entre 115€ y 165€/día por perfil, cifra que incluye el margen de gestión de la agencia.' } },
