      ...
      <div className="min-h-screen" style={{ background: '#090909', color: '#fff' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#8E8EA0' }}>Tenerife es uno de los destinos de boda más demandados de España, con bodas locales en el norte y bodas de destino internacionales en los grandes resorts del sur. Clima perfecto 365 días al año. Guía completa de precios para 2026.</p>
          ...
          <div className="space-y-10">
            <section>
              ...
              <p className="text-xs mt-3" style={{ color: '#8E8EA0' }}>Precios orientativos 2026. Sin IVA. Los resorts del sur suelen tener lista de proveedores aprobados — confirma con el venue antes.</p>
            </section>
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#8E8EA0' }}>XPEAK tiene DJs especializados en bodas en Tenerife y Canarias, incluyendo servicios bilingües para bodas internacionales. Contrato digital automático.</p>
