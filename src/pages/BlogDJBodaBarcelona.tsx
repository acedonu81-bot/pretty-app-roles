      ...
      <div className="min-h-screen" style={{ background: '#090909', color: '#fff' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#8E8EA0' }}>Barcelona es el segundo mercado de bodas más grande de España. El Maresme, el Penedès y los rooftops de la ciudad mueven miles de bodas cada año — te contamos cuánto cuesta un DJ y cómo encontrar el correcto.</p>
          ...
          <div className="space-y-10">
            <section>
              ...
              <p className="text-xs mt-3" style={{ color: '#8E8EA0' }}>Precios específicos para la provincia de Barcelona 2026. Sin IVA. Un 20-30% por encima de la media nacional.</p>
            </section>
            ...
            <section>
              ...
              <p className="text-xs mt-3" style={{ color: '#8E8EA0' }}>Consulta siempre el suplemento de desplazamiento si la finca está a más de 40 km de Barcelona ciudad.</p>
            </section>
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#8E8EA0' }}>XPEAK tiene DJs especializados en bodas en Barcelona, Maresme, Penedès y toda Cataluña. Perfiles verificados, portfolios reales y contrato digital automático.</p>
