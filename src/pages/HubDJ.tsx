      ...
      <div className="min-h-screen" style={{ background: '#090909', color: '#fff' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#8E8EA0' }}>Todo lo que necesitas saber antes de contratar un DJ: precios reales por tipo de evento, diferencias entre perfiles y qué debe incluir el contrato.</p>
          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <p className="text-xs mt-3" style={{ color: '#8E8EA0' }}>Precios orientativos en España 2026. Sin IVA. Variable según ciudad y experiencia.</p>
            </section>
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#8E8EA0' }}>XPEAK tiene DJs verificados para bodas, fiestas privadas y eventos corporativos en toda España. Compara perfiles y contrata con contrato digital automático.</p>
