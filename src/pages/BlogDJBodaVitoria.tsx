  ...
  return (
    <>
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({ '@context': 'https://schema.org', '@type': 'Article', headline: `DJ para bodas en ${ciudad}: precio y cómo contratar en 2026`, datePublished: '2026-06-04', author: { '@type': 'Organization', name: 'XPEAK' } })}</script>
      </Helmet>
      <div className="min-h-screen" style={{ background: '#090909', color: '#fff' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#8E8EA0' }}>{ciudad} es la capital del País Vasco y ofrece una mezcla única de palacios medievales en la ciudad y bodegas espectaculares en la Rioja Alavesa. Guía completa de precios para bodas en 2026.</p>
          ...
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#8E8EA0' }}>XPEAK conecta organizadores con DJs verificados en el País Vasco y Álava. Contrato digital automático.</p>
