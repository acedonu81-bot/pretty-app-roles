...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', name: `DJs para bodas en Vitoria`, description: `Encuentra y contrata DJs verificados para bodas y eventos en Vitoria. Contratos digitales.`, serviceType: 'DJ para bodas y eventos', areaServed: { '@type': 'City', name: 'Vitoria' }, provider: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es' }, url: `https://xpeak.es/blog/dj-bodas-vitoria`, offers: { '@type': 'Offer', price: '0', priceCurrency: 'EUR' } };
  ...
  return (
    <>
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({ '@context': 'https://schema.org', '@type': 'Article', headline: `DJ para bodas en ${ciudad}: precio y cómo contratar en 2026`, datePublished: '2026-06-04', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' } })}</script>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>{ciudad} es la capital del País Vasco y ofrece una mezcla única de palacios medievales en la ciudad y bodegas espectaculares en la Rioja Alavesa. Guía completa de precios para bodas en 2026.</p>
