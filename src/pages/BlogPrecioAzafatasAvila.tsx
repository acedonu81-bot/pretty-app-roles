...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Ávila: guía 2026', description: 'Cuánto cobran las azafatas para eventos institucionales y culturales en Ávila. Tarifas por perfil 2026.', datePublished: '2026-05-25', dateModified: '2026-07-23', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-avila' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Ávila?', acceptedAnswer: { '@type': 'Answer', text: 'En Ávila una azafata de eventos cobra entre 9€ y 14€/hora bruto, por debajo de la media nacional por tratarse de un mercado pequeño con volumen de eventos limitado. Las agencias facturan al cliente entre 90€ y 140€/día por el servicio completo, cifra que incluye el margen de gestión de la agencia.' } },
