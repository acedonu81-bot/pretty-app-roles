      ...
      <div className="min-h-screen" style={{ background: '#090909', color: '#fff' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#8E8EA0' }}>Sevilla es la capital de la boda andaluza. Haciendas, cortijos y patios coloniales concentran algunos de los eventos más espectaculares de España. Precios más competitivos que Madrid — te contamos exactamente cuánto y cómo elegir bien.</p>
          ...
          <div className="space-y-10">
            <section>
              ...
              <p className="text-xs mt-3" style={{ color: '#8E8EA0' }}>Precios para Sevilla y provincia 2026. Sin IVA. En la media nacional, más económico que Madrid o Barcelona.</p>
            </section>
            ...
            <section>
              ...
              <p className="text-xs mt-3" style={{ color: '#8E8EA0' }}>Las haciendas de la campiña suelen cerrar a la 1:00-2:00. Confirma el horario con el venue antes de contratar el DJ.</p>
            </section>
            <section>
              <h2 className="text-lg font-black mb-3">Qué diferencia a un DJ de bodas en Sevilla</h2>
              <p className="text-sm leading-relaxed mb-3" style={{ color: 'rgba(255,255,255,0.75)' }}>Las bodas sevillanas tienen una estructura muy marcada: ceremonia (muchas veces religiosa en iglesia histórica), cóctel en el jardín de la hacienda y cena con pista de baile hasta la madrugada. El DJ entra en el cóctel y lleva la noche hasta el cierre. La música en Sevilla mezcla copla, flamenco pop, comercial español y música latina en proporciones que varían mucho según el perfil de los novios.</p>
              <p className="text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.75)' }}>El calor es un factor crítico: muchas haciendas no tienen climatización en la pista exterior, por lo que el DJ debe saber gestionar el ritmo de la noche según la temperatura. Los meses de otoño (octubre-noviembre) son los más cómodos y los más demandados.</p>
            </section>
            <section>
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#8E8EA0' }}>XPEAK tiene DJs especializados en bodas en Sevilla, haciendas y toda Andalucía. Perfiles verificados, portfolios reales y contrato digital automático.</p>
