  ...
  return (
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
          ...
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(217,119,6,0.04)', border: '1px solid rgba(217,119,6,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#3d3d4e' }}>
                Crea tu perfil verificado en XPEAK y consigue que salas y organizadores te contacten directamente.
              </p>
        ...
        <FooterPublic />
        <BlogScrollCTA role="staff_pro" storageKey="xpeak_scrollcta_promotor_precio_v2" articlePath="/blog/cuanto-cobra-un-promotor-rrpp" />
      </div>
    </>
  );
}
