...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Torrevieja: guía 2026', description: 'Cuánto cobran las azafatas para eventos con clientela internacional en Torrevieja. Tarifas por perfil 2026.', datePublished: '2026-05-17', dateModified: '2026-08-04', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-torrevieja' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Torrevieja?', acceptedAnswer: { '@type': 'Answer', text: 'En Torrevieja, una azafata de eventos cobra entre 14€ y 19€/hora bruto, por encima de la media nacional debido a la gran población internacional residente que multiplica los eventos con clientela extranjera. Las agencias facturan al cliente entre 135€ y 195€/día por perfil, cifra que incluye el margen de gestión de la agencia. Los idiomas son un factor clave en la tarifa.' } },
