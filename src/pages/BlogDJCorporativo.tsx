      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <article className="max-w-3xl mx-auto px-4 sm:px-6 pt-6 pb-20 sm:pb-24">
          ...
          <p className="text-xs mb-6 font-bold" style={{ color: '#666' }}>
            <a href="/" className="hover:text-[#8A6D0F] transition-colors">XPEAK</a> › <a href="/blog" className="hover:text-[#8A6D0F] transition-colors">Blog</a> › <span>DJ corporativo</span>
          </p>
          ...
          <div className="p-4 rounded-xl mb-8" style={{ background: 'rgba(212,175,55,0.06)', border: '1px solid rgba(212,175,55,0.15)' }}>
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#333' }}>
              Un DJ para evento corporativo en España cuesta entre <strong style={{ color: '#111' }}>400€ y 2.000€</strong> según el tipo de evento y el aforo.
          ...
          <div className="rounded-2xl overflow-hidden mb-2" style={{ border: '1px solid rgba(212,175,55,0.2)' }}>
            <div className="p-8" style={{ background: 'linear-gradient(135deg,#0e0e14 0%,#181410 100%)', color: '#fff', borderBottom: '1px solid rgba(212,175,55,0.15)' }}>
              ...
              <p className="text-base mb-5 leading-relaxed" style={{ color: 'rgba(255,255,255,0.6)' }}>
                Tarifas públicas, Flash Booking para fechas urgentes y contratos automáticos.
              </p>
              <a href="/contratar-dj"
            ...
            <div className="p-6 flex flex-col sm:flex-row items-center justify-between gap-4" style={{ background: 'rgba(0,0,0,0.02)' }}>
              <div>
                ...
                <p className="text-xs" style={{ color: '#333' }}>Publica tu perfil y tus tarifas.</p>
              </div>
