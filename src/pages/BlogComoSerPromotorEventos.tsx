      ...
      <div className="min-h-screen" style={{ background: '#090909', color: '#fff' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#3d3d4e' }}>El promotor de eventos es uno de los perfiles más demandados en la industria del ocio nocturno y los eventos privados. No necesitas título ni experiencia previa — necesitas red de contactos, capacidad de gestión y saber cómo estructurar tu trabajo desde el primer día.</p>
