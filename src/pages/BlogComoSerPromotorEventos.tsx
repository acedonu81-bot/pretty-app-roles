    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#090909', color: '#fff' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#D4AF37' }}>Para Promotores · XPEAK Blog</p>
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#8E8EA0' }}>El promotor de eventos es uno de los perfiles más demandados en la industria del ocio nocturno y los eventos privados. No necesitas título ni experiencia previa — necesitas red de contactos, capacidad de gestión y saber cómo estructurar tu trabajo desde el primer día.</p>
          ...
          <div className="space-y-10">
            <section>
              ...
              <div className="space-y-3">
                {MODELOS.map((m, i) => (
                  <div key={m.modelo} className="p-4 rounded-xl" style={{ background: i % 2 === 0 ? 'rgba(255,255,255,0.025)' : 'rgba(255,255,255,0.015)', border: '1px solid rgba(255,255,255,0.04)' }}>
                    <div className="flex items-start justify-between mb-1">
                      <p className="text-xs font-bold">{m.modelo}</p>
                      <span className="text-[0.6rem] font-bold px-2 py-0.5 rounded ml-3 shrink-0" style={{ background: 'rgba(212,175,55,0.1)', color: '#D4AF37' }}>{m.desc}</span>
                    </div>
                    <p className="text-xs" style={{ color: '#8E8EA0' }}>{m.pros}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#8E8EA0' }}>Crea tu perfil en XPEAK gratis. Salas, clubes y promotoras en tu ciudad ven tu red y te contactan directamente para sus eventos. Sin comisión oculta.</p>
              <a href="/auth?role=promotor" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#D4AF37,#B8941E)', color: '#000' }}>Crear mi perfil de promotor gratis →</a>
            </div>
          </div>
