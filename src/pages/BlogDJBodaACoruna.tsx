...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'DJ para bodas en A Coruña: precio y cómo contratar en 2026', description: 'Cuánto cuesta un DJ para una boda en A Coruña. Precios reales 2026, pazos, fincas gallegas y cómo contratar el mejor DJ en Galicia.', datePublished: '2026-06-03', dateModified: '2026-06-03', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/dj-bodas-a-coruna' };
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>Galicia tiene una tradición de bodas muy arraigada con los pazos como venue estrella. A Coruña combina venues históricos, fincas atlánticas y una escena de DJs activa. Esta es la guía de precios y claves para contratar en 2026.</p>
