...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'DJ para bodas en Córdoba: precio y cómo contratar en 2026', description: 'Cuánto cuesta un DJ para una boda en Córdoba. Precios reales 2026, haciendas, cortijos y cómo contratar el mejor DJ en la provincia.', datePublished: '2026-06-03', dateModified: '2026-06-03', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/dj-bodas-cordoba' };
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>Córdoba ofrece algunos de los venues más impresionantes de Andalucía: haciendas históricas, patios con naranjos y cortijos en la campiña. Y los precios de DJ son más competitivos que en Sevilla o Málaga. Esta guía te explica qué esperar en 2026.</p>
            <time className="text-xs mt-3 block" style={{ color: '#666' }}>3 junio 2026</time>
            <BlogAnswerBox
              question="¿Cuánto cuesta un DJ para una boda en Córdoba?"
              answer="Un DJ para el servicio completo de una boda en Córdoba (ceremonia, cóctel, cena y pista de baile) cuesta entre 550 y 1.400€ en 2026. El precio varía según la duración del evento, el equipo técnico incluido y la experiencia del DJ."
            />
          </div>
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#3d3d4e' }}>XPEAK conecta organizadores con DJs verificados en toda Andalucía. Contrato digital automático incluido.</p>
