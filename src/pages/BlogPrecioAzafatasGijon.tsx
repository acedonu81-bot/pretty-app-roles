...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Gijón: guía 2026', description: 'Cuánto cobran las azafatas para eventos, bodas con vistas al Cantábrico y ferias en Gijón. Tarifas por perfil 2026.', datePublished: '2026-06-11', dateModified: '2026-07-06', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-gijon' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Gijón?', acceptedAnswer: { '@type': 'Answer', text: 'En Gijón, una azafata de eventos cobra entre 12€ y 18€/hora bruto, en línea con la media nacional y algo por debajo de las grandes capitales. Las agencias facturan al cliente entre 120€ y 175€/día por perfil, cifra que incluye el margen de gestión de la agencia. En verano, con el turismo de costa y la Semana Grande de agosto, la demanda sube notablemente.' } },
