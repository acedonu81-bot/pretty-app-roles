...
const CATEGORY_DATA: Record<string, {
  ...
  dj: {
    slug: 'dj',
    emoji: '🎧',
    h1: 'Contratar DJ para tu Evento',
    tagline: 'El directorio de DJs profesionales de España',
    ...
    intro: 'XPEAK es la plataforma de referencia para salas, promotoras y organizadores que necesitan contratar un DJ profesional en España. Perfiles verificados, tarifas públicas y contratos digitales listos en minutos.',
    keyword: 'DJ',
    keywords: 'contratar DJ España, contratar DJ profesional, DJ eventos España, DJ boda España, DJ sala España, plataforma DJs',
  ...
  camareros: {
    slug: 'camareros',
    emoji: '🍽️',
    h1: 'Contratar Camareros para Eventos',
    tagline: 'Personal de sala y servicio verificado para bodas, eventos de empresa y fiestas privadas',
    ...
    keyword: 'Camareros',
    keywords: 'contratar camareros boda España, camareros para eventos Madrid, contratar camareros Barcelona, personal de sala eventos, camareros fiestas privadas, camareros eventos empresa',
  ...
  catering: {
    ...
    desc: 'Encuentra servicios de catering profesional para bodas, eventos de empresa y celebraciones privadas en España. Menús personalizados, servicio completo, contratos automáticos. Sin comisión.',
    ...
    keyword: 'Catering',
    keywords: 'contratar catering boda España, catering eventos corporativos Madrid, catering bodas Barcelona, servicio catering eventos, catering empresa España, banquete boda catering',
