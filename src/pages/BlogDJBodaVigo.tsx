...
const faq = [{ q: `¿Cuánto cuesta un DJ para una boda en ${ciudad}?`, a: `Entre 450€ y 1.500€. Vigo es la ciudad más grande de Galicia y tiene buena oferta de DJs. Los pazos con vistas a la Ría de Vigo son los venues más demandados.` },{ q: `¿Cuándo es la mejor época para bodas en ${ciudad}?`, a: `Julio y agosto son los más seguros climáticamente. Las Rías Bajas tienen clima más suave que el norte de Galicia, con menos lluvia en verano.` },{ q: `¿Los pazos de Vigo tienen su propia lista de DJs?`, a: `Algunos pazos tienen proveedores recomendados, pero la mayoría permiten DJ externo. Confirma con el venue antes de cerrar el DJ y pregunta si hay restricciones de horario o decibelios.` }];
...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', name: `DJs para bodas en Vigo`, description: `Encuentra y contrata DJs verificados para bodas y eventos en Vigo. Contratos digitales.`, serviceType: 'DJ para bodas y eventos', areaServed: { '@type': 'City', name: 'Vigo' }, provider: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es' }, url: `https://xpeak.es/blog/dj-bodas-vigo`, offers: { '@type': 'Offer', price: '0', priceCurrency: 'EUR' } };
export default function BlogDJBodaVigo() {
  const articleSchema = {
    '@context': 'https://schema.org',
    '@type': 'Article',
    headline: "DJ para bodas en Vigo: precio 2026",
    description: "",
    author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' },
    publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es' },
    datePublished: '2026-06-07',
    dateModified: '2026-06-07',
    url: "https://xpeak.es/blog/dj-bodas-vigo",
    mainEntityOfPage: { '@type': 'WebPage', '@id': "https://xpeak.es/blog/dj-bodas-vigo" },
  };
  ...
  <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
    ...
    <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
      ...
      <div className="mb-8"><p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#D4AF37' }}>DJ · {ciudad} · XPEAK Blog</p><h1 className="text-2xl sm:text-4xl font-black tracking-tight leading-tight mb-4">DJ para bodas en {ciudad}: precio y cómo contratar en 2026</h1><p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>{ciudad} ofrece bodas con vistas a la Ría más impresionante de España, con pazos centenarios y un clima atlántico perfecto en verano. Guía completa de precios 2026.</p><time className="text-xs mt-3 block" style={{ color: '#666' }}>4 junio 2026</time><BlogAnswerBox question={`¿Cuánto cuesta un DJ para una boda en ${ciudad}?`} answer={`Un DJ para el servicio completo de una boda en ${ciudad} (ceremonia, cóctel, cena y pista de baile) cuesta entre 620 y 1.500€ en 2026. El precio varía según la duración del evento, el equipo técnico incluido y la experiencia del DJ.`} /></div>
      <div className="space-y-10">
        ...
        <BlogInlineCTA role="dj" variant="upgrade" articlePath="/blog/dj-bodas-vigo" />
        ...
        <div className="p-6 rounded-2xl text-center" style={{background:'rgba(212,175,55,0.04)',border:'1px solid rgba(212,175,55,0.12)'}}><p className="text-sm font-black mb-2">¿Buscas DJ para tu boda en {ciudad}?</p><p className="text-xs mb-4" style={{color:'#3d3d4e'}}>XPEAK conecta con DJs verificados en Galicia y las Rías Bajas. Contrato digital automático.</p><a href="/contratar-dj" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black" style={{background:'linear-gradient(90deg,#D4AF37,#B8941E)',color:'#000'}}>Ver DJs de bodas en {ciudad} →</a></div>
      </div>
              <DJResourcesAffiliate role="dj" />

              <BlogEmailCapture variant="presupuestos" intent="contratar-dj" articlePath="/blog/dj-bodas-vigo" />
</main>
    <BlogAuthor />
        <BlogRelatedPosts currentSlug='/blog/dj-bodas-vigo' tag='DJ' />
        <FooterPublic />
    <BlogScrollCTA role="dj" storageKey={`xpeak_scrollcta_${slug}`} articlePath="/blog/dj-bodas-vigo" />
  </div></>);
}
