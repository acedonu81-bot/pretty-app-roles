...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Lleida: guía 2026', description: 'Cuánto cobran las azafatas para eventos, ferias y bodas en Lleida. Tarifas económicas de mercado de interior 2026.', datePublished: '2026-04-20', dateModified: '2026-06-27', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-lleida' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Lleida?', acceptedAnswer: { '@type': 'Answer', text: 'En Lleida, una azafata de eventos cobra entre 11€ y 16€/hora bruto, por debajo de la media catalana al tratarse de un mercado de interior con menos volumen turístico. Las agencias facturan al cliente entre 110€ y 160€/día por perfil, con precios competitivos frente a Barcelona o la costa, cifra que incluye el margen de gestión de la agencia.' } },
