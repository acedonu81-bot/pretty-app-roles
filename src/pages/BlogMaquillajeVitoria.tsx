...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de maquilladora para eventos en Vitoria-Gasteiz: guía 2026', description: 'Cuánto cobra una maquilladora para bodas y eventos institucionales en Vitoria-Gasteiz. Tarifas por servicio 2026.', datePublished: '2026-06-13', dateModified: '2026-07-06', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/maquillaje-eventos-vitoria' };
