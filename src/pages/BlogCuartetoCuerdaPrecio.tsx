        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <div className="mt-4 p-4 rounded-xl text-sm" style={{ background: 'rgba(212,175,55,0.06)', border: '1px solid rgba(212,175,55,0.15)', color: 'rgba(255,255,255,0.7)' }}>
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed mb-4" style={{ color: 'rgba(255,255,255,0.7)' }}>
                Los cuartetos con buena reputación tienen agenda muy limitada en temporada alta. La norma general es reservar con <strong style={{ color: '#fff' }}>6-9 meses de antelación</strong> si la boda es entre mayo y octubre.
              </p>
            ...
            <section className="rounded-2xl p-6 sm:p-8 text-center" style={{ background: 'rgba(212,175,55,0.05)', border: '1px solid rgba(212,175,55,0.15)' }}>
              ...
              <p className="text-xs mb-5" style={{ color: 'rgba(255,255,255,0.5)' }}>Cuartetos, tríos, grupos de jazz y música en vivo. Perfiles verificados con precio público. Sin comisión.</p>
