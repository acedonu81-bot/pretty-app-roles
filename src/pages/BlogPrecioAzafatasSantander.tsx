...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Santander: guía 2026', description: 'Cuánto cobran las azafatas para eventos institucionales, congresos y bodas en la costa de Santander. Tarifas por perfil 2026.', datePublished: '2026-04-29', dateModified: '2026-08-07', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-santander' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Santander?', acceptedAnswer: { '@type': 'Answer', text: 'En Santander, una azafata de eventos cobra entre 12€ y 18€/hora bruto, en línea con la media nacional. Las agencias facturan al cliente entre 115€ y 175€/día por perfil, cifra que incluye el margen de gestión de la agencia. El turismo de verano en Cantabria y los eventos institucionales de la ciudad generan una demanda estable con un pico en la temporada estival.' } },
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#059669' }}>Staff · Santander · XPEAK Blog</p>
            ...
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>Santander combina un calendario de eventos institucionales estable con un fuerte repunte de actividad en verano gracias al turismo de Cantabria. Las tarifas se mantienen en línea con la media nacional durante todo el año.</p>
          ...
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(5,150,105,0.04)', border: '1px solid rgba(5,150,105,0.12)' }}>
              ...
              <a href="/contratar-staff/santander" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#059669,#B8941E)', color: '#000' }}>Ver staff en Santander →</a>
            </div>
          </div>
