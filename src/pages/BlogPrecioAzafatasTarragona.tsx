...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Tarragona: guía 2026', description: 'Cuánto cobran las azafatas para eventos institucionales, culturales y corporativos en Tarragona. Tarifas por perfil 2026.', datePublished: '2026-04-04', dateModified: '2026-07-16', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-tarragona' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Tarragona?', acceptedAnswer: { '@type': 'Answer', text: 'En Tarragona, una azafata de eventos cobra entre 13€ y 19€/hora bruto, en línea con la media de ciudades medianas catalanas. Las agencias facturan al cliente entre 130€ y 190€/día por perfil, cifra que incluye el margen de gestión de la agencia. Los eventos institucionales y culturales ligados al patrimonio romano suelen requerir perfiles con formación en atención al público.' } },
