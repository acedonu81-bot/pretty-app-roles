    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#090909', color: '#fff' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#D4AF37' }}>Fotografía · Barcelona · XPEAK Blog</p>
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#8E8EA0' }}>Barcelona tiene una de las escenas de fotografía de bodas más activas de Europa. Desde el documental puro hasta el editorial mediterráneo — precios reales y cómo encontrar el estilo que se adapta a tu boda.</p>
          ...
          <div className="space-y-10">
            <section>
              ...
              <p className="text-xs mt-3" style={{ color: '#8E8EA0' }}>Precios Barcelona 2026. Sin IVA. Similar a Madrid, un 20-30% por encima de la media nacional.</p>
            </section>
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#8E8EA0' }}>XPEAK tiene fotógrafos verificados para bodas en Barcelona, Maresme y Penedès. Portfolios reales, reseñas verificadas y contrato digital automático.</p>
              <a href="/contratar-fotografo/barcelona" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#D4AF37,#B8941E)', color: '#000' }}>Ver fotógrafos en Barcelona →</a>
            </div>
          </div>
