...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Pamplona: guía 2026', description: 'Cuánto cobran las azafatas para eventos corporativos, bodas en fincas de Navarra y ferias en Pamplona. Tarifas por perfil 2026.', datePublished: '2026-05-31', dateModified: '2026-06-18', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-pamplona' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Pamplona?', acceptedAnswer: { '@type': 'Answer', text: 'En Pamplona, una azafata de eventos cobra entre 12€ y 19€/hora bruto durante el año estándar, en línea con la media nacional. Las agencias facturan al cliente entre 130€ y 185€/día por perfil, cifra que incluye el margen de gestión de la agencia. Fuera de esta guía general, conviene saber que San Fermín (julio) es un pico de demanda de personal muy marcado en la ciudad.' } },
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#059669' }}>Staff · Pamplona · XPEAK Blog</p>
            ...
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>Pamplona combina un tejido corporativo sólido ligado a la industria agroalimentaria de Navarra con un calendario de bodas en fincas del entorno. San Fermín, en julio, es aparte: dispara la demanda de personal de hostelería y eventos muy por encima del resto del año.</p>
          ...
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(5,150,105,0.04)', border: '1px solid rgba(5,150,105,0.12)' }}>
              ...
              <a href="/contratar-staff/pamplona" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#059669,#B8941E)', color: '#000' }}>Ver staff en Pamplona →</a>
            </div>
          </div>
