...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Leganés: guía 2026', description: 'Cuánto cobran las azafatas para congresos universitarios y eventos tecnológicos en Leganés. Tarifas por perfil 2026.', datePublished: '2026-05-15', dateModified: '2026-07-13', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-leganes' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Leganés?', acceptedAnswer: { '@type': 'Answer', text: 'En Leganés, una azafata de eventos cobra entre 12€ y 17€/hora bruto, algo por debajo de Madrid capital. Las agencias facturan al cliente entre 110€ y 170€/día por perfil, cifra que incluye el margen de gestión de la agencia. El campus principal de la Universidad Carlos III y el entorno tecnológico de la zona generan demanda constante de perfiles cualificados.' } },
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#059669' }}>Staff · Leganés · XPEAK Blog</p>
            ...
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>Leganés alberga el campus principal de la Universidad Carlos III de Madrid, lo que la convierte en un polo de congresos académicos y eventos del sector tecnológico. Las tarifas de azafatas se sitúan algo por debajo de Madrid capital, con picos de demanda ligados al calendario universitario.</p>
          ...
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(5,150,105,0.04)', border: '1px solid rgba(5,150,105,0.12)' }}>
              ...
              <a href="/contratar-staff/leganes" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#059669,#B8941E)', color: '#000' }}>Ver staff en Leganés →</a>
            </div>
          </div>
