...
const BentoCard = ({
  ...
  >
    ...
    <div className="relative z-10 h-full flex flex-col justify-end p-6">
      <div
        className="w-10 h-10 rounded-xl flex items-center justify-center mb-3 backdrop-blur-md"
        style={{
...
const StatPill = ({ value, label }: { value: string; label: string }) => (
  <div
    className="glass-panel-subtle px-5 py-3 text-center"
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden flex flex-col bg-background">
      ...
      <header className="max-w-[1200px] mx-auto px-6 md:px-8 pt-24 pb-20 md:pt-32 md:pb-28 text-center">
        <FadeIn>
          <p
            className="uppercase tracking-[0.3em] text-xs font-semibold mb-6"
            style={{ color: '#D4AF37' }}
          >
        ...
        <FadeIn delay={0.3}>
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <button
              ...
              className="btn-nightlife-secondary text-base px-8 py-4"
            >
              Ver Demo
            </button>
          </div>
      ...
      <section className="max-w-[1200px] mx-auto px-6 md:px-8 pb-24">
        <FadeIn>
          <p
            className="uppercase tracking-[0.25em] text-xs font-semibold mb-3 text-center"
            style={{ color: '#D4AF37' }}
          >
            Categorías
          </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 auto-rows-[200px] md:auto-rows-[260px]">
          <FadeIn delay={0} className="md:row-span-2">
            <BentoCard
              ...
              icon={<Music size={20} />}
              title="Música"
              subtitle="DJs, productores y técnicos de sonido"
              className="h-full"
            />
          </FadeIn>
          <FadeIn delay={0.1} className="md:col-span-2">
            <BentoCard
              ...
              title="Gastro"
              subtitle="Bartenders, chefs y catering premium"
              className="h-full"
            />
          </FadeIn>
          <FadeIn delay={0.2} className="md:row-span-2">
            <BentoCard
              ...
              icon={<Camera size={20} />}
              title="Imagen"
              subtitle="Fotógrafos, videógrafos y diseñadores"
              className="h-full"
            />
          </FadeIn>
          <FadeIn delay={0.3} className="md:col-span-2">
            <BentoCard
              ...
              icon={<Users size={20} />}
              title="Staff"
              subtitle="RRPP, hostess, seguridad y coordinación"
              className="h-full"
            />
          </FadeIn>
        </div>
      ...
      <FadeIn className="max-w-[1200px] mx-auto px-6 md:px-8 pb-24">
        ...
        >
          ...
          <button
            onClick={() => navigate('/auth')}
            className="relative z-10 btn-nightlife-primary text-base px-10 py-4"
          >
            Crear Perfil Gratis
          </button>
        </div>
