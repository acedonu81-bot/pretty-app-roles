...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Vigo: guía 2026', description: 'Cuánto cobran las azafatas para eventos corporativos del sector motor/naval y bodas en pazos en Vigo. Tarifas por perfil 2026.', datePublished: '2026-06-05', dateModified: '2026-06-30', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-vigo' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Vigo?', acceptedAnswer: { '@type': 'Answer', text: 'En Vigo, una azafata de eventos cobra entre 11€ y 17€/hora bruto, en línea o algo por debajo de la media nacional. Las agencias facturan al cliente entre 105€ y 165€/día por perfil, cifra que incluye el margen de gestión de la agencia. La industria del motor y naval de la ciudad genera un volumen constante de eventos corporativos durante todo el año.' } },
