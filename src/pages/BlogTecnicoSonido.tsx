      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <article className="max-w-3xl mx-auto px-4 sm:px-6 pt-6 pb-20 sm:pb-24">
          ...
          <p className="text-xs mb-6 font-bold" style={{ color: '#666' }}>
            <a href="/" className="hover:text-[#8A6D0F] transition-colors">XPEAK</a> › <a href="/blog" className="hover:text-[#8A6D0F] transition-colors">Blog</a> › <span>Técnico de sonido</span>
          </p>
          ...
          <div className="overflow-x-auto mb-10 rounded-xl" style={{ border: '1px solid rgba(0,0,0,0.08)' }}>
            <table className="w-full text-xs min-w-[520px]">
              ...
              <tbody>
                {TABLE.map((row, i) => (
                  <tr key={row.evento} style={{ background: i % 2 === 0 ? 'transparent' : 'rgba(0,0,0,0.015)' }}>
                    <td className="px-4 py-3 font-bold" style={{ borderBottom: '1px solid rgba(0,0,0,0.05)' }}>{row.evento}</td>
                    <td className="px-4 py-3 whitespace-nowrap" style={{ color: '#444', borderBottom: '1px solid rgba(0,0,0,0.05)' }}>{row.horas}</td>
