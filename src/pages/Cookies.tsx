      ...
      <div className="flex-1 z-10 max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="glass-panel p-6 md:p-8 space-y-6 text-sm leading-relaxed" style={{ color: 'rgba(22,20,18,0.78)' }}>
          ...
          <section>
            ...
            <p className="mb-3">XPEAK utiliza dos tipos de cookies: <strong style={{ color: "#111" }}>técnicas</strong> (necesarias, no requieren consentimiento) y <strong style={{ color: "#111" }}>opcionales</strong> (analítica y personalización, requieren tu consentimiento previo).</p>
            ...
            <p className="text-xs mt-3" style={{ color: "#222" }}>
              Las cookies opcionales solo se activan si otorgas consentimiento explícito mediante el banner de cookies. Puedes revocar tu consentimiento en cualquier momento desde <strong style={{ color: "#111" }}>Ajustes → Privacidad</strong>.
            </p>
          </section>

          <section>
            <h2 className="text-base font-bold mb-2" style={{ color: '#D4AF37' }}>3. Cookies de Terceros</h2>
            <p>Los pagos se procesan a través de <strong style={{ color: "#111" }}>Stripe Payments Europe Ltd.</strong>, que puede establecer sus propias cookies técnicas para el procesamiento seguro de transacciones (conformidad PCI-DSS). Puedes consultar la política de cookies de Stripe en su sitio web oficial.</p>
          </section>
