      ...
      <div className="flex-1 z-10 max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="glass-panel p-6 md:p-8 space-y-6 text-sm leading-relaxed" style={{ color: '#ccc' }}>
          ...
          <section>
            ...
            <p className="mb-3">XPEAK utiliza dos tipos de cookies: <strong className="text-foreground">técnicas</strong> (necesarias, no requieren consentimiento) y <strong className="text-foreground">opcionales</strong> (analítica y personalización, requieren tu consentimiento previo).</p>
            ...
            <p className="text-xs text-muted-foreground mt-3">
              Las cookies opcionales solo se activan si otorgas consentimiento explícito mediante el banner de cookies. Puedes revocar tu consentimiento en cualquier momento desde <strong className="text-foreground">Ajustes → Privacidad</strong>.
            </p>
          </section>

          <section>
            <h2 className="text-base font-bold mb-2" style={{ color: '#D4AF37' }}>3. Cookies de Terceros</h2>
            <p>Los pagos se procesan a través de <strong className="text-foreground">Stripe Payments Europe Ltd.</strong>, que puede establecer sus propias cookies técnicas para el procesamiento seguro de transacciones (conformidad PCI-DSS). Puedes consultar la política de cookies de Stripe en su sitio web oficial.</p>
          </section>
          ...
          <section>
            ...
            <p>El uso de cookies técnicas estrictamente necesarias se ampara en el <strong className="text-foreground">interés legítimo</strong> del responsable del tratamiento (art. 22.2 LSSI-CE y RGPD). El uso de cookies opcionales de analítica y personalización se basa en el <strong className="text-foreground">consentimiento explícito</strong> del usuario (art. 6.1.a RGPD), que puede revocarse en todo momento sin perjuicio para la licitud del tratamiento previo.</p>
          </section>
