...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Sabadell: guía 2026', description: 'Cuánto cobran las azafatas para eventos corporativos y ferias en Sabadell. Tarifas por perfil 2026.', datePublished: '2026-05-31', dateModified: '2026-07-03', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-sabadell' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Sabadell?', acceptedAnswer: { '@type': 'Answer', text: 'En Sabadell, una azafata de eventos cobra entre 13€ y 19€/hora bruto, algo por debajo de Barcelona capital. Las agencias facturan al cliente entre 130€ y 190€/día por perfil, cifra que incluye el margen de gestión de la agencia. El mercado es de tamaño medio, con eventos corporativos ligados a la tradición empresarial de la ciudad.' } },
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <BlogInlineCTA role="azafata" variant="upgrade" articlePath="/blog/precio-azafatas-sabadell" />
        ...
        <FooterPublic />
        <BlogScrollCTA role="azafata_pro" storageKey="xpeak_scrollcta_precio_azafatas_sabadell_v2" articlePath="/blog/precio-azafatas-sabadell" />
      </div>
    </>
  );
}
