      ...
      <div className="min-h-screen" style={{ background: '#090909', color: '#fff' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#3d3d4e' }}>{ciudad} combina bodas urbanas de lujo con celebraciones en caseríos vascos del interior de Gipuzkoa. Es una de las ciudades con mayor poder adquisitivo de España y los estándares de calidad son muy altos. Guía de precios real para 2026.</p>
