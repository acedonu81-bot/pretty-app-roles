...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'DJ para bodas en Zaragoza: precio y cómo contratar en 2026', description: 'Cuánto cuesta un DJ para una boda en Zaragoza. Precios reales 2026, Aragón, la ribera del Ebro y los palacios mudéjares de la capital aragonesa.', datePublished: '2026-06-03', dateModified: '2026-06-03', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/dj-bodas-zaragoza' };
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="space-y-10">
            ...
            <BlogInlineCTA role="dj" articlePath="/blog/dj-bodas-zaragoza" />
            <section>
        ...
        <FooterPublic />
        <BlogScrollCTA role="dj" storageKey="xpeak_scrollcta_dj_boda_zaragoza" articlePath="/blog/dj-bodas-zaragoza" />
      </div>
    </>
  );
}
