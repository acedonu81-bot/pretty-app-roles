...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Santiago de Compostela: guía 2026', description: 'Cuánto cobran las azafatas para eventos institucionales, universitarios y bodas en el casco histórico de Santiago. Tarifas 2026.', datePublished: '2026-05-28', dateModified: '2026-07-31', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-santiago' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Santiago de Compostela?', acceptedAnswer: { '@type': 'Answer', text: 'En Santiago de Compostela, una azafata de eventos cobra entre 11€ y 17€/hora bruto, en línea con la media nacional. Las agencias facturan al cliente entre 105€ y 165€/día por perfil, cifra que incluye el margen de gestión de la agencia. El Camino de Santiago y el turismo religioso mantienen una demanda constante durante todo el año, no solo en temporada de bodas.' } },
