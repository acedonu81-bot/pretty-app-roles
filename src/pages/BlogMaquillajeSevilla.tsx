...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de maquilladora para eventos en Sevilla: guía 2026', description: 'Cuánto cobra una maquilladora para bodas, eventos corporativos y sesiones de foto en Sevilla. Tarifas por servicio 2026.', datePublished: '2026-04-01', dateModified: '2026-04-19', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/maquillaje-eventos-sevilla' };
