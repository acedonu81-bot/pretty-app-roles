      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        <article className="max-w-3xl mx-auto px-4 py-12">
          <nav className="text-xs text-[#666] mb-6 flex gap-2">
            ...
            <span className="text-[#333]">DJ Techno Madrid</span>
          </nav>
          ...
          <div className="overflow-x-auto mb-8">
            <table className="w-full text-sm border-collapse">
              <thead><tr style={{ background: 'rgba(212,175,55,0.08)' }}>
                <th className="text-left p-3 border border-black/[0.08]">Nivel</th>
                <th className="text-left p-3 border border-black/[0.08]">Escenario</th>
                <th className="text-left p-3 border border-black/[0.08]">Tarifa</th>
              ...
              <tbody>{TARIFAS.map((t, i) => (
                <tr key={i} style={{ background: i % 2 === 0 ? 'transparent' : 'rgba(0,0,0,0.02)' }}>
                  <td className="p-3 border border-black/[0.08] font-medium">{t.nivel}</td>
                  <td className="p-3 border border-black/[0.08] text-[#555]">{t.escenario}</td>
                  <td className="p-3 border border-black/[0.08] font-bold" style={{ color: '#D4AF37' }}>{t.tarifa}</td>
          ...
          <ul className="list-disc list-inside space-y-2 text-[#333] mb-8">
