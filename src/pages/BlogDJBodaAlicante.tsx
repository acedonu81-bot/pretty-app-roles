...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'DJ para bodas en Alicante: precio y cómo contratar en 2026', description: 'Cuánto cuesta un DJ para una boda en Alicante. Precios reales 2026, Costa Blanca, zonas y cómo contratar el mejor DJ.', datePublished: '2026-06-03', dateModified: '2026-06-03', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/dj-bodas-alicante' };
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>La Costa Blanca es uno de los destinos de boda internacionales más importantes de España. Alicante combina bodas locales en masías del interior con bodas de lujo para clientes extranjeros en Jávea, Altea y Moraira. Aquí tienes los precios reales de 2026.</p>
            <time className="text-xs mt-3 block" style={{ color: '#666' }}>3 junio 2026</time>
            <BlogAnswerBox
              question="¿Cuánto cuesta un DJ para una boda en Alicante?"
              answer="Un DJ para el servicio completo de una boda en Alicante (ceremonia, cóctel, cena y pista de baile) cuesta entre 650 y 1.600€ en 2026. El precio varía según la duración del evento, el equipo técnico incluido y la experiencia del DJ."
            />
          </div>
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#3d3d4e' }}>XPEAK tiene DJs especializados en bodas en Alicante y la Costa Blanca. Perfiles verificados, contrato digital automático.</p>
