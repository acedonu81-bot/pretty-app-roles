...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Tenerife: guía 2026', description: 'Cuánto cobran las azafatas para eventos corporativos, bodas de lujo y turismo internacional en Tenerife. Tarifas por perfil 2026.', datePublished: '2026-03-10', dateModified: '2026-04-15', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-tenerife' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Tenerife?', acceptedAnswer: { '@type': 'Answer', text: 'En Tenerife, una azafata de eventos cobra entre 13€ y 21€/hora bruto, por encima de la media nacional debido a la logística de archipiélago y al volumen de turismo internacional durante todo el año. Las agencias facturan al cliente entre 140€ y 210€/día por perfil, cifra que incluye el margen de gestión de la agencia.' } },
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <BlogInlineCTA role="azafata" variant="upgrade" articlePath="/blog/precio-azafatas-tenerife" />
        ...
        <FooterPublic />
        <BlogScrollCTA role="azafata_pro" storageKey="xpeak_scrollcta_precio_azafatas_tenerife_v2" articlePath="/blog/precio-azafatas-tenerife" />
      </div>
    </>
  );
}
