        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <p className="text-xs mt-3" style={{ color: '#3d3d4e' }}>Precios orientativos España 2026. Sin IVA. Madrid y Barcelona suelen estar un 20-30% por encima de la media nacional.</p>
            </section>
            <section>
