...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Cuenca: guía 2026', description: 'Cuánto cobran las azafatas para eventos culturales y turísticos en Cuenca. Tarifas por perfil 2026.', datePublished: '2026-05-18', dateModified: '2026-05-27', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-cuenca' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Cuenca?', acceptedAnswer: { '@type': 'Answer', text: 'En Cuenca una azafata de eventos cobra entre 9€ y 15€/hora bruto, por debajo de la media nacional por ser un mercado pequeño. Las agencias facturan al cliente entre 90€ y 145€/día por el servicio completo.' } },
  { '@type': 'Question', name: '¿Dónde se concentra la demanda de azafatas en Cuenca?', acceptedAnswer: { '@type': 'Answer', text: 'Las Casas Colgadas y el casco histórico (Patrimonio de la Humanidad) generan demanda turística y cultural constante. La Ciudad Encantada también atrae eventos y visitas organizadas que requieren personal de recepción y apoyo.' } },
  { '@type': 'Question', name: '¿Con cuánta antelación reservar azafatas para un evento en Cuenca?', acceptedAnswer: { '@type': 'Answer', text: 'Para eventos culturales o turísticos en el casco histórico, 3 semanas de antelación suelen ser suficientes. Al tratarse de un mercado pequeño, la disponibilidad de perfiles no suele ser un problema fuera de fechas muy señaladas.' } },
  { '@type': 'Question', name: '¿Qué perfil de azafata se pide más en Cuenca?', acceptedAnswer: { '@type': 'Answer', text: 'El perfil de azafata de recepción e información turística es habitual por el flujo de visitantes al casco histórico, junto con azafatas de imagen para eventos institucionales y culturales.' } },
] };
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#059669' }}>Staff · Cuenca · XPEAK Blog</p>
            <h1 className="text-2xl sm:text-4xl font-black tracking-tight leading-tight mb-4">Precio de azafatas para eventos en Cuenca: guía 2026</h1>
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>Cuenca es un mercado de eventos pequeño donde el atractivo turístico de las Casas Colgadas y la Ciudad Encantada genera demanda puntual de personal de recepción, con precios claramente por debajo de la media nacional.</p>
            <time className="text-xs mt-3 block" style={{ color: '#666' }}>8 julio 2026</time>
            <BlogAnswerBox
              question="¿Cuánto cobran las azafatas en Cuenca?"
          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <div className="space-y-2">{['Casas Colgadas y casco histórico (Patrimonio de la Humanidad): eventos culturales y turísticos','Ciudad Encantada: visitas organizadas y eventos ligados al turismo de naturaleza','Actos institucionales de la administración provincial','Celebraciones y bodas con encanto en el casco histórico'].map((item,i) => (<div key={i} className="flex items-start gap-3 p-3 rounded-lg" style={{ background: 'rgba(0,0,0,0.02)' }}><span className="text-xs font-black shrink-0 mt-0.5" style={{ color: '#059669' }}>✓</span><p className="text-xs" style={{ color: '#111' }}>{item}</p></div>))}</div>
            </section>
            <section>
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(5,150,105,0.04)', border: '1px solid rgba(5,150,105,0.12)' }}>
              <p className="text-sm font-black mb-2">¿Necesitas azafatas para tu evento en Cuenca?</p>
              ...
              <a href="/contratar-staff/cuenca" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#059669,#B8941E)', color: '#000' }}>Ver staff en Cuenca →</a>
            </div>
          </div>
        ...
        <FooterPublic />
        <BlogScrollCTA role="azafata" storageKey="xpeak_scrollcta_precio_azafatas_cuenca" />
      </div>
    </>
  );
}
