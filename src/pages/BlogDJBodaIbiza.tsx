...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'DJ para bodas en Ibiza: precio y cómo contratar en 2026', description: 'Cuánto cuesta un DJ para una boda en Ibiza. Precios reales 2026, Capital mundial de la música electrónica y el mercado de bodas de lujo internacional más exclusivo.', datePublished: '2026-06-03', dateModified: '2026-06-03', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/dj-bodas-ibiza' };
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>Ibiza es única: la capital mundial de la música electrónica es también uno de los destinos de bodas de lujo más demandados de Europa. Los presupuestos son muy altos, la clientela mayoritariamente internacional y la temporada muy concentrada (mayo-octubre). Un DJ para boda en Ibiza no es lo mismo que un DJ de club: las bodas aquí requieren versatilidad y experiencia con clientes internacionales.</p>
          ...
          <div className="space-y-10">
            ...
            <BlogInlineCTA role="dj" articlePath="/blog/dj-bodas-ibiza" />
            <section>
        ...
        <FooterPublic />
        <BlogScrollCTA role="dj" storageKey="xpeak_scrollcta_dj_boda_ibiza" articlePath="/blog/dj-bodas-ibiza" />
      </div>
    </>
  );
}
