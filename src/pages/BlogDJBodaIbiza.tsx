      ...
      <div className="min-h-screen" style={{ background: '#090909', color: '#fff' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#8E8EA0' }}>Ibiza es única: la capital mundial de la música electrónica es también uno de los destinos de bodas de lujo más demandados de Europa. Los presupuestos son muy altos, la clientela mayoritariamente internacional y la temporada muy concentrada (mayo-octubre). Un DJ para boda en Ibiza no es lo mismo que un DJ de club — las bodas aquí requieren versatilidad y experiencia con clientes internacionales.</p>
          ...
          <div className="space-y-10">
            <section>
              ...
              <p className="text-xs mt-3" style={{ color: '#8E8EA0' }}>Precios Ibiza 2026. Sin IVA.</p>
            </section>
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#8E8EA0' }}>XPEAK tiene DJs especializados en bodas en Ibiza y alrededores. Perfiles verificados y contrato digital automático.</p>
