...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Murcia: guía 2026', description: 'Cuánto cobran las azafatas para eventos, ferias y bodas en fincas de la huerta en Murcia. Tarifas por perfil 2026.', datePublished: '2026-06-03', dateModified: '2026-08-08', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-murcia' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Murcia?', acceptedAnswer: { '@type': 'Answer', text: 'En Murcia, una azafata de eventos cobra entre 10€ y 15€/hora bruto, por debajo de la media nacional gracias a un mercado con plazas más económicas. Las agencias facturan al cliente entre 95€ y 150€/día por perfil, cifra que incluye el margen de gestión de la agencia. El clima cálido permite eventos al aire libre en más meses del año que en otras ciudades.' } },
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#059669' }}>Staff · Murcia · XPEAK Blog</p>
          ...
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(5,150,105,0.04)', border: '1px solid rgba(5,150,105,0.12)' }}>
              ...
              <a href="/contratar-staff/murcia" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#059669,#B8941E)', color: '#000' }}>Ver staff en Murcia →</a>
            </div>
          </div>
