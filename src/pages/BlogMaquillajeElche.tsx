    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#090909', color: '#fff' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#D4AF37' }}>Maquillaje · Elche · XPEAK Blog</p>
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#3d3d4e' }}>Elche combina bodas en fincas de su extenso término municipal con un patrimonio cultural único, el Palmeral, Patrimonio de la Humanidad. Las tarifas de maquillaje están algo por debajo de la media de las grandes capitales.</p>
          ...
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <a href="/contratar-maquillaje/elche" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#D4AF37,#B8941E)', color: '#000' }}>Ver maquilladoras en Elche →</a>
            </div>
          </div>
