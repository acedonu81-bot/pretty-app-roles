...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de maquilladora para eventos en Ibiza: guía 2026', description: 'Cuánto cobra una maquilladora para bodas y fiestas privadas en villas de Ibiza. Tarifas de temporada alta 2026.', datePublished: '2026-06-29', dateModified: '2026-07-07', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/maquillaje-eventos-ibiza' };
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#DB2777' }}>Maquillaje · Ibiza · XPEAK Blog</p>
            ...
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>Ibiza tiene el mercado de maquillaje de novia más caro de España: bodas en villas privadas con clientela internacional, técnicas resistentes a calor y agua, y una temporada muy concentrada entre mayo y septiembre.</p>
          ...
          <BlogInlineCTA role="makeup" variant="upgrade" articlePath="/blog/maquillaje-eventos-ibiza" />
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(219,39,119,0.04)', border: '1px solid rgba(219,39,119,0.12)' }}>
              ...
              <a href="/contratar-maquillaje/ibiza" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#DB2777,#B8941E)', color: '#000' }}>Ver maquilladoras en Ibiza →</a>
            </div>
          </div>
        ...
        <FooterPublic />
        <BlogScrollCTA role="makeup_pro" storageKey="xpeak_scrollcta_maquillaje_ibiza_v2" articlePath="/blog/maquillaje-eventos-ibiza" />
      </div>
    </>
  );
}
