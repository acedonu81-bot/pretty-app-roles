...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de camareros para eventos en Gijón: guía 2026', description: 'Cuánto cobran los camareros y bartenders para bodas en sidrerías, eventos con vistas al Cantábrico y fiestas en Gijón. Tarifas 2026.', datePublished: '2026-03-21', dateModified: '2026-04-29', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/camareros-eventos-gijon' };
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <BlogInlineCTA role="staff" variant="upgrade" articlePath="/blog/camareros-eventos-gijon" />
        ...
        <FooterPublic />
        <BlogScrollCTA role="staff_pro" storageKey="xpeak_scrollcta_camareros_gijon_v2" articlePath="/blog/camareros-eventos-gijon" />
      </div>
    </>
  );
}
