...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Jerez de la Frontera: guía 2026', description: 'Cuánto cobran las azafatas para catas de bodega, la Feria de Jerez y eventos ecuestres. Tarifas por perfil 2026.', datePublished: '2026-05-12', dateModified: '2026-06-22', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-jerez' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Jerez de la Frontera?', acceptedAnswer: { '@type': 'Answer', text: 'En Jerez de la Frontera, una azafata de eventos cobra entre 12€ y 18€/hora bruto, en línea con la media nacional o algo por debajo, como corresponde a una plaza comercial de interior de Cádiz. Las agencias facturan al cliente entre 120€ y 190€/día por perfil, cifra que incluye el margen de gestión de la agencia. En la Feria de Jerez (mayo) la demanda sube notablemente.' } },
