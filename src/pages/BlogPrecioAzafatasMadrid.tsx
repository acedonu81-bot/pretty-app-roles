...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Madrid: guía 2026', description: 'Cuánto cobran las azafatas para eventos, ferias (IFEMA) y congresos en Madrid. Tarifas por perfil y zona.', datePublished: '2026-04-11', dateModified: '2026-07-11', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-madrid' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Madrid?', acceptedAnswer: { '@type': 'Answer', text: 'En Madrid, una azafata de eventos cobra entre 13€ y 20€/hora bruto, algo por encima de la media nacional por el volumen de ferias en IFEMA. Las agencias facturan al cliente entre 130€ y 200€/día por perfil, cifra que incluye el margen de gestión de la agencia. Ferias grandes como FITUR o el Salón del Automóvil suben la demanda y la tarifa un 15-20%.' } },
