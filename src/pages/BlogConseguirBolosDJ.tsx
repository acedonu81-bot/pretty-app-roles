      ...
      <div className="min-h-screen" style={{ background: '#090909', color: '#fff' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#8E8EA0' }}>España mueve más de 180.000 bodas al año, miles de comuniones y decenas de miles de eventos privados. El trabajo está ahí — el problema es que pocos DJs saben cómo llegar a ese mercado. Aquí van las 8 estrategias que funcionan en 2026.</p>
          ...
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#8E8EA0' }}>Crea tu perfil en XPEAK gratis. Organizadores de bodas, comuniones y eventos ven tu ficha, escuchan tus mixes y te contratan directamente. Sin comisión oculta.</p>
