    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <BlogInlineCTA role="azafata" variant="upgrade" articlePath="/blog/precio-azafatas-denia" />
        ...
        <FooterPublic />
        <BlogScrollCTA role="azafata_pro" storageKey="xpeak_scrollcta_precio_azafatas_denia_v2" articlePath="/blog/precio-azafatas-denia" />
      </div>
    </>
  );
}
