    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#090909', color: '#fff' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#D4AF37' }}>Baile · XPEAK Blog</p>
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#3d3d4e' }}>El mundo del baile se mueve en dos mercados distintos: el show profesional para bodas y eventos, y las clases particulares de salsa, bachata y kizomba, cada vez más demandadas. Esta guía cubre ambos con precios reales de 2026.</p>
            <time className="text-xs mt-3 block" style={{ color: 'rgba(255,255,255,0.3)' }}>11 julio 2026</time>
            <BlogAnswerBox
          ...
          <div className="space-y-10">
            <section>
              ...
              <div className="overflow-x-auto rounded-xl" style={{ border: '1px solid rgba(255,255,255,0.08)' }}>
                <table className="w-full text-xs">
                  <thead><tr style={{ background: 'rgba(212,175,55,0.08)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}><th className="text-left px-4 py-3 font-bold">Servicio</th><th className="px-4 py-3 font-bold text-right">Tarifa</th><th className="px-4 py-3 font-bold text-left hidden sm:table-cell">Nota</th></tr></thead>
            ...
            <section>
              ...
              ].map((item,i) => (<div key={i} className="flex items-start gap-3 p-3 rounded-lg" style={{ background: 'rgba(255,255,255,0.02)' }}><span className="text-xs font-black shrink-0 mt-0.5" style={{ color: '#D4AF37' }}>✓</span><p className="text-xs" style={{ color: 'rgba(255,255,255,0.8)' }}>{item}</p></div>))}</div>
            </section>
            <section>
              ...
              <p className="text-sm leading-relaxed mb-3" style={{ color: 'rgba(255,255,255,0.72)' }}>
                A diferencia de otros directorios que cobran comisión al profesional o requieren plan de pago para destacar, en XPEAK publicar tu perfil y contactar es <strong style={{ color: '#fff' }}>100% gratis, sin comisión</strong>. Para eventos con fecha urgente, el <strong style={{ color: '#fff' }}>Flash Booking</strong> conecta con bailarines disponibles en horas, no días. Y cada contratación incluye <strong style={{ color: '#fff' }}>contrato digital automático</strong>, sin que tengas que redactarlo tú.
              </p>
            </section>
            <section>
            ...
            <div className="p-6 rounded-2xl text-center mb-6" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <a href="/socials" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'rgba(212,175,55,0.1)', color: '#8A6D0F', border: '1px solid rgba(212,175,55,0.25)' }}>Ver agenda de socials →</a>
            </div>
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <a href="/contratar-bailarin" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#D4AF37,#B8941E)', color: '#000' }}>Ver bailarines en XPEAK →</a>
            </div>
          </div>
