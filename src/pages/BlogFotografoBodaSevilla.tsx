...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Fotógrafo para bodas en Sevilla: precio y guía 2026', description: 'Cuánto cuesta un fotógrafo para una boda en Sevilla. Precios reales 2026, haciendas andaluzas, patios y cómo elegir el mejor fotógrafo en Andalucía.', datePublished: '2026-06-03', dateModified: '2026-06-03', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/fotografo-boda-sevilla' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cuesta un fotógrafo de boda en Sevilla?', acceptedAnswer: { '@type': 'Answer', text: 'Un fotógrafo de boda en Sevilla va desde 700€ por un reportaje básico (5-6h, sin álbum) hasta 1.800€ por el reportaje completo (8-10h, sin álbum), o 2.800€ si incluye álbum impreso. Los precios en Sevilla suelen estar algo por debajo de Madrid o Barcelona.' } },
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#4F46E5' }}>Fotografía · Sevilla · XPEAK Blog</p>
            ...
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>La luz de Sevilla es única en España. Haciendas con naranjos, patios barrocos y ese dorado de atardecer que hace que las fotos de boda sevillanas sean reconocibles en cualquier parte del mundo. Precios y guía para elegir bien.</p>
          ...
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(79,70,229,0.04)', border: '1px solid rgba(79,70,229,0.12)' }}>
              ...
              <a href="/contratar-fotografo/sevilla" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#4F46E5,#B8941E)', color: '#000' }}>Ver fotógrafos en Sevilla →</a>
            </div>
          </div>
                  <BlogEmailCapture variant="presupuestos" intent="contratar-fotografo" articlePath="/blog/fotografo-boda-sevilla" />
</main>
