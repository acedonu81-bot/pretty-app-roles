      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <article className="max-w-3xl mx-auto px-4 sm:px-6 pt-6 pb-20 sm:pb-24">
          ...
          <p className="text-xs mb-6 font-bold" style={{ color: '#666' }}>
            <a href="/" className="hover:text-[#8A6D0F] transition-colors">XPEAK</a> › <a href="/contratar-dj" className="hover:text-[#8A6D0F] transition-colors">Contratar DJ</a> › <span>Fiesta privada</span>
          </p>
          ...
          <p className="text-base leading-relaxed mb-6" style={{ color: '#222' }}>
            Contratar un DJ para una fiesta privada es una de las decisiones que más impacto tienen en el ambiente del evento, y también una de las que más dudas genera: <strong style={{ color: '#111' }}>¿cuánto cobran? ¿tienen que llevar su propio equipo? ¿aceptan peticiones?</strong> Esta guía responde todas esas preguntas con precios reales del mercado español en 2026.
          </p>
          ...
          <div className="p-4 rounded-xl mb-8" style={{ background: 'rgba(212,175,55,0.06)', border: '1px solid rgba(212,175,55,0.15)' }}>
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#333' }}>
              Un DJ para fiesta privada en España cuesta entre <strong style={{ color: '#111' }}>150€ y 600€</strong> para eventos de hasta 80 personas.
          ...
          <div className="overflow-x-auto mb-10 rounded-xl" style={{ border: '1px solid rgba(0,0,0,0.08)' }}>
            <table className="w-full text-xs min-w-[520px]">
              ...
              <tbody>
                {TABLE.map((row, i) => (
                  <tr key={row.tipo} style={{ background: i % 2 === 0 ? 'transparent' : 'rgba(0,0,0,0.015)' }}>
                    <td className="px-4 py-3 font-bold" style={{ borderBottom: '1px solid rgba(0,0,0,0.05)' }}>{row.tipo}</td>
                    <td className="px-4 py-3 whitespace-nowrap" style={{ color: '#444', borderBottom: '1px solid rgba(0,0,0,0.05)' }}>{row.horas}</td>
                    <td className="px-4 py-3 font-black whitespace-nowrap" style={{ color: '#D4AF37', borderBottom: '1px solid rgba(0,0,0,0.05)' }}>{row.rango}</td>
                    <td className="px-4 py-3" style={{ color: '#333', borderBottom: '1px solid rgba(0,0,0,0.05)' }}>{row.incluye}</td>
                  </tr>
                ))}
              </tbody>
            </table>
