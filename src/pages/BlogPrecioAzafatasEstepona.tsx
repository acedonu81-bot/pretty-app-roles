...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Estepona: guía 2026', description: 'Cuánto cobran las azafatas para bodas en villas, eventos hoteleros y actos en Estepona. Tarifas 2026.', datePublished: '2026-06-14', dateModified: '2026-07-25', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-estepona' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Estepona?', acceptedAnswer: { '@type': 'Answer', text: 'En Estepona, una azafata de eventos cobra entre 15€ y 23€/hora bruto, por encima de la media nacional gracias al perfil de turismo de calidad creciente de la zona. Las agencias facturan al cliente entre 150€ y 250€/día por perfil, algo por debajo de Marbella pero claramente en la franja alta de la Costa del Sol, cifra que incluye el margen de gestión de la agencia.' } },
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#059669' }}>Staff · Estepona · XPEAK Blog</p>
          ...
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(5,150,105,0.04)', border: '1px solid rgba(5,150,105,0.12)' }}>
              ...
              <a href="/contratar-staff/estepona" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#059669,#B8941E)', color: '#000' }}>Ver staff en Estepona →</a>
            </div>
          </div>
