...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Sitges: guía 2026', description: 'Cuánto cobran las azafatas para eventos, Carnaval y festivales en Sitges. Tarifas de plaza turística premium 2026.', datePublished: '2026-04-17', dateModified: '2026-06-30', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-sitges' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Sitges?', acceptedAnswer: { '@type': 'Answer', text: 'En Sitges, una azafata de eventos cobra entre 17€ y 28€/hora bruto, por encima de la media catalana gracias al turismo internacional de alto nivel. Las agencias facturan al cliente entre 180€ y 320€/día por perfil, cifra que incluye el margen de gestión de la agencia. En Carnaval y en el Festival de Cine Fantástico la demanda se dispara y conviene reservar con antelación.' } },
