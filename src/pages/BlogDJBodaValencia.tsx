...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', name: 'DJs para bodas en Valencia', description: 'Encuentra y contrata DJs verificados para bodas y eventos en Valencia. Contratos digitales.', serviceType: 'DJ para bodas y eventos', areaServed: { '@type': 'City', name: 'Valencia' }, provider: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es' }, url: 'https://xpeak.es/blog/dj-bodas-valencia', offers: { '@type': 'Offer', price: '0', priceCurrency: 'EUR' } };
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <p className="text-xs mt-3" style={{ color: '#3d3d4e' }}>Las fincas cerca de l'Albufera y zonas de huerta protegida pueden tener restricciones de ruido nocturno. Consulta con el venue antes de contratar.</p>
            </section>
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#3d3d4e' }}>XPEAK tiene DJs especializados en bodas en Valencia, L'Albufera, Marina Alta y toda la Comunitat. Perfiles verificados, portfolios reales y contrato digital automático.</p>
