...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Fotógrafo para comunión: precio y qué incluye en España (2026)', description: 'Cuánto cuesta un fotógrafo para una comunión en España. Precios por paquetes, qué incluye el reportaje y cómo elegir el mejor profesional.', datePublished: '2026-05-27', dateModified: '2026-05-27', author: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/fotografo-para-comunion-precio' };
      ...
      <div className="min-h-screen" style={{ background: '#090909', color: '#fff' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#8E8EA0' }}>Las fotos de la comunión son las que quedan en el álbum familiar para siempre. Te contamos cuánto cuesta un buen fotógrafo, qué incluye y cómo no equivocarte en la elección.</p>
          ...
          <div className="space-y-10">
              ...
              <div className="space-y-2">
                {PAQUETES.map((p, i) => (
                  <div key={p.pack} className="p-4 rounded-xl" style={{ background: i % 2 === 0 ? 'rgba(255,255,255,0.025)' : 'rgba(255,255,255,0.015)', border: '1px solid rgba(255,255,255,0.04)' }}>
                    ...
                    <p className="text-xs" style={{ color: '#8E8EA0' }}>{p.incluye}</p>
                  </div>
                ))}
              </div>
              <p className="text-xs mt-3" style={{ color: '#8E8EA0' }}>Precios orientativos España 2026. Sin IVA. Álbum impreso aumenta entre 200-400€ el paquete base.</p>
            </section>
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#8E8EA0' }}>XPEAK tiene fotógrafos verificados para comuniones en toda España. Compara portfolios y contrata con contrato digital automático.</p>
