...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: "Precio de azafatas para eventos en L'Hospitalet: guía 2026", description: "Cuánto cobran las azafatas para ferias y eventos corporativos en L'Hospitalet de Llobregat. Tarifas por perfil 2026.", datePublished: '2026-03-13', dateModified: '2026-06-21', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-hospitalet' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: "¿Cuánto cobran las azafatas de eventos en L'Hospitalet?", acceptedAnswer: { '@type': 'Answer', text: "En L'Hospitalet de Llobregat, una azafata de eventos cobra entre 14€ y 20€/hora bruto, prácticamente en línea con Barcelona capital por la cercanía directa. Las agencias facturan al cliente entre 140€ y 200€/día por perfil, cifra que incluye el margen de gestión de la agencia. La presencia de Fira de Barcelona Gran Via en su término municipal empuja la demanda al alza en fechas de feria." } },
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#059669' }}>Staff · L'Hospitalet · XPEAK Blog</p>
          ...
          <BlogInlineCTA role="azafata" variant="upgrade" articlePath="/blog/precio-azafatas-hospitalet" />
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(5,150,105,0.04)', border: '1px solid rgba(5,150,105,0.12)' }}>
              ...
              <a href="/contratar-staff/hospitalet" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#059669,#B8941E)', color: '#000' }}>Ver staff en L'Hospitalet →</a>
            </div>
          </div>
        ...
        <FooterPublic />
        <BlogScrollCTA role="azafata_pro" storageKey="xpeak_scrollcta_precio_azafatas_hospitalet_v2" articlePath="/blog/precio-azafatas-hospitalet" />
      </div>
    </>
  );
}
