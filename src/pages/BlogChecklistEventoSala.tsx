      ...
      <div style={{ background: '#0A0A0A', color: '#F5F5F0', minHeight: '100vh' }}>
        <div className="max-w-2xl mx-auto px-4 py-12">
          ...
          <article className="mt-6">
            <span style={{ background: 'rgba(109,40,217,0.1)', color: '#6D28D9', border: '1px solid rgba(109,40,217,0.2)', borderRadius: 6, padding: '3px 10px', fontSize: '0.7rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: 1 }}>Organización · Checklist</span>
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem' }}>
                    <thead>
                      <tr style={{ borderBottom: '1px solid #777' }}>
                        <th style={{ textAlign: 'left', padding: '8px 0', color: '#333', fontWeight: 600 }}>Proveedor</th>
                        <th style={{ textAlign: 'left', padding: '8px 0', color: '#333', fontWeight: 600 }}>Antelación</th>
                        <th style={{ textAlign: 'left', padding: '8px 0', color: '#333', fontWeight: 600 }}>Precio orient.</th>
                      </tr>
                    </thead>
                    <tbody>
                      {section.items.map(item => (
                        <tr key={item.nombre} style={{ borderBottom: '1px solid rgba(0,0,0,0.05)' }}>
                          <td style={{ padding: '10px 0' }}>
                            <a href={item.link} style={{ color: '#6D28D9', fontWeight: 700 }}>{item.nombre}</a>
                          </td>
                          <td style={{ padding: '10px 0', color: '#333' }}>{item.antelacion}</td>
                          <td style={{ padding: '10px 0', color: '#333' }}>{item.precio}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
            ...
            <ol style={{ color: '#222', lineHeight: 2, paddingLeft: '1.2rem' }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem', marginBottom: '1.5rem' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid #777' }}>
                  <th style={{ textAlign: 'left', padding: '8px 0', color: '#6D28D9' }}>Tamaño</th>
                  <th style={{ textAlign: 'left', padding: '8px 0', color: '#6D28D9' }}>Personas</th>
                  <th style={{ textAlign: 'left', padding: '8px 0', color: '#6D28D9' }}>Presupuesto orient.</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={size} style={{ borderBottom: '1px solid rgba(0,0,0,0.05)' }}>
                    ...
                    <td style={{ padding: '10px 0', color: '#333' }}>{pax}</td>
                    <td style={{ padding: '10px 0', color: '#6D28D9', fontWeight: 700 }}>{budget}</td>
                  </tr>
                ))}
              </tbody>
            </table>
            <p style={{ color: '#333', fontSize: '0.8rem' }}>* Precios orientativos. No incluyen alquiler de sala, producción de escenario ni caché de artistas headliners.</p>
