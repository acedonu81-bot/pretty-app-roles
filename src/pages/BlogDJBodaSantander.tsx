...
const faq = [{ q: `¿Cuánto cuesta un DJ para una boda en ${ciudad}?`, a: `Entre 450€ y 1.600€ servicio completo. Cantabria tiene un nivel de precios intermedio. El Palacio de la Magdalena y las fincas de costa son los venues más demandados y con precios más altos.` },{ q: `¿Cuándo es la mejor época para casarse en ${ciudad}?`, a: `Julio y agosto son los meses más seguros por clima. Cantabria tiene el clima más húmedo de España con lluvias frecuentes en otoño e invierno. Para bodas al exterior, el verano es imprescindible.` },{ q: `¿Los DJs de Cantabria están acostumbrados a venues con acústica compleja?`, a: `Sí. Las casonas cántabras y los palacios históricos suelen tener acústica difícil. Los DJs locales conocen bien estos espacios y vienen preparados con el equipo adecuado.` }];
...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', name: `DJs para bodas en Santander`, description: `Encuentra y contrata DJs verificados para bodas y eventos en Santander. Contratos digitales.`, serviceType: 'DJ para bodas y eventos', areaServed: { '@type': 'City', name: 'Santander' }, provider: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es' }, url: `https://xpeak.es/blog/dj-bodas-santander`, offers: { '@type': 'Offer', price: '0', priceCurrency: 'EUR' } };
export default function BlogDJBodaSantander() {
  const articleSchema = {
    '@context': 'https://schema.org',
    '@type': 'Article',
    headline: "DJ para bodas en Santander: precio 2026",
    description: "",
    author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' },
    publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es' },
    datePublished: '2026-06-07',
    dateModified: '2026-06-07',
    url: "https://xpeak.es/blog/dj-bodas-santander",
    mainEntityOfPage: { '@type': 'WebPage', '@id': "https://xpeak.es/blog/dj-bodas-santander" },
  };
  ...
  <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
    ...
    <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
      ...
      <div className="mb-8"><p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#D4AF37' }}>DJ · {ciudad} · XPEAK Blog</p><h1 className="text-2xl sm:text-4xl font-black tracking-tight leading-tight mb-4">DJ para bodas en {ciudad}: precio y cómo contratar en 2026</h1><p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>{ciudad} y Cantabria ofrecen bodas entre prados verdes, casonas históricas y vistas al Cantábrico. Una combinación única para parejas que buscan naturaleza y elegancia. Precios reales de 2026.</p><time className="text-xs mt-3 block" style={{ color: '#666' }}>4 junio 2026</time><BlogAnswerBox question={`¿Cuánto cuesta un DJ para una boda en ${ciudad}?`} answer={`Un DJ para el servicio completo de una boda en ${ciudad} (ceremonia, cóctel, cena y pista de baile) cuesta entre 650 y 1.600€ en 2026. El precio varía según la duración del evento, el equipo técnico incluido y la experiencia del DJ.`} /></div>
      <div className="space-y-10">
        ...
        <BlogInlineCTA role="dj" variant="upgrade" articlePath="/blog/dj-bodas-santander" />
    ...
    <BlogAuthor />
        <BlogRelatedPosts currentSlug='/blog/dj-bodas-santander' tag='DJ' />
        <FooterPublic />
    <BlogScrollCTA role="dj" storageKey={`xpeak_scrollcta_${slug}`} articlePath="/blog/dj-bodas-santander" />
  </div></>);
}
