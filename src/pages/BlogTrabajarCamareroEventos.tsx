...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Cómo trabajar de camarero en eventos en España: guía completa 2026', description: 'Guía para trabajar de camarero en bodas, comuniones y eventos en España. Requisitos, cuánto cobras, cómo buscar trabajo y plataformas donde encontrar bolos.', datePublished: '2026-06-02', dateModified: '2026-06-02', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/como-trabajar-de-camarero-eventos' };
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        <nav className="flex items-center justify-between px-4 sm:px-6 py-4 max-w-3xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="/auth" className="px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-bold transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#2563EB,#B8941E)', color: '#000' }}>Unirse</a>
          </div>
        </nav>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#2563EB' }}>Para Camareros · XPEAK Blog</p>
            ...
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>El camarero de eventos es uno de los perfiles más demandados en temporada de bodas. Puedes ganar entre 80€ y 180€ por jornada, sin horario fijo, eligiendo los fines de semana que trabajas. Esta guía te explica cómo empezar y cómo maximizar tus ingresos.</p>
          ...
          <div className="space-y-10">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={row.perfil} className="flex items-center justify-between p-4 rounded-xl" style={{ background: i % 2 === 0 ? 'rgba(0,0,0,0.025)' : 'rgba(0,0,0,0.015)', border: '1px solid rgba(0,0,0,0.04)' }}>
                    ...
                    <span className="text-xs font-bold ml-4 shrink-0" style={{ color: '#2563EB' }}>{row.tarifa}</span>
                  </div>
                ))}
              </div>
            ...
            <section>
              ...
              <div className="space-y-4">
                {PASOS.map((p, i) => (
                  <div key={p.paso} className="flex gap-4 p-5 rounded-xl" style={{ background: i % 2 === 0 ? 'rgba(0,0,0,0.025)' : 'rgba(0,0,0,0.015)', border: '1px solid rgba(0,0,0,0.05)' }}>
                    <span className="text-xl font-black shrink-0 w-6 text-center leading-none mt-0.5" style={{ color: 'rgba(37,99,235,0.35)' }}>{i + 1}</span>
                    <div>
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(37,99,235,0.04)', border: '1px solid rgba(37,99,235,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#3d3d4e' }}>Crea tu perfil en XPEAK. Organizadores de bodas y comuniones en tu zona ven tu disponibilidad y te contratan directamente. Sin intermediarios.</p>
              <a href="/auth?role=staff&mode=register" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#2563EB,#B8941E)', color: '#000' }}>Crear mi perfil de camarero →</a>
            </div>
          </div>
