...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Granada: guía 2026', description: 'Cuánto cobran las azafatas para eventos, congresos y bodas en el entorno de la Alhambra, Granada. Tarifas por perfil 2026.', datePublished: '2026-05-03', dateModified: '2026-07-09', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-granada' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Granada?', acceptedAnswer: { '@type': 'Answer', text: 'En Granada, una azafata de eventos cobra entre 10€ y 16€/hora bruto, algo por debajo de la media nacional. Las agencias facturan al cliente entre 100€ y 160€/día por perfil, cifra que incluye el margen de gestión de la agencia. La combinación de universidad y turismo cultural genera una demanda moderada pero constante todo el año.' } },
