...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de camareros para eventos en San Sebastián: guía 2026', description: 'Cuánto cobran los camareros y bartenders para bodas junto a la Concha y eventos del Zinemaldia en San Sebastián. Tarifas 2026.', datePublished: '2026-03-24', dateModified: '2026-06-29', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/camareros-eventos-sansebastian' };
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#2563EB' }}>Staff · San Sebastián · XPEAK Blog</p>
            <h1 className="text-2xl sm:text-4xl font-black tracking-tight leading-tight mb-4">Precio de camareros para eventos en San Sebastián: guía 2026</h1>
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>San Sebastián tiene el mercado de camareros y bartenders más exigente del norte, marcado por su prestigio gastronómico y el gran pico anual del Zinemaldia en septiembre. Las tarifas están por encima de la media nacional.</p>
            <time className="text-xs mt-3 block" style={{ color: '#666' }}>8 julio 2026</time>
            <BlogAnswerBox
              question="¿Cuánto cobran los camareros de eventos en San Sebastián?"
              answer="Un camarero de eventos en San Sebastián cobra entre 14€ y 22€/hora bruto, y un bartender de coctelería de autor entre 18€ y 26€/hora. Para una boda completa de 6-7 horas junto a la Concha, el presupuesto de personal de sala suele estar entre 960€ y 2.900€ según el número de invitados."
            />
          </div>
          <BlogInlineCTA role="staff" variant="upgrade" articlePath="/blog/camareros-eventos-sansebastian" />
          <div className="space-y-10">
            <section>
              <h2 className="text-lg font-black mb-4">Tarifas por perfil de camarero en San Sebastián</h2>
            ...
            <section>
              ...
              <div className="space-y-2">{['Entorno de la Playa de la Concha: bodas y eventos privados en villas de alto nivel','Zinemaldia (septiembre): galas, cócteles y eventos de alfombra roja','Sector gastronómico de prestigio: coctelería de autor y catering de alta gama','Palacio Kursaal y centro de congresos: eventos corporativos y profesionales'].map((item,i) => (<div key={i} className="flex items-start gap-3 p-3 rounded-lg" style={{ background: 'rgba(0,0,0,0.02)' }}><span className="text-xs font-black shrink-0 mt-0.5" style={{ color: '#2563EB' }}>✓</span><p className="text-xs" style={{ color: '#111' }}>{item}</p></div>))}</div>
            </section>
            <section>
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(37,99,235,0.04)', border: '1px solid rgba(37,99,235,0.12)' }}>
              <p className="text-sm font-black mb-2">¿Necesitas camareros para tu evento en San Sebastián?</p>
              ...
              <a href="/contratar-staff/sansebastian" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#2563EB,#B8941E)', color: '#000' }}>Ver camareros en San Sebastián →</a>
            </div>
          </div>
        ...
        <FooterPublic />
        <BlogScrollCTA role="staff_pro" storageKey="xpeak_scrollcta_camareros_san_sebastian_v2" articlePath="/blog/camareros-eventos-sansebastian" />
      </div>
    </>
  );
}
