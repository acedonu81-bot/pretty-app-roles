...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Salamanca: guía 2026', description: 'Cuánto cobran las azafatas para eventos, bodas y actos universitarios en Salamanca. Tarifas por perfil 2026.', datePublished: '2026-04-07', dateModified: '2026-07-24', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-salamanca' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Salamanca?', acceptedAnswer: { '@type': 'Answer', text: 'En Salamanca, una azafata de eventos cobra entre 11€ y 16€/hora bruto, por debajo de la media nacional al ser una plaza de tamaño medio. Las agencias facturan al cliente entre 100€ y 150€/día por perfil, cifra que incluye el margen de gestión de la agencia. Los actos institucionales de la Universidad de Salamanca y las bodas en el casco histórico son los que más demanda generan.' } },
