...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de maquilladora para eventos en Tarragona: guía 2026', description: 'Cuánto cobra una maquilladora para bodas y eventos corporativos en Tarragona. Tarifas por servicio 2026.', datePublished: '2026-03-26', dateModified: '2026-05-11', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/maquillaje-eventos-tarragona' };
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <BlogInlineCTA role="makeup" variant="upgrade" articlePath="/blog/maquillaje-eventos-tarragona" />
        ...
        <FooterPublic />
        <BlogScrollCTA role="makeup_pro" storageKey="xpeak_scrollcta_maquillaje_tarragona_v2" articlePath="/blog/maquillaje-eventos-tarragona" />
      </div>
    </>
  );
}
