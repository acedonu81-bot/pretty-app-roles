            ...
            <section>
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={estado} className="flex items-center gap-3 p-3 rounded-xl" style={{ background: i % 2 === 0 ? 'rgba(0,0,0,0.025)' : 'rgba(0,0,0,0.015)', border: '1px solid rgba(0,0,0,0.04)' }}>
                    <span className="text-xs font-black w-5 shrink-0" style={{ color: '#0D9488' }}>{i + 1}</span>
                    <p className="text-xs font-medium" style={{ color: '#222' }}>{estado}</p>
                  </div>
                ))}
              </div>
