...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'DJ para bodas en Murcia: precio y cómo contratar en 2026', description: 'Cuánto cuesta un DJ para una boda en Murcia. Precios reales 2026, zonas de celebración y cómo contratar el mejor DJ en la Región de Murcia.', datePublished: '2026-06-03', dateModified: '2026-06-03', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/dj-bodas-murcia' };
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>Murcia tiene una de las temporadas de bodas más activas del sureste español, con fincas en la huerta, haciendas en Lorca y resorts en la Costa Cálida. Te explicamos precios por zona y qué buscar en un DJ para boda en la Región.</p>
            <time className="text-xs mt-3 block" style={{ color: '#666' }}>3 junio 2026</time>
            <BlogAnswerBox
              question="¿Cuánto cuesta un DJ para una boda en Murcia?"
              answer="Un DJ para el servicio completo de una boda en Murcia (ceremonia, cóctel, cena y pista de baile) cuesta entre 600 y 1.500€ en 2026. El precio varía según la duración del evento, el equipo técnico incluido y la experiencia del DJ."
            />
          </div>
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#3d3d4e' }}>XPEAK tiene DJs especializados en bodas en Murcia y la Costa Cálida. Perfiles verificados, contrato digital automático.</p>
