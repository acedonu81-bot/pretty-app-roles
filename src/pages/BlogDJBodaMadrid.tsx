...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'DJ para bodas en Madrid: precio y cómo contratar en 2026', description: 'Cuánto cuesta un DJ para una boda en Madrid. Precios reales, zonas de celebración y cómo elegir el mejor DJ para tu boda en la Comunidad de Madrid.', datePublished: '2026-05-28', dateModified: '2026-05-28', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/dj-bodas-madrid' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cuesta un DJ para una boda en Madrid?', acceptedAnswer: { '@type': 'Answer', text: 'Un DJ para boda en Madrid cuesta entre 900€ y 2.000€ para el servicio completo (ceremonia + cóctel + cena + pista de baile), hasta 2.500€ en la opción premium con luces. Los precios en Madrid son un 20-30% más altos que la media nacional debido a la mayor demanda y coste de vida. Para bodas solo con pista de baile (4-5h), el rango es 500-1.000€.' } },
...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', name: 'DJs para bodas en Madrid', description: 'Encuentra y contrata DJs verificados para bodas y eventos en Madrid. Contratos digitales.', serviceType: 'DJ para bodas y eventos', areaServed: { '@type': 'City', name: 'Madrid' }, provider: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es' }, url: 'https://xpeak.es/blog/dj-bodas-madrid', offers: { '@type': 'Offer', price: '0', priceCurrency: 'EUR' } };
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <p className="text-xs mt-3" style={{ color: '#3d3d4e' }}>Verifica siempre con el DJ el coste de desplazamiento si la finca está a más de 40 km de Madrid capital.</p>
            </section>
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#3d3d4e' }}>XPEAK tiene DJs especializados en bodas en Madrid y toda la Comunidad. Perfiles verificados, portfolios reales y contrato digital automático.</p>
