...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Fotógrafo para bodas en Málaga: precio y guía 2026', description: 'Cuánto cuesta un fotógrafo para una boda en Málaga. Precios reales 2026, Costa del Sol, Serranía de Ronda y el glamour internacional del mercado de lujo.', datePublished: '2026-06-03', dateModified: '2026-06-03', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/fotografo-boda-malaga' };
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#4F46E5' }}>Fotografía · Málaga · XPEAK Blog</p>
            ...
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>Málaga tiene dos mercados fotográficos muy distintos: la Costa del Sol con bodas internacionales de lujo en Marbella y Estepona, y el interior con fincas y cortijos más auténticos. Los fotógrafos malagueños son expertos en trabajar con luz mediterránea intensa y en espacios con contrastes muy marcados.</p>
            <time className="text-xs mt-3 block" style={{ color: '#666' }}>3 junio 2026</time>
          <BlogAnswerBox
            question="¿Cuánto cuesta un fotógrafo para una boda en Málaga?"
            answer="Un fotógrafo para el reportaje completo de una boda en Málaga (sin álbum impreso) cuesta entre 1.500 y 2.500€ en 2026. El precio final depende de las horas de cobertura, si incluye álbum físico y si se contrata también videógrafo."
          />
          ...
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(79,70,229,0.04)', border: '1px solid rgba(79,70,229,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#3d3d4e' }}>XPEAK tiene fotógrafos verificados para bodas en Málaga y Costa del Sol. Portfolios reales y contrato digital automático.</p>
              <a href="/contratar-fotografo/malaga" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#4F46E5,#B8941E)', color: '#000' }}>Ver fotógrafos en Málaga →</a>
            </div>
          </div>
                  <BlogEmailCapture variant="presupuestos" intent="contratar-fotografo" articlePath="/blog/fotografo-boda-malaga" />
</main>
