...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'DJ para bodas en Málaga: precio y cómo contratar en 2026', description: 'Cuánto cuesta un DJ para una boda en Málaga. Precios reales 2026, zonas de celebración (Costa del Sol, Serranía, Antequera) y cómo contratar el mejor DJ.', datePublished: '2026-06-02', dateModified: '2026-06-02', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/dj-bodas-malaga' };
...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', name: 'DJs para bodas en Málaga', description: 'Encuentra y contrata DJs verificados para bodas y eventos en Málaga. Contratos digitales.', serviceType: 'DJ para bodas y eventos', areaServed: { '@type': 'City', name: 'Málaga' }, provider: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es' }, url: 'https://xpeak.es/blog/dj-bodas-malaga', offers: { '@type': 'Offer', price: '0', priceCurrency: 'EUR' } };
