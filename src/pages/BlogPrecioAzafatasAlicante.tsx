...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Alicante: guía 2026', description: 'Cuánto cobran las azafatas para eventos, bodas en la Costa Blanca y ferias en Alicante. Tarifas por perfil 2026.', datePublished: '2026-06-14', dateModified: '2026-07-02', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-alicante' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Alicante?', acceptedAnswer: { '@type': 'Answer', text: 'En Alicante, una azafata de eventos cobra entre 11€ y 17€/hora bruto, en línea con la media nacional. Las agencias facturan al cliente entre 115€ y 175€/día por perfil, cifra que incluye el margen de gestión de la agencia. La temporada alta de la Costa Blanca (abril-octubre) sube la demanda de personal para bodas y eventos de playa.' } },
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#059669' }}>Staff · Alicante · XPEAK Blog</p>
            ...
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>Alicante combina un centro de negocios activo con la fuerte temporada de bodas y eventos de playa de la Costa Blanca, entre abril y octubre. Las tarifas se mantienen en línea con la media nacional, con picos en temporada alta.</p>
          ...
          <BlogInlineCTA role="azafata" variant="upgrade" articlePath="/blog/precio-azafatas-alicante" />
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(5,150,105,0.04)', border: '1px solid rgba(5,150,105,0.12)' }}>
              ...
              <a href="/contratar-staff/alicante" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#059669,#B8941E)', color: '#000' }}>Ver staff en Alicante →</a>
            </div>
          </div>
        ...
        <FooterPublic />
        <BlogScrollCTA role="azafata_pro" storageKey="xpeak_scrollcta_precio_azafatas_alicante_v2" articlePath="/blog/precio-azafatas-alicante" />
      </div>
    </>
  );
}
