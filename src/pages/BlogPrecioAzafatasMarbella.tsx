...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Marbella: guía 2026', description: 'Cuánto cobran las azafatas para eventos, bodas de lujo y Puerto Banús en Marbella. Tarifas de temporada alta 2026.', datePublished: '2026-03-31', dateModified: '2026-05-31', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-marbella' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Marbella?', acceptedAnswer: { '@type': 'Answer', text: 'En Marbella, una azafata de eventos cobra entre 17€ y 28€/hora bruto, muy por encima de la media nacional gracias al turismo internacional de lujo de Puerto Banús. Las agencias facturan al cliente entre 180€ y 320€/día por perfil, cifra que incluye el margen de gestión de la agencia. En temporada alta (junio-septiembre) la demanda se dispara con bodas en villas y hoteles 5 estrellas.' } },
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#059669' }}>Staff · Marbella · XPEAK Blog</p>
            ...
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>Marbella es una de las plazas más caras de España para contratar azafatas: clientela internacional de alto poder adquisitivo en Puerto Banús, villas de lujo en la Milla de Oro y una temporada de verano muy intensa.</p>
          ...
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(5,150,105,0.04)', border: '1px solid rgba(5,150,105,0.12)' }}>
              ...
              <a href="/contratar-staff/marbella" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#059669,#B8941E)', color: '#000' }}>Ver staff en Marbella →</a>
            </div>
          </div>
