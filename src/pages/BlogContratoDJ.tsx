        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="space-y-10">
              ...
              <div className="space-y-3">
                {CLAUSULAS.map((c, i) => (
                  <div key={c.clausula} className="p-4 rounded-xl" style={{ background: i % 2 === 0 ? 'rgba(255,255,255,0.025)' : 'rgba(255,255,255,0.015)', border: '1px solid rgba(255,255,255,0.04)' }}>
                    ...
                    <p className="text-xs pl-4" style={{ color: '#8E8EA0' }}>{c.detalle}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.12)' }}>
              ...
              <p className="text-xs mb-4" style={{ color: '#8E8EA0' }}>En XPEAK el contrato se genera solo: fechas, precio, IVA, IRPF y cláusulas de cancelación. Firma digital desde el móvil. Sin papeleo.</p>
