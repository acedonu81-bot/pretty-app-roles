...
const faq = [{ q: `¿Cuánto cuesta un DJ para una boda en ${ciudad}?`, a: `Entre 450€ y 1.500€. La provincia de Cádiz es uno de los destinos de boda más activos de Andalucía, con Jerez y la Costa de la Luz como zonas más demandadas.` },{ q: `¿Qué diferencia hay entre casarse en Jerez vs Cádiz capital?`, a: `Jerez tiene haciendas bodegueras muy glamurosas con tradición de bodas de lujo. Cádiz capital ofrece el océano Atlántico como backdrop. Para bodas más bohemias, Vejer de la Frontera y Tarifa son muy populares entre parejas jóvenes.` },{ q: `¿El viento en Tarifa y la Costa de la Luz afecta a las bodas al exterior?`, a: `El viento de Levante puede ser muy fuerte en esa zona. Para bodas al exterior, confirma con el venue que tiene cortavientos o alternativa de interior. Los DJs con experiencia en esa zona ya están acostumbrados y traen material asegurado.` }];
...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', name: `DJs para bodas en Cádiz`, description: `Encuentra y contrata DJs verificados para bodas y eventos en Cádiz. Contratos digitales.`, serviceType: 'DJ para bodas y eventos', areaServed: { '@type': 'City', name: 'Cádiz' }, provider: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es' }, url: `https://xpeak.es/blog/dj-bodas-cadiz`, offers: { '@type': 'Offer', price: '0', priceCurrency: 'EUR' } };
export default function BlogDJBodaCadiz() {
  const articleSchema = {
    '@context': 'https://schema.org',
    '@type': 'Article',
    headline: "DJ para bodas en Cádiz: precio 2026",
    description: "",
    author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' },
    publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es' },
    datePublished: '2026-06-07',
    dateModified: '2026-06-07',
    url: "https://xpeak.es/blog/dj-bodas-cadiz",
    mainEntityOfPage: { '@type': 'WebPage', '@id': "https://xpeak.es/blog/dj-bodas-cadiz" },
  };
  ...
  <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
    ...
    <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
      ...
      <div className="mb-8"><p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#D4AF37' }}>DJ · {ciudad} · XPEAK Blog</p><h1 className="text-2xl sm:text-4xl font-black tracking-tight leading-tight mb-4">DJ para bodas en {ciudad}: precio y cómo contratar en 2026</h1><p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>La provincia de {ciudad} ofrece bodas únicas: haciendas bodegueras en Jerez, cortijos frente al océano en la Costa de la Luz y fincas bohemias en Vejer y Tarifa. Guía de precios 2026.</p><time className="text-xs mt-3 block" style={{ color: '#666' }}>4 junio 2026</time><BlogAnswerBox question={`¿Cuánto cuesta un DJ para una boda en ${ciudad}?`} answer={`Un DJ para el servicio completo de una boda en ${ciudad} (ceremonia, cóctel, cena y pista de baile) cuesta entre 620 y 1.500€ en 2026. El precio varía según la duración del evento, el equipo técnico incluido y la experiencia del DJ.`} /></div>
      <div className="space-y-10">
        ...
        <BlogInlineCTA role="dj" variant="upgrade" articlePath="/blog/dj-bodas-cadiz" />
