...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Benidorm: guía 2026', description: 'Cuánto cobran las azafatas para eventos, hoteles y temporada turística en Benidorm. Tarifas por perfil 2026.', datePublished: '2026-05-31', dateModified: '2026-06-29', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-benidorm' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Benidorm?', acceptedAnswer: { '@type': 'Answer', text: 'En Benidorm, una azafata de eventos cobra entre 13€ y 19€/hora bruto, en línea con la media nacional, con subidas puntuales en verano por la alta actividad turística. Las agencias facturan al cliente entre 130€ y 190€/día por perfil, cifra que incluye el margen de gestión de la agencia. La temporada abril-octubre es cuando se concentra la mayor parte de la demanda.' } },
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <BlogInlineCTA role="azafata" variant="upgrade" articlePath="/blog/precio-azafatas-benidorm" />
        ...
        <FooterPublic />
        <BlogScrollCTA role="azafata_pro" storageKey="xpeak_scrollcta_precio_azafatas_benidorm_v2" articlePath="/blog/precio-azafatas-benidorm" />
      </div>
    </>
  );
}
