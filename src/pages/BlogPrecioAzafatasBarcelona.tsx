...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Barcelona: guía 2026', description: 'Cuánto cobran las azafatas para eventos, ferias (Fira de Barcelona) y congresos en Barcelona. Tarifas por perfil 2026.', datePublished: '2026-03-27', dateModified: '2026-07-05', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-barcelona' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Barcelona?', acceptedAnswer: { '@type': 'Answer', text: 'En Barcelona una azafata de eventos cobra entre 13€ y 20€/hora bruto, en línea con Madrid por el volumen de ferias internacionales que pasan por Fira de Barcelona. Las agencias facturan al cliente entre 130€ y 200€/día, cifra que incluye el margen de gestión de la agencia. Durante el Mobile World Congress la demanda de perfiles multilingües dispara la tarifa un 20-30%.' } },
