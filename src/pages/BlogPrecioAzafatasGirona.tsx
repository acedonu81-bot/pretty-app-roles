...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Girona: guía 2026', description: 'Cuánto cobran las azafatas para eventos, congresos y bodas en Girona. Tarifas de ciudad de patrimonio y gastronomía 2026.', datePublished: '2026-06-22', dateModified: '2026-07-07', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-girona' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Girona?', acceptedAnswer: { '@type': 'Answer', text: 'En Girona, una azafata de eventos cobra entre 13€ y 19€/hora bruto, en línea con la media de ciudades medianas catalanas. Las agencias facturan al cliente entre 130€ y 195€/día por perfil, cifra que incluye el margen de gestión de la agencia. El turismo creciente de la ciudad y la demanda gastronómica de la zona sostienen la actividad todo el año.' } },
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
          ...
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#059669' }}>Staff · Girona · XPEAK Blog</p>
            ...
            <p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>Girona combina un patrimonio histórico reconocido en el Barri Vell con una escena gastronómica de prestigio y un turismo internacional en crecimiento. Esto genera una demanda de azafatas estable durante todo el año, con tarifas en línea con la media catalana.</p>
          ...
          <div className="space-y-10">
            ...
            <div className="p-6 rounded-2xl text-center" style={{ background: 'rgba(5,150,105,0.04)', border: '1px solid rgba(5,150,105,0.12)' }}>
              ...
              <a href="/contratar-staff/girona" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105" style={{ background: 'linear-gradient(90deg,#059669,#B8941E)', color: '#000' }}>Ver staff en Girona →</a>
            </div>
          </div>
