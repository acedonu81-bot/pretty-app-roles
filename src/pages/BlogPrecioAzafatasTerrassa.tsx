...
const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Precio de azafatas para eventos en Terrassa: guía 2026', description: 'Cuánto cobran las azafatas para eventos culturales, institucionales y bodas en Terrassa. Tarifas por perfil 2026.', datePublished: '2026-04-05', dateModified: '2026-05-07', author: { '@type': 'Person', name: 'Daniel', jobTitle: 'Fundador de XPEAK', url: 'https://xpeak.es/autor/daniel' }, publisher: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es', logo: { '@type': 'ImageObject', url: 'https://xpeak.es/favicon.png' } }, image: 'https://xpeak.es/og-image.jpg', url: 'https://xpeak.es/blog/precio-azafatas-terrassa' };
const faqStructured = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  { '@type': 'Question', name: '¿Cuánto cobran las azafatas de eventos en Terrassa?', acceptedAnswer: { '@type': 'Answer', text: 'En Terrassa, una azafata de eventos cobra entre 13€ y 19€/hora bruto, en línea con el resto del Vallès Occidental. Las agencias facturan al cliente entre 130€ y 190€/día por perfil, cifra que incluye el margen de gestión de la agencia. Los eventos culturales e institucionales de la ciudad generan una demanda constante durante todo el año.' } },
