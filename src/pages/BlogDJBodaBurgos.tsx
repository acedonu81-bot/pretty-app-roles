...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', name: `DJs para bodas en Burgos`, description: `Encuentra y contrata DJs verificados para bodas y eventos en Burgos. Contratos digitales.`, serviceType: 'DJ para bodas y eventos', areaServed: { '@type': 'City', name: 'Burgos' }, provider: { '@type': 'Organization', name: 'XPEAK', url: 'https://xpeak.es' }, url: `https://xpeak.es/blog/dj-bodas-burgos`, offers: { '@type': 'Offer', price: '0', priceCurrency: 'EUR' } };
export default function BlogDJBodaBurgos() {
  ...
  <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
    ...
    <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-20">
      ...
      <div className="mb-8"><p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#D4AF37' }}>DJ · {ciudad} · XPEAK Blog</p><h1 className="text-2xl sm:text-4xl font-black tracking-tight leading-tight mb-4">DJ para bodas en {ciudad}: precio y cómo contratar en 2026</h1><p className="text-base leading-relaxed" style={{ color: '#3d3d4e' }}>{ciudad} es una de las ciudades más históricas de España, con su catedral gótica y paradores únicos. Las bodegas de la Ribera del Duero burgalesa añaden una opción vinícola de primer nivel. Guía de precios 2026.</p><time className="text-xs mt-3 block" style={{ color: '#666' }}>4 junio 2026</time><BlogAnswerBox question={`¿Cuánto cuesta un DJ para una boda en ${ciudad}?`} answer={`Un DJ para el servicio completo de una boda en ${ciudad} (ceremonia, cóctel, cena y pista de baile) cuesta entre 580 y 1.400€ en 2026. El precio varía según la duración del evento, el equipo técnico incluido y la experiencia del DJ.`} /></div>
      <div className="space-y-10">
        ...
        <BlogInlineCTA role="dj" variant="upgrade" articlePath="/blog/dj-bodas-burgos" />
    ...
    <BlogAuthor />
        <BlogRelatedPosts currentSlug='/blog/dj-bodas-burgos' tag='DJ' />
        <FooterPublic />
    <BlogScrollCTA role="dj" storageKey={`xpeak_scrollcta_${slug}`} articlePath="/blog/dj-bodas-burgos" />
  </div></>);
}
