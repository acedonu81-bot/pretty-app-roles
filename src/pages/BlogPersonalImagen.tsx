      ...
      <div className="min-h-screen" style={{ background: '#ffffff', color: '#111' }}>
        ...
        <article className="max-w-3xl mx-auto px-4 sm:px-6 pt-6 pb-20 sm:pb-24">
          ...
          <p className="text-xs mb-6 font-bold" style={{ color: '#666' }}>
            <a href="/" className="hover:text-[#8A6D0F] transition-colors">XPEAK</a> › <a href="/contratar-staff" className="hover:text-[#8A6D0F] transition-colors">Contratar Staff</a> › <span>Personal de imagen</span>
          </p>

          <div className="flex items-center gap-2 mb-4">
            <TrendingUp size={14} style={{ color: '#059669' }} />
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#059669' }}>Blog · Guía de precios</span>
          </div>
              ...
              <tbody>
                {TABLE.map((row, i) => (
                  <tr key={row.perfil} style={{ background: i % 2 === 0 ? 'transparent' : 'rgba(0,0,0,0.015)' }}>
                    <td className="px-4 py-3 font-bold" style={{ borderBottom: '1px solid rgba(0,0,0,0.05)' }}>{row.perfil}</td>
                    <td className="px-4 py-3" style={{ color: '#444', borderBottom: '1px solid rgba(0,0,0,0.05)' }}>{row.jornada}</td>
                    <td className="px-4 py-3 font-black whitespace-nowrap" style={{ color: '#059669', borderBottom: '1px solid rgba(0,0,0,0.05)' }}>{row.rango}</td>
          ...
          <ul className="space-y-3 mb-10">
            {[
              ...
              <li key={item.label} className="flex gap-3">
                <Star size={13} className="flex-shrink-0 mt-0.5" style={{ color: '#059669' }} />
                <div>
          ...
          <div className="rounded-2xl overflow-hidden mb-2" style={{ border: '1px solid rgba(5,150,105,0.2)' }}>
            <div className="p-8" style={{ background: 'linear-gradient(135deg,#0e0e14 0%,#181410 100%)', color: '#fff', borderBottom: '1px solid rgba(5,150,105,0.15)' }}>
              ...
              {[
                ...
                <a key={p.href} href={p.href}
                  ...
                  <span className="inline-block text-[0.6rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded mb-2"
                    style={{ background: 'rgba(5,150,105,0.1)', color: '#059669', border: '1px solid rgba(212,175,56,0.18)' }}>{p.tag}</span>
