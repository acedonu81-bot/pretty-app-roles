export interface Profile {
  id: number;
  name: string;
  role: 'dj' | 'staff' | 'azafata' | 'makeup' | 'peluqueria' | 'vestuario' | 'media' | 'design' | 'promotor' | 'ambassador' | 'rookie' | 'empresario' | 'catering' | 'mago' | 'bailarin' | 'humorista' | 'monologo' | 'speaker' | 'animador';
  specialty: string;
  rating: number;
  reviews: number;
  location: string;
...
{ id: 2, name: 'Luna Deep', role: 'dj', specialty: 'Deep House / Melodic', rating: 5.0, reviews: 312, location: 'Madrid', zone: 'Salamanca', country: 'España', city: 'Madrid', experience: '11 años', price: 150, priceUnit: '/hora', avatar: 'LD', gradient: 'linear-gradient(135deg, #D4AF37, #F5D77A)', badges: ['Deep House', 'Melodic', 'Vinyl Set'], description: 'Referente del deep house en Madrid. Sesiones melódicas con vinilo y producción propia.', phone: '', instagram: 'lunadeep_music', topWeekend: true, photo: '', subscriptionTier: 'elite', isFlashActive: true, profileViews: 47, contactClicks: 0, category: 'professional', isPremium: true },
  ...
  { id: 45, name: 'Ana Improv',          role: 'humorista', specialty: 'Improv & Humor Corporativo',    rating: 4.7, reviews: 67,  location: 'Barcelona', zone: 'Eixample', country: 'España', city: 'Barcelona', experience: '6 años',  price: 300, priceUnit: '/evento', avatar: 'AI', gradient: 'linear-gradient(135deg,#333,#1a1a1a)',   badges: ['Improv', 'Team Building', 'Dinámicas'], description: 'Actriz de impro y humor para team building corporativo. Shows participativos donde el público es el protagonista.', phone: '', instagram: 'anaimprov',  topWeekend: false, photo: '', subscriptionTier: 'premium',  isFlashActive: false, profileViews: 18, contactClicks: 0, category: 'professional' },

  // Monólogos & Stand-Up
  { id: 60, name: 'Dani Escena',      role: 'monologo', specialty: 'Stand-Up & Monólogo Corporativo', rating: 5.0, reviews: 287, location: 'Madrid',    zone: 'Malasaña',  country: 'España', city: 'Madrid',    experience: '12 años', price: 500, priceUnit: '/actuación', avatar: 'DE', gradient: 'linear-gradient(135deg,#EF4444,#B91C1C)', badges: ['Stand-Up', 'Corporativo', 'Guión Personalizado'], description: 'Monologuista con más de 800 actuaciones en cenas de empresa, bodas y festivales. Guión 100% personalizado con referencias a tu empresa o sector. TV y Netflix.', phone: '', instagram: 'danieescena', topWeekend: true,  photo: '', subscriptionTier: 'elite',   isFlashActive: true,  profileViews: 134, contactClicks: 0, category: 'professional', isPremium: true },
  { id: 61, name: 'Marta Risas',      role: 'monologo', specialty: 'Monólogo Boda & Eventos Privados', rating: 4.9, reviews: 156, location: 'Barcelona', zone: 'Gràcia',    country: 'España', city: 'Barcelona', experience: '8 años',  price: 350, priceUnit: '/actuación', avatar: 'MR', gradient: 'linear-gradient(135deg,#333,#1a1a1a)',   badges: ['Bodas', 'Stand-Up', 'Improv'], description: 'La monologuista más solicitada para bodas en Cataluña. Humor blanco y elegante adaptado a todo tipo de público. Actuaciones de 20-40 min.', phone: '', instagram: 'martarisascomic', topWeekend: true,  photo: '', subscriptionTier: 'premium',  isFlashActive: true,  profileViews: 89,  contactClicks: 0, category: 'professional' },
  { id: 62, name: 'El Paco Mic',      role: 'monologo', specialty: 'Open Mic & Humor Ácido',          rating: 4.8, reviews: 98,  location: 'Valencia',  zone: 'Ruzafa',    country: 'España', city: 'Valencia',  experience: '6 años',  price: 250, priceUnit: '/actuación', avatar: 'PM', gradient: 'linear-gradient(135deg,#333,#1a1a1a)',   badges: ['Open Mic', 'Humor Ácido', 'Festivales'], description: 'Cómico de stand-up especializado en humor negro y ácido para festivales y salas alternativas. Sets de 15-45 min.', phone: '', instagram: 'elpacomic', topWeekend: false, photo: '', subscriptionTier: 'free',     isFlashActive: false, profileViews: 43,  contactClicks: 0, category: 'rookie' },
  { id: 63, name: 'Sofía Punchline',  role: 'monologo', specialty: 'Humor Feminista & Millennial',    rating: 4.9, reviews: 203, location: 'Madrid',    zone: 'Lavapiés',  country: 'España', city: 'Madrid',    experience: '9 años',  price: 400, priceUnit: '/actuación', avatar: 'SP', gradient: 'linear-gradient(135deg,#EF4444,#B91C1C)', badges: ['Humor Feminista', 'Millennial', 'Teatro'], description: 'Stand-up comedy con perspectiva feminista y millennial. Shows de 45-60 min con gira nacional. Actuaciones para festivales, teatros y eventos corporativos con perfil joven.', phone: '', instagram: 'sofiapunchline', topWeekend: false, photo: '', subscriptionTier: 'premium',  isFlashActive: true,  profileViews: 77,  contactClicks: 0, category: 'professional' },
  { id: 64, name: 'Tono & Asociados', role: 'monologo', specialty: 'Humor Corporativo & Team Building',rating: 5.0, reviews: 312, location: 'Madrid',    zone: 'Chamberí',  country: 'España', city: 'Madrid',    experience: '15 años', price: 800, priceUnit: '/actuación', avatar: 'TA', gradient: 'linear-gradient(135deg,#EF4444,#B91C1C)', badges: ['Corporativo', 'Team Building', 'Interactivo'], description: 'Empresa de humor corporativo para grandes cuentas. Monólogos personalizados, dinámicas de team building con humor y presentaciones de empresa con cómicos integrados.', phone: '', instagram: 'tonoyasociados', topWeekend: true,  photo: '', subscriptionTier: 'elite',   isFlashActive: true,  profileViews: 201, contactClicks: 0, category: 'professional', isPremium: true },

  // Speakers / Presentadores (GigSalad: Speakers — Emcees, Motivational, Corporate)
  { id: 46, name: 'Javier Keynote',     role: 'speaker',   specialty: 'Speaker Motivacional & Empresa', rating: 5.0, reviews: 98,  location: 'Madrid',    zone: 'Salamanca',country: 'España', city: 'Madrid',    experience: '14 años', price: 800, priceUnit: '/evento', avatar: 'JK', gradient: 'linear-gradient(135deg,#D4AF37,#B8941E)', badges: ['Motivacional', 'Liderazgo', 'Keynote'], description: 'Speaker de referencia en eventos corporativos y congresos. Ponencias sobre liderazgo, innovación y gestión de equipos. +200 conferencias.', phone: '', instagram: 'javierkeynotespk', topWeekend: false, photo: '', subscriptionTier: 'elite',   isFlashActive: false, profileViews: 44, contactClicks: 0, category: 'professional', isPremium: true },
  { id: 47, name: 'Lucía Presenta',     role: 'speaker',   specialty: 'Presentadora & MC de Eventos',  rating: 4.9, reviews: 145, location: 'Madrid',    zone: 'Centro',   country: 'España', city: 'Madrid',    experience: '11 años', price: 500, priceUnit: '/evento', avatar: 'LP', gradient: 'linear-gradient(135deg,#333,#1a1a1a)',   badges: ['MC Eventos', 'Galas', 'Presentadora TV'], description: 'Presentadora profesional con experiencia en galas, congresos y eventos corporativos. Ex presentadora de televisión. Bilingüe ES/EN.', phone: '', instagram: 'luciapresenta', topWeekend: false, photo: '', subscriptionTier: 'premium',  isFlashActive: true,  profileViews: 70, contactClicks: 0, category: 'professional' },

  // Catering / Chef de eventos
  { id: 30, name: 'Chef Marco Rossi', role: 'catering', specialty: 'Chef Privado & Banquetes', rating: 5.0, reviews: 134, location: 'Madrid', zone: 'Salamanca', country: 'España', city: 'Madrid', experience: '14 años', price: 120, priceUnit: '/evento', avatar: 'MR', gradient: 'linear-gradient(135deg, #D4AF37, #B8941E)', badges: ['Chef Privado', 'Menú Degustación', 'Cocina Mediterránea'], description: 'Chef con estrellas Michelin reconvertido en especialista de eventos privados. Desde cenas íntimas hasta banquetes de 300 personas.', phone: '', instagram: 'chefmarcorossi_events', topWeekend: true, photo: '', subscriptionTier: 'elite', isFlashActive: true, profileViews: 26, contactClicks: 0, category: 'professional', isPremium: true },
  { id: 31, name: 'Sara Gastro',    role: 'catering', specialty: 'Catering Bodas & Eventos',  rating: 4.9, reviews: 98,  location: 'Barcelona', zone: 'Eixample',  country: 'España', city: 'Barcelona', experience: '9 años',  price: 65,  priceUnit: '/persona', avatar: 'SG', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['Bodas', 'Buffet Premium', 'Menú Cerrado'], description: 'Empresa de catering para bodas y eventos corporativos en Cataluña. Cocina de autor, menús cerrados y buffets de alta gama.', phone: '', instagram: 'saragastro_catering', topWeekend: false, photo: '', subscriptionTier: 'premium', isFlashActive: true, profileViews: 85, contactClicks: 0, category: 'professional' },
  { id: 32, name: 'Kokoro Sushi',   role: 'catering', specialty: 'Catering Japonés & Fusión', rating: 4.8, reviews: 67,  location: 'Madrid',    zone: 'Malasaña', country: 'España', city: 'Madrid',    experience: '6 años',  price: 45,  priceUnit: '/persona', avatar: 'KS', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['Sushi en Vivo', 'Fusión', 'Estación Temática'], description: 'Catering japonés y fusión asiática con chef en directo. Estaciones de sushi, gyozas y cocktails japoneses para eventos exclusivos.', phone: '', instagram: 'kokorosushi_events', topWeekend: false, photo: '', subscriptionTier: 'free', isFlashActive: false, profileViews: 13, contactClicks: 0, category: 'rookie' },

  { id: 19, name: 'Javi Street', role: 'ambassador', specialty: 'Promoción Física & Soporte Marca', rating: 4.6, reviews: 67, location: 'Madrid', zone: 'Malasaña', experience: '2 años', price: 20, priceUnit: '/hora', avatar: 'JS', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['QR Campaigns', 'Activaciones', 'Soporte Evento'], description: 'Soporte de marca en eventos nocturnos. Gestión de stands y captación.', phone: '', instagram: 'javistreet_promo', topWeekend: false, photo: '/images/profiles/4353842.jpg', subscriptionTier: 'free', isFlashActive: false, profileViews: 61, contactClicks: 0, category: 'rookie' },

  // Payasos & Animadores
  { id: 70, name: 'Ricky & Burbuja', role: 'animador', specialty: 'Payaso & Animación Infantil', rating: 5.0, reviews: 312, location: 'Madrid', zone: 'Vallecas', country: 'España', city: 'Madrid', experience: '14 años', price: 250, priceUnit: '/evento', avatar: 'RB', gradient: 'linear-gradient(135deg,#FBBF24,#D97706)', badges: ['Cumpleaños', 'Magia', 'Globoflexia'], description: 'Dúo de payasos profesionales para cumpleaños, comuniones y eventos infantiles. Show de 60-90 min con magia, globoflexia y juegos para niños de 3-12 años.', phone: '', instagram: 'rickyyburbuja', topWeekend: true, photo: '', subscriptionTier: 'elite', isFlashActive: true, profileViews: 88, contactClicks: 0, category: 'professional', isPremium: true },
  { id: 71, name: 'Super Fiesta Kids', role: 'animador', specialty: 'Animación Infantil & Temática', rating: 4.9, reviews: 201, location: 'Barcelona', zone: 'Gracia', country: 'España', city: 'Barcelona', experience: '9 años', price: 200, priceUnit: '/evento', avatar: 'SF', gradient: 'linear-gradient(135deg,#333,#1a1a1a)', badges: ['Princesas', 'Superhéroes', 'Talleres'], description: 'Animadoras especializadas en fiestas temáticas infantiles. Princesas, superhéroes, dinosaurios. Talleres de manualidades, teatrillo y cuentacuentos incluidos.', phone: '', instagram: 'superfiestakids', topWeekend: true, photo: '', subscriptionTier: 'premium', isFlashActive: true, profileViews: 54, contactClicks: 0, category: 'professional' },
  { id: 72, name: 'Zirkus Crew', role: 'animador', specialty: 'Animación Circo & Malabares', rating: 4.8, reviews: 98, location: 'Valencia', zone: 'Ruzafa', country: 'España', city: 'Valencia', experience: '7 años', price: 350, priceUnit: '/evento', avatar: 'ZC', gradient: 'linear-gradient(135deg,#FBBF24,#D97706)', badges: ['Circo', 'Malabares', 'Zancos'], description: 'Compañía de animación circense para festivales, eventos corporativos y bodas. Malabares, zancos, monociclo y acrobacias aéreas. Shows de 30-60 min.', phone: '', instagram: 'zirkuscrew', topWeekend: false, photo: '', subscriptionTier: 'premium', isFlashActive: false, profileViews: 31, contactClicks: 0, category: 'professional' },
  { id: 73, name: 'Mimo & Magia', role: 'animador', specialty: 'Mimo & Magia Callejera', rating: 4.9, reviews: 145, location: 'Madrid', zone: 'Lavapiés', country: 'España', city: 'Madrid', experience: '11 años', price: 180, priceUnit: '/hora', avatar: 'MM', gradient: 'linear-gradient(135deg,#333,#1a1a1a)', badges: ['Mimo', 'Magia', 'Street Art'], description: 'Artista de calle especializado en mimo y magia de cerca para inauguraciones, eventos corporativos y espacios públicos. Única propuesta de entretenimiento ambulante.', phone: '', instagram: 'mimoymagia', topWeekend: false, photo: '', subscriptionTier: 'free', isFlashActive: false, profileViews: 17, contactClicks: 0, category: 'rookie' },
  { id: 74, name: 'Party Animals España', role: 'animador', specialty: 'Animación Adultos & Team Building', rating: 5.0, reviews: 267, location: 'Ibiza', zone: 'Playa d\'en Bossa', country: 'España', city: 'Ibiza', experience: '10 años', price: 500, priceUnit: '/evento', avatar: 'PA', gradient: 'linear-gradient(135deg,#FBBF24,#D97706)', badges: ['Pool Party', 'Corporativo', 'Juegos Gigantes'], description: 'Animación para adultos en hoteles, resorts y eventos de empresa. Pool parties, olimpiadas de empresa, karaoke en vivo y juegos gigantes. Especializados en temporada Ibiza.', phone: '', instagram: 'partyanimalsibiza', topWeekend: true, photo: '', subscriptionTier: 'elite', isFlashActive: true, profileViews: 112, contactClicks: 0, category: 'professional', isPremium: true },

  // Empresarios / Salas / Clubs (nombres ficticios)
  { id: 50, name: 'Club Vórtex Madrid', role: 'empresario', specialty: 'Club Nocturno · Techno & House', rating: 4.9, reviews: 312, location: 'Madrid', zone: 'Malasaña', country: 'España', city: 'Madrid', experience: '8 años', price: 0, priceUnit: '', avatar: 'CV', gradient: 'linear-gradient(135deg,#D4AF37,#B8941E)', badges: ['Techno', 'House', 'Aforo 600'], description: 'Club de referencia en Madrid. Dos floors, sistema de sonido premium. Programación semanal de DJs nacionales e internacionales.', phone: '', instagram: '', topWeekend: true, photo: '', subscriptionTier: 'elite', isFlashActive: true, profileViews: 37, contactClicks: 0, category: 'venue', isPremium: true },
  { id: 51, name: 'Terraza Nébula', role: 'empresario', specialty: 'Rooftop Bar · Vistas Madrid', rating: 4.8, reviews: 189, location: 'Madrid', zone: 'Salamanca', country: 'España', city: 'Madrid', experience: '5 años', price: 0, priceUnit: '', avatar: 'TN', gradient: 'linear-gradient(135deg,#333,#1a1a1a)', badges: ['Rooftop', 'Afterwork', 'Eventos Privados'], description: 'Terraza premium con vistas panorámicas. Eventos privados, bodas y showcases musicales en el corazón de Madrid.', phone: '', instagram: '', topWeekend: true, photo: '', subscriptionTier: 'premium', isFlashActive: true, profileViews: 95, contactClicks: 0, category: 'venue' },
  { id: 52, name: 'Sala Éxtasis BCN', role: 'empresario', specialty: 'Sala de Conciertos & Club · Barcelona', rating: 5.0, reviews: 234, location: 'Barcelona', zone: 'Poble Nou', country: 'España', city: 'Barcelona', experience: '10 años', price: 0, priceUnit: '', avatar: 'SE', gradient: 'linear-gradient(135deg,#D4AF37,#B8941E)', badges: ['Multi-room', 'Electrónica', 'Aforo 1.200'], description: 'Sala de referencia en Barcelona con 3 rooms y programación internacional de techno, house y electrónica.', phone: '', instagram: '', topWeekend: true, photo: '', subscriptionTier: 'elite', isFlashActive: true, profileViews: 22, contactClicks: 0, category: 'venue', isPremium: true },
  { id: 53, name: 'Club Ámbar Ibiza', role: 'empresario', specialty: 'Club de Verano · Ibiza', rating: 5.0, reviews: 412, location: 'Ibiza', zone: 'San Antonio', country: 'España', city: 'Ibiza', experience: '7 años', price: 0, priceUnit: '', avatar: 'CA', gradient: 'linear-gradient(135deg,#D4AF37,#B8941E)', badges: ['House', 'Temporada Verano', 'Aforo 1.500'], description: 'Club de verano en Ibiza con programación de DJs internacionales. Temporada mayo-octubre en pleno corazón de la isla.', phone: '', instagram: '', topWeekend: true, photo: '', subscriptionTier: 'elite', isFlashActive: true, profileViews: 58, contactClicks: 0, category: 'venue', isPremium: true },
];
