...
export const profiles: Profile[] = [
  // ═══════════════════ DJs (4) ═══════════════════
  {
    ...
    description: 'DJ y productor de techno industrial con residencias en las mejores salas underground de Madrid.',
  ...
  },
  {
    ...
    description: 'Referente del deep house en Madrid. Sesiones melódicas con vinilo y producción propia.',
  ...
  },
  {
    ...
    description: 'El DJ urbano más solicitado de la zona centro.',
  ...
  },
  {
    ...
    description: 'DJ versátil con repertorio comercial para todo tipo de público.',
  ...
  // ═══════════════════ Staff (3) ═══════════════════
  {
    ...
    description: 'Azafata profesional con experiencia en clubs de alto standing.',
  ...
  },
  {
    ...
    description: 'Barman con espectáculo. Coctelería molecular y flair para eventos exclusivos.',
  ...
  },
  {
    ...
    description: 'La RRPP más conectada de Madrid.',
  ...
  // ═══════════════════ Maquillaje (2) ═══════════════════
  {
    ...
    description: 'Maquilladora artística especializada en looks de noche y efectos especiales.',
  ...
  },
  {
    ...
    description: 'Estilista capilar de autor con experiencia en desfiles y eventos nocturnos.',
  ...
  // ═══════════════════ Vestuario (2) ═══════════════════
  {
    ...
    description: 'Servicio integral de imagen nocturna: vestuario, asesoría de estilo y personal shopping.',
  ...
  },
  {
    ...
    description: 'Estilista de moda nocturna y streetwear. Diseño custom de outfits para artistas.',
  ...
  // ═══════════════════ Media & Contenido (3) ═══════════════════
  {
    id: 12, name: 'Carlos Flash', role: 'media', specialty: 'Fotografía de Eventos',
    rating: 4.9, reviews: 187, location: 'Madrid', zone: 'Centro',
    experience: '10 años', price: 60, priceUnit: '/hora',
    avatar: 'CF', gradient: 'linear-gradient(135deg, #D4AF37, #B8941E)',
    badges: ['Foto Nocturna', 'Reportaje', 'Canon R5'],
    description: 'Fotógrafo especializado en eventos nocturnos y fiestas. Entrega en 24h. Cobertura profesional para clubs y promotoras.',
    phone: '34612345012', instagram: 'carlosflash_photo', topWeekend: false,
    photo: '', subscriptionTier: 'elite', isFlashActive: true,
    profileViews: 934, contactClicks: 72, category: 'professional', isPremium: true,
  },
  {
    id: 13, name: 'Marta Lens', role: 'media', specialty: 'Videógrafa / Aftermovies',
    rating: 5.0, reviews: 156, location: 'Madrid', zone: 'Salamanca',
    experience: '8 años', price: 80, priceUnit: '/hora',
    avatar: 'ML', gradient: 'linear-gradient(135deg, #D4AF37, #F5D77A)',
    badges: ['Aftermovie', '4K Cinema', 'Drone'],
    description: 'Aftermovies cinematográficos para salas y festivales. Equipo propio con drone y gimbal. Edición completa incluida.',
    phone: '34612345013', instagram: 'martalens_video', topWeekend: false,
    photo: '', subscriptionTier: 'premium', isFlashActive: false,
    profileViews: 678, contactClicks: 54, category: 'professional',
  },
  {
    id: 14, name: 'Zoe Viral', role: 'media', specialty: 'Creadora de Contenido UGC/TikTok',
    rating: 4.8, reviews: 89, location: 'Madrid', zone: 'Malasaña',
    experience: '3 años', price: 45, priceUnit: '/hora',
    avatar: 'ZV', gradient: 'linear-gradient(135deg, #333, #1a1a1a)',
    badges: ['TikTok', 'Reels', 'UGC Creator'],
    description: 'Creadora de contenido viral para clubs y eventos nocturnos. +200K seguidores combinados. Reels, TikToks y Stories.',
    phone: '34612345014', instagram: 'zoeviral_', topWeekend: false,
    photo: '', subscriptionTier: 'free', isFlashActive: true,
    profileViews: 1456, contactClicks: 98, category: 'rookie',
    tiktok: 'zoeviral_',
  },

  // ═══════════════════ Diseño & Visuales (3) ═══════════════════
  {
    id: 15, name: 'Álex Neon', role: 'design', specialty: 'Identidad Visual / Flyers',
    rating: 4.9, reviews: 203, location: 'Madrid', zone: 'Lavapiés',
    experience: '9 años', price: 50, priceUnit: '/hora',
    avatar: 'AN', gradient: 'linear-gradient(135deg, #D4AF37, #B8941E)',
    badges: ['Flyers', 'Branding', 'Cartelería'],
    description: 'Diseñador gráfico especializado en identidad visual para salas y promotoras de ocio nocturno. Flyers, carteles y branding.',
    phone: '34612345015', instagram: 'alexneon_design', topWeekend: false,
    photo: '', subscriptionTier: 'elite', isFlashActive: true,
    profileViews: 812, contactClicks: 61, category: 'professional', isPremium: true,
  },
  {
    id: 16, name: 'Paula Motion', role: 'design', specialty: 'Motion Graphics',
    rating: 5.0, reviews: 112, location: 'Madrid', zone: 'Chamberí',
    experience: '6 años', price: 65, priceUnit: '/hora',
    avatar: 'PM', gradient: 'linear-gradient(135deg, #333, #1a1a1a)',
    badges: ['After Effects', 'LED Mapping', 'Visuales Live'],
    description: 'Diseñadora de motion graphics para pantallas LED en salas y festivales. Visuales interactivos en tiempo real.',
    phone: '34612345016', instagram: 'paulamotion_vfx', topWeekend: false,
    photo: '', subscriptionTier: 'premium', isFlashActive: false,
    profileViews: 445, contactClicks: 33, category: 'professional',
  },
  {
    id: 17, name: 'Rubén VJ', role: 'design', specialty: 'Video Jockey (VJ)',
    rating: 4.7, reviews: 78, location: 'Madrid', zone: 'Malasaña',
    experience: '5 años', price: 55, priceUnit: '/hora',
    avatar: 'RV', gradient: 'linear-gradient(135deg, #333, #1a1a1a)',
    badges: ['Resolume', 'VDMX', 'Live Visuals'],
    description: 'VJ con setup propio. Proyecciones inmersivas sincronizadas con el DJ. Experiencia en las mejores salas underground.',
    phone: '34612345017', instagram: 'rubenvj_visuals', topWeekend: false,
    photo: '', subscriptionTier: 'free', isFlashActive: true,
    profileViews: 234, contactClicks: 19, category: 'rookie',
  },

  // ═══════════════════ Brand Ambassador (2) ═══════════════════
  {
    id: 18, name: 'Laura Promo', role: 'ambassador', specialty: 'Brand Ambassador & Street Team',
    rating: 4.8, reviews: 145, location: 'Madrid', zone: 'Centro',
    experience: '4 años', price: 25, priceUnit: '/hora',
    avatar: 'LP', gradient: 'linear-gradient(135deg, #D4AF37, #B8941E)',
    badges: ['Street Team', 'Flyering', 'Registro In-Situ'],
    description: 'Promotora profesional con experiencia en acciones de guerrilla, reparto de flyers con QR y registro de usuarios en eventos.',
    phone: '34612345018', instagram: 'laurapromo_mad', topWeekend: false,
    photo: '', subscriptionTier: 'premium', isFlashActive: true,
    profileViews: 567, contactClicks: 43, category: 'professional',
  },
  {
    id: 19, name: 'Javi Street', role: 'ambassador', specialty: 'Promoción Física & Soporte Marca',
    rating: 4.6, reviews: 67, location: 'Madrid', zone: 'Malasaña',
    experience: '2 años', price: 20, priceUnit: '/hora',
    avatar: 'JS', gradient: 'linear-gradient(135deg, #333, #1a1a1a)',
    badges: ['QR Campaigns', 'Activaciones', 'Soporte Evento'],
    description: 'Soporte de marca en eventos nocturnos. Gestión de stands, activaciones y captación de nuevos usuarios para la plataforma.',
    phone: '34612345019', instagram: 'javistreet_promo', topWeekend: false,
    photo: '', subscriptionTier: 'free', isFlashActive: false,
    profileViews: 123, contactClicks: 8, category: 'rookie',
  },
];
