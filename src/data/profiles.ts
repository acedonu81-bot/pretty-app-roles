...
export const profiles: Profile[] = [
  // ═══════════════════ DJs (4) ═══════════════════
  { id: 1, name: 'Dani Tech', role: 'dj', specialty: 'Techno / Industrial', rating: 4.9, reviews: 218, location: 'Madrid', zone: 'Malasaña', country: 'España', city: 'Madrid', experience: '8 años', price: 120, priceUnit: '/hora', avatar: 'DT', gradient: 'linear-gradient(135deg, #D4AF37, #B8941E)', badges: ['Techno', 'Industrial', 'Modular Live'], description: 'DJ y productor de techno industrial con residencias en las mejores salas underground de Madrid.', phone: '', instagram: 'danitech_dj', topWeekend: true, photo: '', subscriptionTier: 'elite', isFlashActive: true, profileViews: 0, contactClicks: 0, streamUrl: 'https://twitch.tv/danitech_dj', isLive: true, category: 'professional', isPremium: true },
  ...
  { id: 3, name: 'MC Ráfaga', role: 'dj', specialty: 'Urbano / Reggaetón', rating: 4.7, reviews: 189, location: 'Barcelona', zone: 'Eixample', country: 'España', city: 'Barcelona', experience: '6 años', price: 60, priceUnit: '/hora', avatar: 'MR', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['Urbano', 'Reggaetón', 'Latino Mix'], description: 'El DJ urbano más solicitado de Barcelona.', phone: '', instagram: 'mcrafaga_dj', topWeekend: false, photo: '', subscriptionTier: 'premium', isFlashActive: false, profileViews: 0, contactClicks: 0, category: 'rookie' },
  { id: 4, name: 'Sara Beats', role: 'dj', specialty: 'Comercial / Top Hits', rating: 4.8, reviews: 267, location: 'Lisboa', zone: 'Bairro Alto', country: 'Portugal', city: 'Lisboa', experience: '9 años', price: 80, priceUnit: '/hora', avatar: 'SB', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['Comercial', 'Top 40', 'Bodas & Eventos'], description: 'DJ versátil con repertorio comercial para todo tipo de público.', phone: '', instagram: 'sarabeats_official', topWeekend: false, photo: '', subscriptionTier: 'free', isFlashActive: true, profileViews: 0, contactClicks: 0, category: 'rookie' },

  // ═══════════════════ Staff (3) ═══════════════════
  { id: 5, name: 'Carla Vega', role: 'staff', specialty: 'Azafata VIP & Hostess', rating: 4.9, reviews: 154, location: 'Madrid', zone: 'Salamanca', experience: '5 años', price: 30, priceUnit: '/hora', avatar: 'CV', gradient: 'linear-gradient(135deg, #D4AF37, #B8941E)', badges: ['Hostess VIP', 'Protocolo', 'Multilingüe EN/FR'], description: 'Azafata profesional con experiencia en clubs de alto standing.', phone: '', instagram: 'carlavega_hostess', topWeekend: false, photo: '', subscriptionTier: 'elite', isFlashActive: true, profileViews: 0, contactClicks: 0, category: 'professional', isPremium: true },
  { id: 6, name: 'Marcos Ríos', role: 'staff', specialty: 'Camarero VIP & Flair', rating: 4.8, reviews: 98, location: 'Madrid', zone: 'Malasaña', experience: '7 años', price: 22, priceUnit: '/hora', avatar: 'MR', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['Flair Bartending', 'Coctelería VIP', 'Certificado WSET'], description: 'Barman con espectáculo. Coctelería molecular y flair para eventos exclusivos.', phone: '', instagram: 'marcosrios_bar', topWeekend: false, photo: '', subscriptionTier: 'premium', isFlashActive: false, profileViews: 0, contactClicks: 0, category: 'rookie' },
