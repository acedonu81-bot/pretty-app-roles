...
export const profiles: Profile[] = [
  // ═══════════════════ DJs (4) ═══════════════════
  { id: 1, name: 'Dani Tech', role: 'dj', specialty: 'Techno / Industrial', rating: 4.9, reviews: 218, location: 'Madrid', zone: 'Malasaña', country: 'España', city: 'Madrid', experience: '8 años', price: 120, priceUnit: '/hora', avatar: 'DT', gradient: 'linear-gradient(135deg, #D4AF37, #B8941E)', badges: ['Techno', 'Industrial', 'Modular Live'], description: 'DJ y productor de techno industrial con residencias en las mejores salas underground de Madrid.', phone: '34612345001', instagram: 'danitech_dj', topWeekend: true, photo: '', subscriptionTier: 'elite', isFlashActive: true, profileViews: 0, contactClicks: 0, streamUrl: 'https://twitch.tv/danitech_dj', isLive: true, category: 'professional', isPremium: true },
  ...
  { id: 13, name: 'Marta Lens', role: 'media', specialty: 'Videógrafa / Aftermovies', rating: 5.0, reviews: 156, location: 'Madrid', zone: 'Salamanca', experience: '8 años', price: 0, priceUnit: '', avatar: 'ML', gradient: 'linear-gradient(135deg, #D4AF37, #F5D77A)', badges: ['Aftermovie', '4K Cinema', 'Drone'], description: 'Aftermovies cinematográficos para salas y festivales. Equipo propio con drone y gimbal.', phone: '34612345013', instagram: 'martalens_video', topWeekend: false, photo: '', subscriptionTier: 'premium', isFlashActive: false, profileViews: 0, contactClicks: 0, category: 'professional' },
  { id: 14, name: 'Zoe Viral', role: 'media', specialty: 'Creadora de Contenido UGC/TikTok', rating: 4.8, reviews: 89, location: 'Madrid', zone: 'Malasaña', experience: '3 años', price: 0, priceUnit: '', avatar: 'ZV', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['TikTok', 'Reels', 'UGC Creator'], description: 'Creadora de contenido viral para clubs y eventos nocturnos. +200K seguidores.', phone: '34612345014', instagram: 'zoeviral_', topWeekend: false, photo: '', subscriptionTier: 'free', isFlashActive: true, profileViews: 0, contactClicks: 0, category: 'rookie', tiktok: 'zoeviral_' },
