...
export const profiles: Profile[] = [
  // ═══════════════════ DJs (4) ═══════════════════
{ id: 2, name: 'Luna Deep', role: 'dj', specialty: 'Deep House / Melodic', rating: 5.0, reviews: 312, location: 'Madrid', zone: 'Salamanca', country: 'España', city: 'Madrid', experience: '11 años', price: 150, priceUnit: '/hora', avatar: 'LD', gradient: 'linear-gradient(135deg, #D4AF37, #F5D77A)', badges: ['Deep House', 'Melodic', 'Vinyl Set'], description: 'Referente del deep house en Madrid. Sesiones melódicas con vinilo y producción propia.', phone: '', instagram: 'lunadeep_music', topWeekend: true, photo: 'https://images.pexels.com/photos/1362727/pexels-photo-1362727.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'elite', isFlashActive: true, profileViews: 0, contactClicks: 0, category: 'professional', isPremium: true },
  { id: 3, name: 'MC Ráfaga', role: 'dj', specialty: 'Urbano / Reggaetón', rating: 4.7, reviews: 189, location: 'Barcelona', zone: 'Eixample', country: 'España', city: 'Barcelona', experience: '6 años', price: 60, priceUnit: '/hora', avatar: 'MR', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['Urbano', 'Reggaetón', 'Latino Mix'], description: 'El DJ urbano más solicitado de Barcelona.', phone: '', instagram: 'mcrafaga_dj', topWeekend: false, photo: 'https://images.pexels.com/photos/1699161/pexels-photo-1699161.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'premium', isFlashActive: false, profileViews: 0, contactClicks: 0, category: 'rookie' },
  { id: 4, name: 'Sara Beats', role: 'dj', specialty: 'Comercial / Top Hits', rating: 4.8, reviews: 267, location: 'Sevilla', zone: 'Centro', country: 'España', city: 'Sevilla', experience: '9 años', price: 80, priceUnit: '/hora', avatar: 'SB', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['Comercial', 'Top 40', 'Bodas & Eventos'], description: 'DJ versátil con repertorio comercial para todo tipo de público.', phone: '', instagram: 'sarabeats_official', topWeekend: false, photo: 'https://images.pexels.com/photos/3237218/pexels-photo-3237218.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'free', isFlashActive: true, profileViews: 0, contactClicks: 0, category: 'rookie' },

  // ═══════════════════ Staff (3) ═══════════════════
  { id: 5, name: 'Carla Vega', role: 'staff', specialty: 'Azafata VIP & Hostess', rating: 4.9, reviews: 154, location: 'Madrid', zone: 'Salamanca', experience: '5 años', price: 30, priceUnit: '/hora', avatar: 'CV', gradient: 'linear-gradient(135deg, #D4AF37, #B8941E)', badges: ['Hostess VIP', 'Protocolo', 'Multilingüe EN/FR'], description: 'Azafata profesional con experiencia en clubs de alto standing.', phone: '', instagram: 'carlavega_hostess', topWeekend: false, photo: 'https://images.pexels.com/photos/4065624/pexels-photo-4065624.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'elite', isFlashActive: true, profileViews: 0, contactClicks: 0, category: 'professional', isPremium: true },
  { id: 6, name: 'Marcos Ríos', role: 'staff', specialty: 'Camarero VIP & Flair', rating: 4.8, reviews: 98, location: 'Madrid', zone: 'Malasaña', experience: '7 años', price: 22, priceUnit: '/hora', avatar: 'MR', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['Flair Bartending', 'Coctelería VIP', 'Certificado WSET'], description: 'Barman con espectáculo. Coctelería molecular y flair para eventos exclusivos.', phone: '', instagram: 'marcosrios_bar', topWeekend: false, photo: 'https://images.pexels.com/photos/2773977/pexels-photo-2773977.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'premium', isFlashActive: false, profileViews: 0, contactClicks: 0, category: 'rookie' },
  { id: 7, name: 'Patricia Sanz', role: 'staff', specialty: 'RRPP & Relaciones Públicas', rating: 5.0, reviews: 201, location: 'Madrid', zone: 'Chamberí', experience: '10 años', price: 28, priceUnit: '/hora', avatar: 'PS', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['RRPP Premium', 'Gestión Listas', 'Networking VIP'], description: 'La RRPP más conectada de Madrid.', phone: '', instagram: 'patriciasanz_rrpp', topWeekend: false, photo: 'https://images.pexels.com/photos/2878934/pexels-photo-2878934.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'free', isFlashActive: true, profileViews: 0, contactClicks: 0, category: 'professional' },

  // ═══════════════════ Maquillaje (2) ═══════════════════
  { id: 8, name: 'Nadia Glamour', role: 'makeup', specialty: 'Maquillaje de Noche & FX', rating: 5.0, reviews: 245, location: 'Madrid', zone: 'Chueca', experience: '9 años', price: 0, priceUnit: '', avatar: 'NG', gradient: 'linear-gradient(135deg, #D4AF37, #F5D77A)', badges: ['Noche Glam', 'FX Pro', 'Bodypaint UV'], description: 'Maquilladora artística especializada en looks de noche y efectos especiales.', phone: '', instagram: 'nadiaglamour_makeup', topWeekend: false, photo: 'https://images.pexels.com/photos/3680445/pexels-photo-3680445.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'elite', isFlashActive: false, profileViews: 0, contactClicks: 0, category: 'professional', isPremium: true },
  { id: 9, name: 'Iván Stylez', role: 'makeup', specialty: 'Peluquería de Autor', rating: 4.9, reviews: 178, location: 'Madrid', zone: 'Chamberí', experience: '12 años', price: 0, priceUnit: '', avatar: 'IS', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['Color Expert', 'Extensiones', 'Peinado Evento'], description: 'Estilista capilar de autor con experiencia en desfiles y eventos nocturnos.', phone: '', instagram: 'ivanstylez_hair', topWeekend: false, photo: 'https://images.pexels.com/photos/2608517/pexels-photo-2608517.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'premium', isFlashActive: true, profileViews: 0, contactClicks: 0, category: 'rookie' },

  // ═══════════════════ Vestuario (2) ═══════════════════
  { id: 10, name: 'Alicia Moon', role: 'vestuario', specialty: 'Estilismo Integral Nocturno', rating: 4.8, reviews: 134, location: 'Madrid', zone: 'Chueca', experience: '7 años', price: 0, priceUnit: '', avatar: 'AM', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['Styling Completo', 'Asesoría Imagen', 'Luxury Brands'], description: 'Servicio integral de imagen nocturna: vestuario, asesoría de estilo y personal shopping.', phone: '', instagram: 'aliciamoon_style', topWeekend: false, photo: 'https://images.pexels.com/photos/1126993/pexels-photo-1126993.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'free', isFlashActive: false, profileViews: 0, contactClicks: 0, category: 'professional' },
  { id: 11, name: 'Diego Noir', role: 'vestuario', specialty: 'Moda Nocturna & Streetwear', rating: 4.7, reviews: 92, location: 'Madrid', zone: 'Malasaña', experience: '5 años', price: 0, priceUnit: '', avatar: 'DN', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['Streetwear', 'Diseño Custom', 'Vintage'], description: 'Estilista de moda nocturna y streetwear. Diseño custom de outfits para artistas.', phone: '', instagram: 'diegonoir_fashion', topWeekend: false, photo: 'https://images.pexels.com/photos/2869657/pexels-photo-2869657.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'premium', isFlashActive: true, profileViews: 0, contactClicks: 0, category: 'rookie' },

  // ═══════════════════ Media & Contenido (3) ═══════════════════
  { id: 12, name: 'Carlos Flash', role: 'media', specialty: 'Fotografía de Eventos', rating: 4.9, reviews: 187, location: 'Madrid', zone: 'Centro', experience: '10 años', price: 0, priceUnit: '', avatar: 'CF', gradient: 'linear-gradient(135deg, #D4AF37, #B8941E)', badges: ['Foto Nocturna', 'Reportaje', 'Canon R5'], description: 'Fotógrafo especializado en eventos nocturnos y fiestas. Entrega en 24h.', phone: '', instagram: 'carlosflash_photo', topWeekend: false, photo: 'https://images.pexels.com/photos/1047540/pexels-photo-1047540.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'elite', isFlashActive: true, profileViews: 0, contactClicks: 0, category: 'professional', isPremium: true },
  { id: 13, name: 'Marta Lens', role: 'media', specialty: 'Videógrafa / Aftermovies', rating: 5.0, reviews: 156, location: 'Madrid', zone: 'Salamanca', experience: '8 años', price: 0, priceUnit: '', avatar: 'ML', gradient: 'linear-gradient(135deg, #D4AF37, #F5D77A)', badges: ['Aftermovie', '4K Cinema', 'Drone'], description: 'Aftermovies cinematográficos para salas y festivales. Equipo propio con drone y gimbal.', phone: '', instagram: 'martalens_video', topWeekend: false, photo: 'https://images.pexels.com/photos/3822619/pexels-photo-3822619.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'premium', isFlashActive: false, profileViews: 0, contactClicks: 0, category: 'professional' },
  { id: 14, name: 'Zoe Viral', role: 'media', specialty: 'Creadora de Contenido UGC/TikTok', rating: 4.8, reviews: 89, location: 'Madrid', zone: 'Malasaña', experience: '3 años', price: 0, priceUnit: '', avatar: 'ZV', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['TikTok', 'Reels', 'UGC Creator'], description: 'Creadora de contenido viral para clubs y eventos nocturnos. +200K seguidores.', phone: '', instagram: 'zoeviral_', topWeekend: false, photo: 'https://images.pexels.com/photos/3771819/pexels-photo-3771819.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'free', isFlashActive: true, profileViews: 0, contactClicks: 0, category: 'rookie', tiktok: 'zoeviral_' },

  // ═══════════════════ Diseño & Visuales (3) ═══════════════════
  { id: 15, name: 'Álex Neon', role: 'design', specialty: 'Identidad Visual / Flyers', rating: 4.9, reviews: 203, location: 'Madrid', zone: 'Lavapiés', experience: '9 años', price: 0, priceUnit: '', avatar: 'AN', gradient: 'linear-gradient(135deg, #D4AF37, #B8941E)', badges: ['Flyers', 'Branding', 'Cartelería'], description: 'Diseñador gráfico especializado en identidad visual para salas y promotoras.', phone: '', instagram: 'alexneon_design', topWeekend: false, photo: 'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'elite', isFlashActive: true, profileViews: 0, contactClicks: 0, category: 'professional', isPremium: true },
  { id: 16, name: 'Paula Motion', role: 'design', specialty: 'Motion Graphics', rating: 5.0, reviews: 112, location: 'Madrid', zone: 'Chamberí', experience: '6 años', price: 0, priceUnit: '', avatar: 'PM', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['After Effects', 'LED Mapping', 'Visuales Live'], description: 'Diseñadora de motion graphics para pantallas LED en salas y festivales.', phone: '', instagram: 'paulamotion_vfx', topWeekend: false, photo: 'https://images.pexels.com/photos/1878294/pexels-photo-1878294.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'premium', isFlashActive: false, profileViews: 0, contactClicks: 0, category: 'professional' },
  { id: 17, name: 'Rubén VJ', role: 'design', specialty: 'Video Jockey (VJ)', rating: 4.7, reviews: 78, location: 'Madrid', zone: 'Malasaña', experience: '5 años', price: 0, priceUnit: '', avatar: 'RV', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['Resolume', 'VDMX', 'Live Visuals'], description: 'VJ con setup propio. Proyecciones inmersivas sincronizadas con el DJ.', phone: '', instagram: 'rubenvj_visuals', topWeekend: false, photo: 'https://images.pexels.com/photos/7149246/pexels-photo-7149246.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'free', isFlashActive: true, profileViews: 0, contactClicks: 0, category: 'rookie' },

  // ═══════════════════ Brand Ambassador (2) ═══════════════════
  { id: 18, name: 'Laura Promo', role: 'ambassador', specialty: 'Brand Ambassador & Street Team', rating: 4.8, reviews: 145, location: 'Madrid', zone: 'Centro', experience: '4 años', price: 25, priceUnit: '/hora', avatar: 'LP', gradient: 'linear-gradient(135deg, #D4AF37, #B8941E)', badges: ['Street Team', 'Flyering', 'Registro In-Situ'], description: 'Promotora profesional con experiencia en acciones de guerrilla.', phone: '', instagram: 'laurapromo_mad', topWeekend: false, photo: 'https://images.pexels.com/photos/1647919/pexels-photo-1647919.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'premium', isFlashActive: true, profileViews: 0, contactClicks: 0, category: 'professional' },
  { id: 19, name: 'Javi Street', role: 'ambassador', specialty: 'Promoción Física & Soporte Marca', rating: 4.6, reviews: 67, location: 'Madrid', zone: 'Malasaña', experience: '2 años', price: 20, priceUnit: '/hora', avatar: 'JS', gradient: 'linear-gradient(135deg, #333, #1a1a1a)', badges: ['QR Campaigns', 'Activaciones', 'Soporte Evento'], description: 'Soporte de marca en eventos nocturnos. Gestión de stands y captación.', phone: '', instagram: 'javistreet_promo', topWeekend: false, photo: 'https://images.pexels.com/photos/4353842/pexels-photo-4353842.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop', subscriptionTier: 'free', isFlashActive: false, profileViews: 0, contactClicks: 0, category: 'rookie' },
];
