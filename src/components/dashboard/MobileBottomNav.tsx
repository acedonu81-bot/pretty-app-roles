...
const roleToView: Record<string, string> = {
  dj: 'dj', staff: 'staff', azafata: 'azafata', makeup: 'makeup', media: 'media',
  vestuario: 'vestuario', design: 'design', promotor: 'promotor',
  event_manager: 'event_manager', empresario: 'empresario',
};

const dirViews = new Set(['dj','staff','azafata','makeup','media','vestuario','design','promotor','event_manager','empresario','catering','mago','bailarin','humorista','monologo','animador','speaker','ambassador']);
