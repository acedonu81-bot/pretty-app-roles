...
const initialThreads: Thread[] = [
  { id: 1, name: 'Onyx Club Madrid', initials: 'ON', gradient: 'linear-gradient(135deg,#D4AF37,#B8941E)', color: '#000', lastMsg: 'Envío de Normas de Uso y Privacidad', time: 'Hace 5m', online: true, unread: 2, verified: true },
...
const chatMessages = [
  ...
  { sender: 'system', text: 'Se han enviado las Normas de Uso y Privacidad de XPEAK. Recuerda: XPEAK no contrata, solo intermedia entre profesionales y empresas.' },
];
                ...
                <div key={i} className="text-center py-2">
                  <div className="inline-flex flex-col items-center gap-1.5 px-4 py-3 rounded-lg text-xs" style={{ background: 'rgba(212,175,55,0.06)', border: '1px solid rgba(212,175,55,0.15)' }}>
                    ...
                    <button onClick={() => setShowLegalModal(true)}
                      ...
                      <Download size={10} /> Ver Normas de Uso y Privacidad
                    </button>
                  </div>
                </div>
              ) : (
