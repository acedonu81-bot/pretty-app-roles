// Contenido extraído literal de src/pages/Terminos.tsx (sin Helmet,
// AmbientBackground ni LegalFooter — esos quedan solo para la ruta web
// /terminos). Ver src/pages/Terminos.tsx para la fuente original.
