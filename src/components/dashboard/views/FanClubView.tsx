...
import SessionsTab from './fanclub/SessionsTab';
...
const FanClubView = () => {
  ...
  const [tab, setTab] = useState<'overview' | 'posts' | 'sessions' | 'fans' | 'tiers'>('overview');
    ...
    <div className="animate-[fadeIn_0.4s_ease] relative">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-8">
        ...
        <div className="flex gap-2 overflow-x-auto pb-0.5" style={{ scrollbarWidth: 'none' }}>
          {(['overview','sessions','posts','fans','tiers'] as const).map(t => (
