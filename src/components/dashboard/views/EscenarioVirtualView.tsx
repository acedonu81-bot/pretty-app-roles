      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-4" style={{ minHeight: '55vh' }}>
        <div className="flex flex-col gap-4">
          <div className="glass-panel p-5 flex-1 flex flex-col">
            ...
            {profile.phone ? (
              <a
                href={`https://wa.me/${profile.phone.replace(/\D/g, '')}?text=Hola%2C%20te%20he%20visto%20en%20XPEAK`}
                target="_blank"
              ...
              <div className="mt-4 w-full flex items-center justify-center gap-2 px-6 py-3 rounded-lg text-sm"
                style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', color: '#8E8EA0' }}>
                <WaIcon size={18} /> Añade tu teléfono en Ajustes para activar el contacto
              </div>
            )}
          </div>
        </div>
