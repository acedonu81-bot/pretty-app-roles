...
const ROLE_CFG: Record<string, {
  color: string; glow: string; label: string; tagline: string; icon: React.ElementType;
}> = {
  dj:        { color: '#4285F4', glow: 'rgba(66,133,244,0.45)',   label: 'DJ · Artista',       tagline: 'La pista empieza aquí',        icon: Music },
  rookie:    { color: '#FBBF24', glow: 'rgba(251,191,36,0.4)',    label: 'DJ Promesa',          tagline: 'El próximo grande',             icon: Star },
  staff:     { color: '#34D399', glow: 'rgba(52,211,153,0.35)',   label: 'Sala & Barra',        tagline: 'El engranaje invisible del show', icon: Users },
  azafata:   { color: '#F472B6', glow: 'rgba(244,114,182,0.35)',  label: 'Azafata',             tagline: 'La primera impresión del evento', icon: Users },
  makeup:    { color: '#F472B6', glow: 'rgba(244,114,182,0.35)',  label: 'Maquillaje',            tagline: 'Arte en la piel',              icon: Star },
  peluqueria:{ color: '#EC4899', glow: 'rgba(236,72,153,0.35)',   label: 'Peluquería a Domicilio', tagline: 'Estilo que llega hasta ti',   icon: Star },
  media:     { color: '#A78BFA', glow: 'rgba(167,139,250,0.4)',   label: 'Media · Contenido',   tagline: 'Cada frame es eterno',          icon: Camera },
  ambassador:{ color: '#FB923C', glow: 'rgba(251,146,60,0.35)',   label: 'Promotor',            tagline: 'La energía que llena salas',    icon: Megaphone },
  vestuario: { color: '#D4AF37', glow: 'rgba(212,175,55,0.35)',   label: 'Vestuario',           tagline: 'Estilo que habla',              icon: Crown },
  design:    { color: '#22D3EE', glow: 'rgba(34,211,238,0.35)',   label: 'VJing · Diseño',      tagline: 'El visual de tu evento',        icon: Camera },
  promotor:  { color: '#FB923C', glow: 'rgba(251,146,60,0.35)',   label: 'Promotor',            tagline: 'La energía que llena salas',    icon: Megaphone },
  empresario:{ color: '#D4AF37', glow: 'rgba(212,175,55,0.4)',    label: 'Empresario · Venue',  tagline: 'Tu espacio, tus eventos',       icon: Crown },
  ...
  'grupo-musical': { color: '#DB2777', glow: 'rgba(219,39,119,0.4)',  label: 'Grupo Musical',       tagline: 'Música en directo',             icon: Music },
  catering:  { color: '#B45309', glow: 'rgba(180,83,9,0.35)',     label: 'Catering · Chef',     tagline: 'El sabor de la noche',          icon: Star },
  mago:      { color: '#7C3AED', glow: 'rgba(124,58,237,0.4)',    label: 'Mago · Ilusionista',  tagline: 'Lo imposible, en directo',      icon: Star },
  bailarin:  { color: '#DB2777', glow: 'rgba(219,39,119,0.35)',   label: 'Instructor · Bailarín', tagline: 'El cuerpo también habla',     icon: Users },
  humorista: { color: '#F59E0B', glow: 'rgba(245,158,11,0.35)',   label: 'Humorista · Cómico',  tagline: 'La sala entera riendo',         icon: Megaphone },
...
const getRoleCfg = (role: string) => ROLE_CFG[role] ?? {
  ...
  tagline: 'Profesional de eventos', icon: Star,
};
