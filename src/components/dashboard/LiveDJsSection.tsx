...
const ROLE_LABEL: Record<string, string> = { dj: 'DJ', staff: 'Camarero', azafata: 'Azafata', makeup: 'Makeup', peluqueria: 'Peluquería', rookie: 'Promesa', media: 'Media' };
const ROLE_COLOR: Record<string, string> = { dj: '#D4AF37', staff: '#8B5CF6', azafata: '#F472B6', makeup: '#EC4899', peluqueria: '#F472B6', rookie: '#F59E0B', media: '#3B82F6' };
