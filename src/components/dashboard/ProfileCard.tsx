import { Star, MapPin, Clock, Instagram, Navigation } from 'lucide-react';
...
const ProfileCard = ({ profile: p, onBook, compact }: ProfileCardProps) => {
  ...
  return (
    <div className="glass-panel p-5 flex flex-col transition-all hover:border-gold/20 duration-300 relative group">
      {/* TOP WEEKEND badge */}
      {p.topWeekend && (
