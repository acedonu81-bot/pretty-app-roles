        ...
        {teaser && (
          <div className="relative rounded-xl overflow-hidden" style={{ border: `1px solid ${accentColor}20` }}>
            <div className="p-4 pb-2">
              <p className="text-xs font-bold truncate" style={{ color: 'rgba(255,255,255,0.5)' }}>{teaser.title}</p>
            </div>
            {parsed && (
        ...
        return (
          <div key={s.id} className="rounded-xl overflow-hidden"
            ...
            <button
              ...
              {isOpen ? <ChevronUp size={14} style={{ flexShrink: 0, color: 'rgba(255,255,255,0.4)' }} />
                : <ChevronDown size={14} style={{ flexShrink: 0, color: 'rgba(255,255,255,0.4)' }} />}
            </button>
            {isOpen && parsed && (
