        ...
        {status === 'done' ? (
          <div className="text-center py-6">
            ...
            {/* Sin prometer que le contactarán: eso no depende de XPEAK y el 22
                ...
                pantalla. Se dice lo que sí es cierto (que le ha llegado). El
                CTA de "crea cuenta gratis" que había aquí se quitó (09 sep
                2026): el modal ya solo se abre con sesión iniciada, así que
                nunca podía verlo nadie. */}
