  ...
  return (
    <div className="my-6 rounded-xl overflow-hidden"
      ...
      <div className="px-4 py-4">
        <p className="text-xs font-bold mb-2" style={{ color: 'rgba(255,255,255,0.5)' }}>{question}</p>
        <p className="text-sm leading-relaxed font-medium" style={{ color: 'rgba(255,255,255,0.88)' }}>{answer}</p>
      </div>
    </div>
  );
}
