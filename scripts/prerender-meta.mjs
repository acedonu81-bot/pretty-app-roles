...
const ROUTES = [
  ...
  },
  {
    ...
    title: 'Contratar maquilladora o peluquero para bodas y eventos — Directorio XPEAK',
    desc: 'Directorio de maquilladoras y peluqueros para bodas, comuniones y eventos en España. Portfolios y precios reales.',
    ogTitle: 'Directorio de maquilladoras y peluqueros — XPEAK',
    ogDesc: 'Encuentra maquilladoras y peluqueros para tu boda o evento. Portfolios reales y contacto directo.',
    ogType: 'website',
  },
  {
