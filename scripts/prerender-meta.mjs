...
const ROUTES = [
  ...
  { path: '/blog/locales-para-eventos-madrid', title: 'Locales para eventos en Madrid: guía de salas, terrazas y fincas (2026) | XPEAK', desc: 'Discotecas, terrazas, azoteas y fincas para despedidas en Madrid y alrededores, con web y contacto directo. Sin comisiones ni intermediarios.', ogTitle: 'Locales para eventos en Madrid — XPEAK Blog', ogDesc: 'Guía de salas, terrazas, azoteas y fincas para fiestas y despedidas en Madrid, con contacto directo de cada local.', ogType: 'article' },
