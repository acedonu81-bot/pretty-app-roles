...
const ROUTES = [
  ...
  // Category landings
  {
    ...
    desc: 'Contrata DJs verificados en toda España: Tech House, Techno, Comercial y más. Flash Booking en menos de 1h. Contratos automáticos.',
    ogTitle: 'Contratar DJ para Eventos en España | XPEAK',
    ogDesc: 'Directorio verificado de DJs profesionales. Flash Booking, contratos digitales. DJ para bodas, clubs y festivales.',
    ogType: 'website',
  },
  {
  ...
  },
  {
    ...
    desc: 'Contrata camareros y personal de servicio para bodas, eventos corporativos y hostelería nocturna. Perfiles verificados, contratos automáticos.',
  ...
  },
  {
    ...
    desc: 'Contrata catering y personal de servicio para bodas, eventos corporativos y celebraciones privadas en España. Perfiles verificados.',
  ...
  },
  {
    ...
    desc: 'Contrata maquilladores artísticos para eventos, shows y actuaciones en España. Perfiles verificados.',
  ...
  },
  {
    ...
    desc: 'Encuentra peluquera a domicilio cerca de ti en España. Corte, color, peinados de novia y recogidos, para eventos o para el día a día. Perfiles verificados.',
  ...
  },
  {
    ...
    desc: 'Contrata promotores, RRPP y coordinadores de acceso para clubs, festivales y eventos privados en España. Perfiles verificados.',
    ogTitle: 'Contratar Promotores de Eventos en España | XPEAK',
    ogDesc: 'Promotores y RRPP verificados para clubs y festivales. Flash Booking disponible.',
    ogType: 'website',
  },
  {
    path: '/contratar-vestuario',
    title: 'Contratar Estilista de Eventos | XPEAK | Directorio Profesional de Eventos',
    desc: 'Contrata diseñadores de vestuario, estilistas y técnicos de moda para shows, actuaciones y eventos en España. Perfiles verificados.',
  ...
  // City landings — Camareros
  {
    ...
    ogDesc: 'Camareros verificados en Madrid. Flash Booking para cubrir eventos urgentes.',
    ogType: 'website',
  },
  {
    ...
    ogDesc: 'Camareros verificados en Barcelona. Flash Booking para cubrir eventos urgentes.',
    ogType: 'website',
  },
  // City landings — Fotógrafo
  {
    ...
    desc: 'Contrata fotógrafos profesionales en Madrid para bodas, eventos nocturnos y corporativos. Pack foto+vídeo disponible. Flash Booking.',
    ogTitle: 'Contratar Fotógrafo en Madrid | XPEAK',
    ogDesc: 'Fotógrafos verificados en Madrid para bodas y eventos. Flash Booking disponible.',
    ogType: 'website',
  },
  {
    path: '/contratar-fotografo/barcelona',
    title: 'Contratar Fotógrafo en Barcelona | XPEAK | Fotógrafos de eventos verificados',
    desc: 'Contrata fotógrafos profesionales en Barcelona para bodas, eventos nocturnos y corporativos. Pack foto+vídeo disponible. Flash Booking.',
    ogTitle: 'Contratar Fotógrafo en Barcelona | XPEAK',
    ogDesc: 'Fotógrafos verificados en Barcelona para bodas y eventos. Flash Booking disponible.',
    ogType: 'website',
  },
  // City landings — Catering
  {
    ...
    desc: 'Contrata catering profesional en Madrid para bodas, eventos corporativos y celebraciones privadas. Menús personalizados.',
    ogTitle: 'Contratar Catering en Madrid | XPEAK',
    ogDesc: 'Catering profesional en Madrid para bodas y eventos. Menús personalizados.',
    ogType: 'website',
  },
  {
    path: '/contratar-catering/barcelona',
    title: 'Contratar Catering en Barcelona | XPEAK | Catering para bodas y eventos',
    desc: 'Contrata catering profesional en Barcelona para bodas, eventos corporativos y celebraciones privadas. Menús personalizados.',
    ogTitle: 'Contratar Catering en Barcelona | XPEAK',
    ogDesc: 'Catering profesional en Barcelona para bodas y eventos. Menús personalizados.',
    ogType: 'website',
  },
  // Disco móvil — genérica + ciudades
  {
    ...
    desc: 'Alquiler de disco móvil profesional para bodas, comuniones y fiestas privadas en España. DJ + sonido + luces + efectos incluidos. Flash Booking.',
    ogTitle: 'Contratar Disco Móvil en España | XPEAK',
    ogDesc: 'DJ con equipo completo para bodas, comuniones y fiestas privadas. Flash Booking disponible.',
    ogType: 'website',
  },
  {
    path: '/contratar-disco-movil/madrid',
    title: 'Contratar Disco Móvil en Madrid | XPEAK | DJ con equipo para bodas',
    desc: 'Contrata disco móvil en Madrid: DJ profesional con equipo de sonido, luces y efectos para bodas, comuniones y fiestas privadas. Flash Booking.',
    ogTitle: 'Contratar Disco Móvil en Madrid | XPEAK',
    ogDesc: 'Disco móvil profesional en Madrid para bodas y eventos. Equipo completo incluido.',
    ogType: 'website',
  },
  {
    path: '/contratar-disco-movil/barcelona',
    title: 'Contratar Disco Móvil en Barcelona | XPEAK | DJ con equipo para bodas',
    desc: 'Contrata disco móvil en Barcelona: DJ profesional con equipo de sonido, luces y efectos para bodas, comuniones y fiestas privadas. Flash Booking.',
    ogTitle: 'Contratar Disco Móvil en Barcelona | XPEAK',
    ogDesc: 'Disco móvil profesional en Barcelona para bodas y eventos. Equipo completo incluido.',
    ogType: 'website',
  },
  {
    path: '/contratar-disco-movil/valencia',
    title: 'Contratar Disco Móvil en Valencia | XPEAK | DJ con equipo para bodas',
    desc: 'Contrata disco móvil en Valencia: DJ profesional con equipo de sonido, luces y efectos para bodas, comuniones y fiestas privadas. Flash Booking.',
    ogTitle: 'Contratar Disco Móvil en Valencia | XPEAK',
    ogDesc: 'Disco móvil profesional en Valencia para bodas y eventos. Equipo completo incluido.',
    ogType: 'website',
  },
  {
    path: '/contratar-disco-movil/sevilla',
    title: 'Contratar Disco Móvil en Sevilla | XPEAK | DJ con equipo para bodas',
    desc: 'Contrata disco móvil en Sevilla: DJ profesional con equipo de sonido, luces y efectos para bodas, comuniones y fiestas privadas. Flash Booking.',
    ogTitle: 'Contratar Disco Móvil en Sevilla | XPEAK',
    ogDesc: 'Disco móvil profesional en Sevilla para bodas y eventos. Equipo completo incluido.',
    ogType: 'website',
  },
  // City landings — Staff
  {
  ...
  },
  {
    ...
    desc: 'Comparativa 2026 de XPEAK, Gigstarter, Bodas.net y agencias tradicionales para contratar DJ en España: coste real, contacto y cobertura de categorías.',
    ogTitle: 'Mejores Plataformas para Contratar DJ en España (2026)',
    ogDesc: 'Comparativa de XPEAK, Gigstarter, Bodas.net y agencias tradicionales: coste real, contacto y cobertura.',
    ogType: 'article',
  },
  {
  ...
  { path: '/contratar-camareros/sevilla',  title: 'Contratar Camareros en Sevilla | XPEAK | Personal de hostelería verificado',   desc: 'Contrata camareros y personal de hostelería en Sevilla para bodas, eventos corporativos y hostelería nocturna. Flash Booking disponible.',   ogTitle: 'Contratar Camareros en Sevilla | XPEAK',   ogDesc: 'Camareros verificados en Sevilla. Flash Booking para cubrir eventos urgentes.',   ogType: 'website' },
  { path: '/contratar-camareros/malaga',   title: 'Contratar Camareros en Málaga | XPEAK | Personal de hostelería verificado',    desc: 'Contrata camareros y personal de hostelería en Málaga para bodas, eventos corporativos y hostelería nocturna. Flash Booking disponible.',    ogTitle: 'Contratar Camareros en Málaga | XPEAK',    ogDesc: 'Camareros verificados en Málaga. Flash Booking para cubrir eventos urgentes.',    ogType: 'website' },
  { path: '/contratar-camareros/bilbao',   title: 'Contratar Camareros en Bilbao | XPEAK | Personal de hostelería verificado',    desc: 'Contrata camareros y personal de hostelería en Bilbao para bodas, eventos corporativos y hostelería nocturna. Flash Booking disponible.',    ogTitle: 'Contratar Camareros en Bilbao | XPEAK',    ogDesc: 'Camareros verificados en Bilbao. Flash Booking para cubrir eventos urgentes.',    ogType: 'website' },
  { path: '/contratar-camareros/zaragoza', title: 'Contratar Camareros en Zaragoza | XPEAK | Personal de hostelería verificado', desc: 'Contrata camareros y personal de hostelería en Zaragoza para bodas, eventos corporativos y hostelería nocturna. Flash Booking disponible.', ogTitle: 'Contratar Camareros en Zaragoza | XPEAK', ogDesc: 'Camareros verificados en Zaragoza. Flash Booking para cubrir eventos urgentes.', ogType: 'website' },
  { path: '/contratar-camareros/murcia',   title: 'Contratar Camareros en Murcia | XPEAK | Personal de hostelería verificado',   desc: 'Contrata camareros y personal de hostelería en Murcia para bodas, eventos corporativos y hostelería nocturna. Flash Booking disponible.',   ogTitle: 'Contratar Camareros en Murcia | XPEAK',   ogDesc: 'Camareros verificados en Murcia. Flash Booking para cubrir eventos urgentes.',   ogType: 'website' },
  { path: '/contratar-camareros/palma',    title: 'Contratar Camareros en Palma | XPEAK | Personal de hostelería verificado',    desc: 'Contrata camareros y personal de hostelería en Palma de Mallorca para bodas y eventos privados. Flash Booking disponible.',                   ogTitle: 'Contratar Camareros en Palma | XPEAK',    ogDesc: 'Camareros verificados en Palma. Flash Booking para cubrir eventos urgentes.',    ogType: 'website' },
  { path: '/contratar-camareros/ibiza',    title: 'Contratar Camareros en Ibiza | XPEAK | Personal de hostelería verificado',    desc: 'Contrata camareros y personal de hostelería en Ibiza para eventos privados, fiestas VIP y clubs exclusivos. Flash Booking disponible.',        ogTitle: 'Contratar Camareros en Ibiza | XPEAK',    ogDesc: 'Camareros verificados en Ibiza. Flash Booking para eventos VIP y clubs.',        ogType: 'website' },
  ...
  { path: '/contratar-promotores/coruna',   title: 'Contratar Promotores en A Coruña | XPEAK | RRPP y promotores verificados', desc: 'Contrata promotores, RRPP y coordinadores de acceso en A Coruña para clubs, festivales y eventos privados. Perfiles verificados.', ogTitle: 'Contratar Promotores en A Coruña | XPEAK', ogDesc: 'Promotores y RRPP verificados en A Coruña. Flash Booking disponible.', ogType: 'website' },
  { path: '/contratar-promotores/madrid',   title: 'Contratar Promotores en Madrid | XPEAK | RRPP y promotores verificados',   desc: 'Contrata promotores, RRPP y coordinadores de acceso en Madrid para clubs, festivales y eventos privados. Perfiles verificados.',   ogTitle: 'Contratar Promotores en Madrid | XPEAK',   ogDesc: 'Promotores y RRPP verificados en Madrid. Flash Booking disponible.',   ogType: 'website' },
  { path: '/contratar-promotores/barcelona', title: 'Contratar Promotores en Barcelona | XPEAK | RRPP y promotores verificados', desc: 'Contrata promotores, RRPP y coordinadores de acceso en Barcelona para clubs, festivales y eventos privados. Perfiles verificados.', ogTitle: 'Contratar Promotores en Barcelona | XPEAK', ogDesc: 'Promotores y RRPP verificados en Barcelona. Flash Booking disponible.', ogType: 'website' },
  { path: '/contratar-promotores/valencia', title: 'Contratar Promotores en Valencia | XPEAK | RRPP y promotores verificados',  desc: 'Contrata promotores, RRPP y coordinadores de acceso en Valencia para clubs, festivales y eventos privados. Perfiles verificados.',  ogTitle: 'Contratar Promotores en Valencia | XPEAK',  ogDesc: 'Promotores y RRPP verificados en Valencia. Flash Booking disponible.',  ogType: 'website' },
  { path: '/contratar-promotores/sevilla',  title: 'Contratar Promotores en Sevilla | XPEAK | RRPP y promotores verificados',   desc: 'Contrata promotores, RRPP y coordinadores de acceso en Sevilla para clubs, festivales y eventos privados. Perfiles verificados.',   ogTitle: 'Contratar Promotores en Sevilla | XPEAK',   ogDesc: 'Promotores y RRPP verificados en Sevilla. Flash Booking disponible.',   ogType: 'website' },
  { path: '/contratar-promotores/malaga',   title: 'Contratar Promotores en Málaga | XPEAK | RRPP y promotores verificados',    desc: 'Contrata promotores, RRPP y coordinadores de acceso en Málaga para clubs, festivales y eventos privados. Perfiles verificados.',    ogTitle: 'Contratar Promotores en Málaga | XPEAK',    ogDesc: 'Promotores y RRPP verificados en Málaga. Flash Booking disponible.',    ogType: 'website' },

  // Fotógrafo por ciudad — adicionales
  { path: '/contratar-fotografo/valencia', title: 'Contratar Fotógrafo en Valencia | XPEAK | Fotógrafos de eventos verificados', desc: 'Contrata fotógrafos profesionales en Valencia para bodas, eventos nocturnos y corporativos. Pack foto+vídeo disponible. Flash Booking.', ogTitle: 'Contratar Fotógrafo en Valencia | XPEAK', ogDesc: 'Fotógrafos verificados en Valencia para bodas y eventos. Flash Booking disponible.', ogType: 'website' },
  { path: '/contratar-fotografo/sevilla',  title: 'Contratar Fotógrafo en Sevilla | XPEAK | Fotógrafos de eventos verificados',  desc: 'Contrata fotógrafos profesionales en Sevilla para bodas, eventos nocturnos y corporativos. Pack foto+vídeo disponible. Flash Booking.',  ogTitle: 'Contratar Fotógrafo en Sevilla | XPEAK',  ogDesc: 'Fotógrafos verificados en Sevilla para bodas y eventos. Flash Booking disponible.',  ogType: 'website' },
  { path: '/contratar-fotografo/malaga',   title: 'Contratar Fotógrafo en Málaga | XPEAK | Fotógrafos de eventos verificados',   desc: 'Contrata fotógrafos profesionales en Málaga para bodas, eventos nocturnos y corporativos. Pack foto+vídeo disponible. Flash Booking.',   ogTitle: 'Contratar Fotógrafo en Málaga | XPEAK',   ogDesc: 'Fotógrafos verificados en Málaga para bodas y eventos. Flash Booking disponible.',   ogType: 'website' },
  { path: '/contratar-fotografo/bilbao',   title: 'Contratar Fotógrafo en Bilbao | XPEAK | Fotógrafos de eventos verificados',   desc: 'Contrata fotógrafos profesionales en Bilbao para bodas, eventos nocturnos y corporativos. Pack foto+vídeo disponible. Flash Booking.',   ogTitle: 'Contratar Fotógrafo en Bilbao | XPEAK',   ogDesc: 'Fotógrafos verificados en Bilbao para bodas y eventos. Flash Booking disponible.',   ogType: 'website' },
  { path: '/contratar-fotografo/zaragoza', title: 'Contratar Fotógrafo en Zaragoza | XPEAK | Fotógrafos de eventos verificados', desc: 'Contrata fotógrafos profesionales en Zaragoza para bodas, eventos nocturnos y corporativos. Pack foto+vídeo disponible. Flash Booking.', ogTitle: 'Contratar Fotógrafo en Zaragoza | XPEAK', ogDesc: 'Fotógrafos verificados en Zaragoza para bodas y eventos. Flash Booking disponible.', ogType: 'website' },
  { path: '/contratar-fotografo/murcia',   title: 'Contratar Fotógrafo en Murcia | XPEAK | Fotógrafos de eventos verificados',   desc: 'Contrata fotógrafos profesionales en Murcia para bodas, eventos nocturnos y corporativos. Pack foto+vídeo disponible. Flash Booking.',   ogTitle: 'Contratar Fotógrafo en Murcia | XPEAK',   ogDesc: 'Fotógrafos verificados en Murcia para bodas y eventos. Flash Booking disponible.',   ogType: 'website' },
  { path: '/contratar-fotografo/palma',    title: 'Contratar Fotógrafo en Palma | XPEAK | Fotógrafos de eventos verificados',    desc: 'Contrata fotógrafos profesionales en Palma de Mallorca para bodas y eventos exclusivos. Pack foto+vídeo disponible. Flash Booking.',    ogTitle: 'Contratar Fotógrafo en Palma | XPEAK',    ogDesc: 'Fotógrafos verificados en Palma para bodas y eventos. Flash Booking disponible.',    ogType: 'website' },
  { path: '/contratar-fotografo/ibiza',    title: 'Contratar Fotógrafo en Ibiza | XPEAK | Fotógrafos de eventos verificados',    desc: 'Contrata fotógrafos profesionales en Ibiza para eventos exclusivos, clubs y fiestas privadas. Especialistas en fotografía nocturna.',    ogTitle: 'Contratar Fotógrafo en Ibiza | XPEAK',    ogDesc: 'Fotógrafos verificados en Ibiza para eventos y clubs. Flash Booking disponible.',    ogType: 'website' },

  // Catering por ciudad — adicionales
  { path: '/contratar-catering/valencia', title: 'Contratar Catering en Valencia | XPEAK | Catering para bodas y eventos', desc: 'Contrata catering profesional en Valencia para bodas, eventos corporativos y celebraciones privadas. Menús personalizados.', ogTitle: 'Contratar Catering en Valencia | XPEAK', ogDesc: 'Catering profesional en Valencia para bodas y eventos. Menús personalizados.', ogType: 'website' },
  { path: '/contratar-catering/sevilla',  title: 'Contratar Catering en Sevilla | XPEAK | Catering para bodas y eventos',  desc: 'Contrata catering profesional en Sevilla para bodas, eventos corporativos y celebraciones privadas. Menús personalizados.',  ogTitle: 'Contratar Catering en Sevilla | XPEAK',  ogDesc: 'Catering profesional en Sevilla para bodas y eventos. Menús personalizados.',  ogType: 'website' },
  { path: '/contratar-catering/malaga',   title: 'Contratar Catering en Málaga | XPEAK | Catering para bodas y eventos',   desc: 'Contrata catering profesional en Málaga para bodas, eventos corporativos y celebraciones privadas. Menús personalizados.',   ogTitle: 'Contratar Catering en Málaga | XPEAK',   ogDesc: 'Catering profesional en Málaga para bodas y eventos. Menús personalizados.',   ogType: 'website' },
  { path: '/contratar-catering/bilbao',   title: 'Contratar Catering en Bilbao | XPEAK | Catering para bodas y eventos',   desc: 'Contrata catering profesional en Bilbao para bodas, eventos corporativos y celebraciones privadas. Menús personalizados.',   ogTitle: 'Contratar Catering en Bilbao | XPEAK',   ogDesc: 'Catering profesional en Bilbao para bodas y eventos. Menús personalizados.',   ogType: 'website' },
  { path: '/contratar-catering/zaragoza', title: 'Contratar Catering en Zaragoza | XPEAK | Catering para bodas y eventos', desc: 'Contrata catering profesional en Zaragoza para bodas, eventos corporativos y celebraciones privadas. Menús personalizados.', ogTitle: 'Contratar Catering en Zaragoza | XPEAK', ogDesc: 'Catering profesional en Zaragoza para bodas y eventos. Menús personalizados.', ogType: 'website' },
  { path: '/contratar-catering/murcia',   title: 'Contratar Catering en Murcia | XPEAK | Catering para bodas y eventos',   desc: 'Contrata catering profesional en Murcia para bodas, eventos corporativos y celebraciones privadas. Menús personalizados.',   ogTitle: 'Contratar Catering en Murcia | XPEAK',   ogDesc: 'Catering profesional en Murcia para bodas y eventos. Menús personalizados.',   ogType: 'website' },
  { path: '/contratar-catering/palma',    title: 'Contratar Catering en Palma | XPEAK | Catering para bodas y eventos',    desc: 'Contrata catering profesional en Palma de Mallorca para bodas y eventos exclusivos. Menús personalizados.',                    ogTitle: 'Contratar Catering en Palma | XPEAK',    ogDesc: 'Catering profesional en Palma para bodas y eventos. Menús personalizados.',    ogType: 'website' },
  { path: '/contratar-catering/ibiza',    title: 'Contratar Catering en Ibiza | XPEAK | Catering para bodas y eventos',    desc: 'Contrata catering de lujo en Ibiza para bodas, eventos privados exclusivos y fiestas VIP. Menús personalizados.',             ogTitle: 'Contratar Catering en Ibiza | XPEAK',    ogDesc: 'Catering de lujo en Ibiza para eventos privados y bodas. Menús personalizados.',    ogType: 'website' },

  // Disco móvil por ciudad — adicionales
  { path: '/contratar-disco-movil/malaga',   title: 'Contratar Disco Móvil en Málaga | XPEAK | DJ con equipo para bodas',   desc: 'Contrata disco móvil en Málaga: DJ con sonido, luces y efectos para bodas, comuniones y fiestas privadas. Flash Booking.',   ogTitle: 'Contratar Disco Móvil en Málaga | XPEAK',   ogDesc: 'Disco móvil profesional en Málaga para bodas y eventos. Equipo completo.',   ogType: 'website' },
  { path: '/contratar-disco-movil/bilbao',   title: 'Contratar Disco Móvil en Bilbao | XPEAK | DJ con equipo para bodas',   desc: 'Contrata disco móvil en Bilbao: DJ con sonido, luces y efectos para bodas, comuniones y fiestas privadas. Flash Booking.',   ogTitle: 'Contratar Disco Móvil en Bilbao | XPEAK',   ogDesc: 'Disco móvil profesional en Bilbao para bodas y eventos. Equipo completo.',   ogType: 'website' },
  { path: '/contratar-disco-movil/zaragoza', title: 'Contratar Disco Móvil en Zaragoza | XPEAK | DJ con equipo para bodas', desc: 'Contrata disco móvil en Zaragoza: DJ con sonido, luces y efectos para bodas, comuniones y fiestas privadas. Flash Booking.', ogTitle: 'Contratar Disco Móvil en Zaragoza | XPEAK', ogDesc: 'Disco móvil profesional en Zaragoza para bodas y eventos. Equipo completo.', ogType: 'website' },
  { path: '/contratar-disco-movil/murcia',   title: 'Contratar Disco Móvil en Murcia | XPEAK | DJ con equipo para bodas',   desc: 'Contrata disco móvil en Murcia: DJ con sonido, luces y efectos para bodas, comuniones y fiestas privadas. Flash Booking.',   ogTitle: 'Contratar Disco Móvil en Murcia | XPEAK',   ogDesc: 'Disco móvil profesional en Murcia para bodas y eventos. Equipo completo.',   ogType: 'website' },
  { path: '/contratar-disco-movil/palma',    title: 'Contratar Disco Móvil en Palma | XPEAK | DJ con equipo para bodas',    desc: 'Contrata disco móvil en Palma de Mallorca: DJ con sonido, luces y efectos para bodas y fiestas privadas. Flash Booking.',    ogTitle: 'Contratar Disco Móvil en Palma | XPEAK',    ogDesc: 'Disco móvil profesional en Palma para bodas y eventos. Equipo completo.',    ogType: 'website' },
  { path: '/contratar-disco-movil/ibiza',    title: 'Contratar Disco Móvil en Ibiza | XPEAK | DJ con equipo para bodas',    desc: 'Contrata disco móvil en Ibiza: DJ con equipo profesional de sonido y luces para bodas y eventos privados exclusivos. Flash Booking.', ogTitle: 'Contratar Disco Móvil en Ibiza | XPEAK',    ogDesc: 'Disco móvil profesional en Ibiza para bodas y eventos exclusivos.',         ogType: 'website' },
  ...
  { path: '/blog/cuanto-cuesta-un-food-truck-para-evento', title: '¿Cuánto Cuesta un Food Truck? Precio Real 350€-2.000€ (2026) | XPEAK', desc: 'Un food truck para boda o evento cuesta entre 350€ y 2.000€ según formato y comensales (15€-70€/persona). Tabla de precios reales 2026, por formato y por ciudad.', ogTitle: '¿Cuánto Cuesta un Food Truck? Precio Real 350€-2.000€ (2026)', ogDesc: 'Un food truck para boda o evento cuesta entre 350€ y 2.000€. Tabla de precios reales 2026, por formato y por ciudad.', ogType: 'article' },
  { path: '/blog/donde-publicar-food-truck-eventos', title: 'Dónde Publicar tu Food Truck para Conseguir Eventos (2026) | XPEAK', desc: 'Comparativa 2026 de XPEAK, Foodtruckya, Bodas.net e Instagram para que tu food truck consiga bodas y eventos: coste real, contacto y cobertura.', ogTitle: 'Dónde Publicar tu Food Truck para Conseguir Eventos (2026)', ogDesc: 'Comparativa de XPEAK, Foodtruckya, Bodas.net e Instagram: coste real, contacto y cobertura para food trucks.', ogType: 'article' },
  ...
  // DJs por ciudad
  { path: '/dj-madrid',    title: 'DJs en Madrid: Contratar DJ para tu evento | XPEAK', desc: 'Encuentra DJs profesionales en Madrid. Tech House, Techno, Comercial, Reggaeton. Tarifas desde 60€/h. Flash Booking en menos de 1h.', ogTitle: 'DJs en Madrid: Contratar DJ | XPEAK', ogDesc: 'DJs verificados en Madrid para clubs, bodas y eventos. Tarifas desde 60€/h. Flash Booking disponible.', ogType: 'website' },
  { path: '/dj-barcelona', title: 'DJs en Barcelona: Contratar DJ para tu evento | XPEAK', desc: 'Encuentra DJs profesionales en Barcelona. Tech House, Techno, Deep House y más. Tarifas desde 80€/h. Flash Booking en menos de 1h.', ogTitle: 'DJs en Barcelona: Contratar DJ | XPEAK', ogDesc: 'DJs verificados en Barcelona para clubs, bodas y eventos. Tarifas desde 80€/h. Flash Booking disponible.', ogType: 'website' },
  { path: '/dj-sevilla',   title: 'DJs en Sevilla: Contratar DJ para tu evento | XPEAK', desc: 'Encuentra DJs profesionales en Sevilla. Afro House, Comercial, Reggaeton y más. Tarifas desde 40€/h. Flash Booking en menos de 1h.', ogTitle: 'DJs en Sevilla: Contratar DJ | XPEAK', ogDesc: 'DJs verificados en Sevilla para clubs, bodas y eventos. Tarifas desde 40€/h. Flash Booking disponible.', ogType: 'website' },
  { path: '/dj-valencia',  title: 'DJs en Valencia: Contratar DJ para tu evento | XPEAK', desc: 'Encuentra DJs profesionales en Valencia. Deep House, Comercial y más. Tarifas desde 50€/h. Flash Booking en menos de 1h.', ogTitle: 'DJs en Valencia: Contratar DJ | XPEAK', ogDesc: 'DJs verificados en Valencia para clubs, bodas y eventos. Tarifas desde 50€/h. Flash Booking disponible.', ogType: 'website' },
  { path: '/dj-malaga',    title: 'DJs en Málaga: Contratar DJ para tu evento | XPEAK', desc: 'Encuentra DJs profesionales en Málaga y la Costa del Sol. Tarifas desde 35€/h. Flash Booking en menos de 1h.', ogTitle: 'DJs en Málaga: Contratar DJ | XPEAK', ogDesc: 'DJs verificados en Málaga para clubs, bodas y eventos. Flash Booking disponible.', ogType: 'website' },
  { path: '/dj-bilbao',    title: 'DJs en Bilbao: Contratar DJ para tu evento | XPEAK', desc: 'Encuentra DJs profesionales en Bilbao. Techno, Deep House y más. Tarifas desde 50€/h. Flash Booking en menos de 1h.', ogTitle: 'DJs en Bilbao: Contratar DJ | XPEAK', ogDesc: 'DJs verificados en Bilbao para clubs, bodas y eventos. Flash Booking disponible.', ogType: 'website' },

  // Camareros por ciudad
  { path: '/camareros-madrid',    title: 'Camareros en Madrid: Personal de sala para eventos | XPEAK', desc: 'Camareros y barmans profesionales en Madrid para bodas, eventos de empresa y fiestas privadas. Desde 16€/h. Flash Booking disponible.', ogTitle: 'Camareros en Madrid para eventos | XPEAK', ogDesc: 'Personal de sala verificado en Madrid. Bodas, eventos corporativos y fiestas privadas. Flash Booking.', ogType: 'website' },
  { path: '/camareros-barcelona', title: 'Camareros en Barcelona: Personal de sala para eventos | XPEAK', desc: 'Camareros y barmans profesionales en Barcelona para bodas y eventos. Desde 16€/h. Flash Booking disponible.', ogTitle: 'Camareros en Barcelona para eventos | XPEAK', ogDesc: 'Personal de sala verificado en Barcelona. Bodas y eventos corporativos. Flash Booking disponible.', ogType: 'website' },
  { path: '/camareros-sevilla',   title: 'Camareros en Sevilla: Personal de sala para eventos | XPEAK', desc: 'Camareros y barmans profesionales en Sevilla para bodas y eventos. Desde 14€/h. Flash Booking disponible.', ogTitle: 'Camareros en Sevilla para eventos | XPEAK', ogDesc: 'Personal de sala verificado en Sevilla. Bodas y eventos. Flash Booking disponible.', ogType: 'website' },
  { path: '/camareros-valencia',  title: 'Camareros en Valencia: Personal de sala para eventos | XPEAK', desc: 'Camareros y barmans profesionales en Valencia para bodas y eventos. Desde 15€/h. Flash Booking disponible.', ogTitle: 'Camareros en Valencia para eventos | XPEAK', ogDesc: 'Personal de sala verificado en Valencia. Bodas y eventos. Flash Booking disponible.', ogType: 'website' },
  { path: '/camareros-malaga',    title: 'Camareros en Málaga: Personal de sala para eventos | XPEAK', desc: 'Camareros y barmans profesionales en Málaga para bodas y eventos. Desde 14€/h. Flash Booking disponible.', ogTitle: 'Camareros en Málaga para eventos | XPEAK', ogDesc: 'Personal de sala verificado en Málaga. Bodas y eventos. Flash Booking disponible.', ogType: 'website' },
  { path: '/camareros-bilbao',    title: 'Camareros en Bilbao: Personal de sala para eventos | XPEAK', desc: 'Camareros y barmans profesionales en Bilbao para bodas y eventos. Desde 15€/h. Flash Booking disponible.', ogTitle: 'Camareros en Bilbao para eventos | XPEAK', ogDesc: 'Personal de sala verificado en Bilbao. Bodas y eventos. Flash Booking disponible.', ogType: 'website' },

  // Fotógrafo por ciudad
  { path: '/fotografo-madrid',    title: 'Fotógrafos en Madrid: Fotografía de eventos y bodas | XPEAK', desc: 'Fotógrafos profesionales en Madrid para bodas, eventos nocturnos y corporativos. Portfolio verificado. Desde 300€/evento. Flash Booking.', ogTitle: 'Fotógrafos en Madrid para eventos y bodas | XPEAK', ogDesc: 'Fotógrafos verificados en Madrid. Portfolio real, entrega rápida. Flash Booking disponible.', ogType: 'website' },
  { path: '/fotografo-barcelona', title: 'Fotógrafos en Barcelona: Fotografía de eventos y bodas | XPEAK', desc: 'Fotógrafos profesionales en Barcelona para bodas, eventos nocturnos y corporativos. Portfolio verificado. Flash Booking.', ogTitle: 'Fotógrafos en Barcelona para eventos y bodas | XPEAK', ogDesc: 'Fotógrafos verificados en Barcelona. Portfolio real, entrega rápida. Flash Booking disponible.', ogType: 'website' },
  { path: '/fotografo-sevilla',   title: 'Fotógrafos en Sevilla: Fotografía de eventos y bodas | XPEAK', desc: 'Fotógrafos profesionales en Sevilla para bodas, eventos y corporativos. Portfolio verificado. Flash Booking.', ogTitle: 'Fotógrafos en Sevilla para eventos y bodas | XPEAK', ogDesc: 'Fotógrafos verificados en Sevilla. Portfolio real, entrega rápida. Flash Booking disponible.', ogType: 'website' },
  { path: '/fotografo-valencia',  title: 'Fotógrafos en Valencia: Fotografía de eventos y bodas | XPEAK', desc: 'Fotógrafos profesionales en Valencia para bodas, eventos y corporativos. Portfolio verificado. Flash Booking.', ogTitle: 'Fotógrafos en Valencia para eventos y bodas | XPEAK', ogDesc: 'Fotógrafos verificados en Valencia. Portfolio real, entrega rápida. Flash Booking disponible.', ogType: 'website' },
  { path: '/fotografo-malaga',    title: 'Fotógrafos en Málaga: Fotografía de eventos y bodas | XPEAK', desc: 'Fotógrafos profesionales en Málaga y la Costa del Sol para bodas y eventos. Portfolio verificado. Flash Booking.', ogTitle: 'Fotógrafos en Málaga para eventos y bodas | XPEAK', ogDesc: 'Fotógrafos verificados en Málaga. Portfolio real, entrega rápida. Flash Booking disponible.', ogType: 'website' },
  { path: '/fotografo-bilbao',    title: 'Fotógrafos en Bilbao: Fotografía de eventos y bodas | XPEAK', desc: 'Fotógrafos profesionales en Bilbao para bodas, eventos y corporativos. Portfolio verificado. Flash Booking.', ogTitle: 'Fotógrafos en Bilbao para eventos y bodas | XPEAK', ogDesc: 'Fotógrafos verificados en Bilbao. Portfolio real, entrega rápida. Flash Booking disponible.', ogType: 'website' },

  // Maquillaje por ciudad
  { path: '/maquillaje-madrid',    title: 'Maquilladoras en Madrid: Maquillaje para bodas y eventos | XPEAK', desc: 'Maquilladoras profesionales en Madrid para bodas, fotografía y eventos. Prueba nupcial incluida. Desde 95€. Flash Booking disponible.', ogTitle: 'Maquilladoras en Madrid para bodas | XPEAK', ogDesc: 'Maquilladoras verificadas en Madrid. Nupcial, artístico y editorial. Flash Booking disponible.', ogType: 'website' },
  { path: '/maquillaje-barcelona', title: 'Maquilladoras en Barcelona: Maquillaje para bodas y eventos | XPEAK', desc: 'Maquilladoras profesionales en Barcelona para bodas, fotografía y eventos. Prueba nupcial incluida. Flash Booking disponible.', ogTitle: 'Maquilladoras en Barcelona para bodas | XPEAK', ogDesc: 'Maquilladoras verificadas en Barcelona. Nupcial, artístico y editorial. Flash Booking disponible.', ogType: 'website' },
  { path: '/maquillaje-sevilla',   title: 'Maquilladoras en Sevilla: Maquillaje para bodas y eventos | XPEAK', desc: 'Maquilladoras profesionales en Sevilla para bodas y eventos. Prueba nupcial incluida. Flash Booking disponible.', ogTitle: 'Maquilladoras en Sevilla para bodas | XPEAK', ogDesc: 'Maquilladoras verificadas en Sevilla. Nupcial y artístico. Flash Booking disponible.', ogType: 'website' },
  { path: '/maquillaje-valencia',  title: 'Maquilladoras en Valencia: Maquillaje para bodas y eventos | XPEAK', desc: 'Maquilladoras profesionales en Valencia para bodas y eventos. Prueba nupcial incluida. Flash Booking disponible.', ogTitle: 'Maquilladoras en Valencia para bodas | XPEAK', ogDesc: 'Maquilladoras verificadas en Valencia. Nupcial y artístico. Flash Booking disponible.', ogType: 'website' },
  { path: '/maquillaje-malaga',    title: 'Maquilladoras en Málaga: Maquillaje para bodas y eventos | XPEAK', desc: 'Maquilladoras profesionales en Málaga para bodas y eventos. Prueba nupcial incluida. Flash Booking disponible.', ogTitle: 'Maquilladoras en Málaga para bodas | XPEAK', ogDesc: 'Maquilladoras verificadas en Málaga. Nupcial y artístico. Flash Booking disponible.', ogType: 'website' },
  { path: '/maquillaje-bilbao',    title: 'Maquilladoras en Bilbao: Maquillaje para bodas y eventos | XPEAK', desc: 'Maquilladoras profesionales en Bilbao para bodas y eventos. Prueba nupcial incluida. Flash Booking disponible.', ogTitle: 'Maquilladoras en Bilbao para bodas | XPEAK', ogDesc: 'Maquilladoras verificadas en Bilbao. Nupcial y artístico. Flash Booking disponible.', ogType: 'website' },

  // Staff por ciudad
  { path: '/staff-madrid',    title: 'Staff de eventos en Madrid: Hostesses y RRPP | XPEAK', desc: 'Staff profesional en Madrid para discotecas, festivales y eventos: hostesses, RRPP, promotores y coordinadores. Desde 15€/h. Flash Booking.', ogTitle: 'Staff de eventos en Madrid: Hostesses y RRPP | XPEAK', ogDesc: 'Staff verificado en Madrid. Hostesses, RRPP y coordinadores para clubs y festivales. Flash Booking.', ogType: 'website' },
  { path: '/staff-barcelona', title: 'Staff de eventos en Barcelona: Hostesses y RRPP | XPEAK', desc: 'Staff profesional en Barcelona para discotecas y eventos: hostesses, RRPP, promotores. Desde 15€/h. Flash Booking.', ogTitle: 'Staff de eventos en Barcelona: Hostesses y RRPP | XPEAK', ogDesc: 'Staff verificado en Barcelona. Hostesses, RRPP y coordinadores. Flash Booking disponible.', ogType: 'website' },
  { path: '/staff-sevilla',   title: 'Staff de eventos en Sevilla: Hostesses y RRPP | XPEAK', desc: 'Staff profesional en Sevilla para discotecas y eventos: hostesses, RRPP, promotores. Flash Booking.', ogTitle: 'Staff de eventos en Sevilla: Hostesses y RRPP | XPEAK', ogDesc: 'Staff verificado en Sevilla. Hostesses, RRPP y promotores. Flash Booking disponible.', ogType: 'website' },
  ...
  // ── Directorio público ────────────────────────────────────────────────────
  {
    ...
    desc: 'Directorio de DJs para bodas, comuniones y eventos en España. Perfiles verificados, precios reales y contacto directo.',
  ...
  },
  {
    ...
    desc: 'Directorio de técnicos de sonido, iluminación y montaje de escenario en España. Con equipo propio o solo mano de obra. Tarifa por jornada y contacto directo.',
  ...
  },
  {
    ...
    desc: 'Socials y congresos de salsa, bachata y kizomba en toda España. Encuentra dónde bailar esta semana o publica tu evento.',
  ...
  { path: '/healthy-zone', title: 'Healthy Zone: tardeos, afterworks y eventos sin alcohol | XPEAK', desc: 'Ocio de día y consciente en Madrid: tardeos, afterworks de empresa, eventos sin alcohol y jornadas de bienestar. Guías prácticas y profesionales para organizarlos.', ogTitle: 'Healthy Zone: la fiesta, de otra forma | XPEAK', ogDesc: 'Tardeos, afterworks, eventos sin alcohol y jornadas de bienestar en Madrid.', ogType: 'website' },
  { path: '/blog/tardeo-privado-madrid', title: 'Tardeo privado en Madrid: horario, DJ y cuánto cuesta (2026) | XPEAK', desc: 'Cómo montar un tardeo privado en Madrid: qué horario funciona, cuánto cobra un DJ de tarde, qué local buscar y qué música poner para que la gente no se vaya a las ocho.', ogTitle: 'Tardeo privado en Madrid: horario, DJ y cuánto cuesta (2026) | XPEAK Healthy Zone', ogDesc: 'Cómo montar un tardeo privado en Madrid: qué horario funciona, cuánto cobra un DJ de tarde, qué local buscar y qué música poner para que la gente no se vaya a las ocho.', ogType: 'article' },
  { path: '/blog/afterwork-empresa-madrid', title: 'Afterwork de empresa en Madrid: horario, DJ y cuánto cuesta (2026) | XPEAK', desc: 'Cómo organizar un afterwork de empresa en Madrid: a qué hora empezar, qué local elegir, cuánto cuesta un DJ y qué servir para que vaya todo el equipo y no solo los de siempre.', ogTitle: 'Afterwork de empresa en Madrid: horario, DJ y cuánto cuesta (2026) | XPEAK Healthy Zone', ogDesc: 'Cómo organizar un afterwork de empresa en Madrid: a qué hora empezar, qué local elegir, cuánto cuesta un DJ y qué servir para que vaya todo el equipo y no solo los de siempre.', ogType: 'article' },
  { path: '/blog/eventos-sin-alcohol', title: 'Eventos sin alcohol: cómo organizarlos y qué servir (2026) | XPEAK', desc: 'Cómo organizar un evento sin alcohol, o con poco alcohol, que no sea aburrido: cócteles sin alcohol, bartender, horario, música y qué poner en la invitación.', ogTitle: 'Eventos sin alcohol: cómo organizarlos y qué servir (2026) | XPEAK Healthy Zone', ogDesc: 'Cómo organizar un evento sin alcohol, o con poco alcohol, que no sea aburrido: cócteles sin alcohol, bartender, horario, música y qué poner en la invitación.', ogType: 'article' },
  { path: '/blog/jornada-bienestar-empresa', title: 'Jornada de bienestar para empresas: qué incluir y precios (2026) | XPEAK', desc: 'Cómo organizar una jornada de bienestar o wellness day para el equipo: yoga, pausas activas, masajes, charlas y comida sana. Qué profesionales contratar y precio orientativo.', ogTitle: 'Jornada de bienestar para empresas: qué incluir y precios (2026) | XPEAK Healthy Zone', ogDesc: 'Cómo organizar una jornada de bienestar o wellness day para el equipo: yoga, pausas activas, masajes, charlas y comida sana. Qué profesionales contratar y precio orientativo.', ogType: 'article' },
  ...
  // Bodas
  { path: '/bodas', title: 'Profesionales para tu Boda | XPEAK | DJ, Fotógrafo, Catering y más', desc: 'Encuentra todos los profesionales para tu boda en un solo sitio: DJ, fotógrafo, catering, maquillaje y más. Perfiles verificados, contratos digitales.', ogTitle: 'Profesionales para tu Boda | XPEAK', ogDesc: 'DJ, fotógrafo, catering y maquillaje para tu boda. Perfiles verificados.', ogType: 'website' },
  { path: '/organizar-eventos', title: 'Organizar Eventos en España: Gestiona Todo desde un Solo Panel | XPEAK', desc: 'Organiza bodas, eventos de empresa y celebraciones con XPEAK: compara profesionales verificados, publica necesidades puntuales con Flash Booking y firma contratos digitales automáticos.', ogTitle: 'Organizar Eventos en España | XPEAK', ogDesc: 'Panel de gestión para organizar eventos: directorio verificado, contratos digitales y control de gastos.', ogType: 'website' },
  ...
  { path: '/blog/locales-para-eventos-madrid', title: 'Locales para eventos en Madrid: guía de salas, terrazas y fincas (2026) | XPEAK', desc: 'Discotecas, terrazas, azoteas y fincas para despedidas en Madrid y alrededores, con web y contacto directo.', ogTitle: 'Locales para eventos en Madrid | XPEAK Blog', ogDesc: 'Guía de salas, terrazas, azoteas y fincas para fiestas y despedidas en Madrid, con contacto directo de cada local.', ogType: 'article' },
...
for (const [catSlug, cat] of Object.entries(CATEGORY_DATA)) {
  ...
  ROUTES.push({
    ...
    ogDesc: `${cat.tagline} Directorio verificado. Flash Booking disponible.`,
    ogType: 'website',
  });
...
for (const [occSlug, roleSlugs] of Object.entries(OCC_ROLES)) {
  ...
  for (const roleSlug of roleSlugs) {
    ...
    ROUTES.push({
      ...
      desc: desc.slice(0, 300),
      ogTitle: `Contratar ${rol} para ${occLabel} | XPEAK`,
      ogDesc: desc.slice(0, 200),
      ogType: 'website',
    });
    existingPaths.add(routePath);
    ...
    }
    {
      ...
      for (const p of profiles) {
        ...
        const desc = bioSnippet
          ? `${p.display_name} · ${roleLabel}${where}. ${bioSnippet}${p.bio.length > 150 ? '…' : ''} Contacta y contrata en XPEAK.${antiguedadSuffix}`
          : `${p.display_name} · ${roleLabel}${where}. Perfil verificado en XPEAK: tarifas públicas, contacto directo y contrato digital.${antiguedadSuffix}`;
        ...
        ROUTES.push({
          ...
          bodyHtml: `<div style="max-width:720px;margin:0 auto;padding:48px 24px;color:#fff">` +
            ...
            portfolioHtml +
            postsHtml +
            `<p>Contrata a ${escHtml(p.display_name)} directamente en XPEAK: tarifas públicas, contacto directo y contrato digital automático.</p>` +
