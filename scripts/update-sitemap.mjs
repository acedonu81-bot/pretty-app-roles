...
function staticUrls(today, indexableCities, cityContentDates) {
  ...
  lines.push('\n  <!-- Directorio público -->');
  const dirSlugs = ['dj','fotografo','staff','azafata','camareros','maquillaje','promotores','catering','grupo-musical','animador','mago','humorista','bailarin','speaker','vestuario','photo-booth','wedding-planner','diseno-grafico','tecnico-sonido','djs-emergentes'];
