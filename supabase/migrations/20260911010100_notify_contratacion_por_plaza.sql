-- Con event_request_slots, "contratado" ya no cierra TODA la oferta ni avisa
-- a TODOS los inscritos — solo a los que compartían la MISMA plaza (mismo
-- slot_id: mismo rol, ej. "camarero #2"). La oferta completa solo se cierra
-- cuando TODAS sus plazas tienen un hired_at.
